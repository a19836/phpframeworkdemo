...
RUN echo '#!/bin/bash' > /usr/local/bin/docker-entrypoint.sh && \
	...
	echo '	' >> /usr/local/bin/docker-entrypoint.sh && \
	echo '	echo "Bloxtor is ready! Access it at: http://localhost:${WEB_PORT}/__system/admin"' >> /usr/local/bin/docker-entrypoint.sh && \
	echo 'else' >> /usr/local/bin/docker-entrypoint.sh && \
	echo '	' >> /usr/local/bin/docker-entrypoint.sh && \
	echo '	echo "Bloxtor is ready! Access it at: http://localhost:YOUR_PORT/__system/admin"' >> /usr/local/bin/docker-entrypoint.sh && \
