...
Content-Type: text/plain;
	charset="'.$pba11a122.'"
Content-Transfer-Encoding: '.$v0e3d8f53e0.'bit
...
------='.$this->v565a00eace.'--'; } public function getMultiPartHeader($v7633a72607, $pe4c7aeda, $pc0dcc212 = false) { $v0e3d8f53e0 = isset($this->pbebc8cef[1]) ? $this->pbebc8cef[1] : null; $v15493e4c60 = 'From: '.$v7633a72607.'
Subject: '.$pe4c7aeda.'
Content-Transfer-Encoding: '.$v0e3d8f53e0.'bit
MIME-Version: 1.0
