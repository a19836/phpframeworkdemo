 ...
 */
 trait MSSqlDBStatement { public static function getCreateDBStatement($pb67a2609, $v5d3813882f = false) { $pf6d213c3 = null; if (!empty($v5d3813882f["encoding"])) { $pf548ad60 = strtolower($v5d3813882f["encoding"]); $pf6d213c3 = isset(self::$db_connection_encodings_to_collations[$pf548ad60]) ? self::$db_connection_encodings_to_collations[$pf548ad60] : null; $pf6d213c3 = $pf6d213c3 ? " COLLATE " . $pf6d213c3 : ""; } return "IF DB_ID ('" . $pb67a2609 . "') IS NULL CREATE DATABASE " . $pb67a2609 . $pf6d213c3; } public static function getDropDatabaseStatement($pb67a2609, $v5d3813882f = false) { return "/* DROP DATABASE IF EXISTS [$pb67a2609] */;"; } public static function getSelectedDBStatement($v5d3813882f = false) { return "SELECT DB_NAME() AS db"; } public static function getDBsStatement($v5d3813882f = false) { return "SELECT name, database_id FROM sys.databases"; } public static function getTablesStatement($pb67a2609 = false, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; $v3c76382d93 ="SELECT 
			...
			ORDER BY t.TABLE_NAME ASC"; return $v3c76382d93; } public static function getTableFieldsStatement($pc661dc6b, $pb67a2609 = false, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; $pd5ae1c40 = isset($pbec62cc6["database"]) ? $pbec62cc6["database"] : null; $pb67a2609 = $pb67a2609 ? $pb67a2609 : $pd5ae1c40; $v3c76382d93 = "SELECT 
			...
			WHERE " . ($pa51282b5 ? " isc.TABLE_SCHEMA='$pa51282b5' AND " : "") . "isc.TABLE_NAME='$pc661dc6b'"; return $v3c76382d93; } public static function getCreateTableStatement($v87a92bb1ad, $v5d3813882f = false) { $v8c5df8072b = !empty($v87a92bb1ad["table_name"]) ? $v87a92bb1ad["table_name"] : (isset($v87a92bb1ad["name"]) ? $v87a92bb1ad["name"] : null); $pe8765fe8 = !empty($v87a92bb1ad["table_collation"]) ? $v87a92bb1ad["table_collation"] : (isset($v87a92bb1ad["collation"]) ? $v87a92bb1ad["collation"] : null); $pfdbbc383 = isset($v87a92bb1ad["attributes"]) ? $v87a92bb1ad["attributes"] : null; $pe8765fe8 = $pe8765fe8 ? " COLLATE=$pe8765fe8" : ""; $pe83acfb1 = self::getParsedTableEscapedSQL($v8c5df8072b, $v5d3813882f); $v3c76382d93 = "CREATE TABLE $pe83acfb1 (\n"; if (is_array($pfdbbc383)) { $v890f3625e5 = array(); foreach ($pfdbbc383 as $v97915b9670) if (isset($v97915b9670["name"])) { $v5e813b295b = $v97915b9670["name"]; $v597dd8d456 = isset($v97915b9670["primary_key"]) ? $v97915b9670["primary_key"] : null; $v597dd8d456 = $v597dd8d456 == "1" || strtolower($v597dd8d456) == "true"; if ($v597dd8d456) $v890f3625e5[] = $v5e813b295b; $peda0af84 = self::getCreateTableAttributeStatement($v97915b9670); $v3c76382d93 .= "  " . $peda0af84 . ",\n"; } if ($v890f3625e5) $v3c76382d93 .= "  PRIMARY KEY ([" . implode("], [", $v890f3625e5) . "])"; else $v3c76382d93 = substr($v3c76382d93, 0, strlen($v3c76382d93) - 2); } if (isset($v87a92bb1ad["unique_keys"]) && is_array($v87a92bb1ad["unique_keys"])) foreach ($v87a92bb1ad["unique_keys"] as $pbfa01ed1) if (!empty($pbfa01ed1["attribute"])) { $v3fb9f41470 = !empty($pbfa01ed1["type"]) ? "WITH " . $pbfa01ed1["type"] : ""; $ped0a6251 = is_array($pbfa01ed1["attribute"]) ? $pbfa01ed1["attribute"] : array($pbfa01ed1["attribute"]); $v3c76382d93 .= ",   " . (!empty($pbfa01ed1["name"]) ? "CONSTRAINT " . $pbfa01ed1["name"] . " " : "") . "UNIQUE ([" . implode('", "', $ped0a6251) . "]) $v3fb9f41470"; } if (isset($v87a92bb1ad["foreign_keys"]) && is_array($v87a92bb1ad["foreign_keys"])) foreach ($v87a92bb1ad["foreign_keys"] as $pbfa01ed1) if (!empty($pbfa01ed1["attribute"]) || !empty($pbfa01ed1["child_column"])) { $v6912eee73f = !empty($pbfa01ed1["on_delete"]) ? "ON DELETE " . $pbfa01ed1["on_delete"] : ""; $pd7c78775 = !empty($pbfa01ed1["on_update"]) ? "ON UPDATE " . $pbfa01ed1["on_update"] : ""; $v5e45ec9bb9 = !empty($pbfa01ed1["attribute"]) ? $pbfa01ed1["attribute"] : $pbfa01ed1["child_column"]; $pe3b2d7ad = !empty($pbfa01ed1["reference_attribute"]) ? $pbfa01ed1["reference_attribute"] : (isset($pbfa01ed1["parent_column"]) ? $pbfa01ed1["parent_column"] : null); $pf8a2ba68 = !empty($pbfa01ed1["reference_table"]) ? $pbfa01ed1["reference_table"] : (isset($pbfa01ed1["parent_table"]) ? $pbfa01ed1["parent_table"] : null); $pa28639ac = !empty($pbfa01ed1["name"]) ? $pbfa01ed1["name"] : (isset($pbfa01ed1["constraint_name"]) ? $pbfa01ed1["constraint_name"] : null); $ped0a6251 = is_array($v5e45ec9bb9) ? $v5e45ec9bb9 : array($v5e45ec9bb9); $v9256fc8d51 = is_array($pe3b2d7ad) ? $pe3b2d7ad : array($pe3b2d7ad); $v45be4caf5b = self::getParsedTableEscapedSQL($pf8a2ba68, $v5d3813882f); $v3c76382d93 .= ",\n   " . ($pa28639ac ? "CONSTRAINT " . $pa28639ac . " " : "") . " FOREIGN KEY ([" . implode('", "', $ped0a6251) . "]) REFERENCES " . $v45be4caf5b . " ([" . implode('", "', $v9256fc8d51) . "]) $v6912eee73f $pd7c78775"; } if (isset($v87a92bb1ad["index_keys"]) && is_array($v87a92bb1ad["index_keys"])) foreach ($v87a92bb1ad["index_keys"] as $pbfa01ed1) if (!empty($pbfa01ed1["attribute"])) { $v3fb9f41470 = !empty($pbfa01ed1["type"]) ? "WITH " . $pbfa01ed1["type"] : ""; $ped0a6251 = is_array($pbfa01ed1["attribute"]) ? $pbfa01ed1["attribute"] : array($pbfa01ed1["attribute"]); $v3c76382d93 .= ",\n   INDEX " . (isset($pbfa01ed1["name"]) ? $pbfa01ed1["name"] : "") . " ([" . implode('", "', $ped0a6251) . "]) $v3fb9f41470"; } $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $v3c76382d93 .= "\n) $pe8765fe8 $v77cb07b555"; return trim($v3c76382d93); } public static function getCreateTableAttributeStatement($v261e7b366d, $v5d3813882f = false, &$v808a08b1f9 = array()) { if (!empty($v261e7b366d["name"])) { $v5d3813882f = $v5d3813882f ? $v5d3813882f : array(); $name = trim($v261e7b366d["name"]); $type = isset($v261e7b366d["type"]) ? self::convertColumnTypeToDB($v261e7b366d["type"], $pe1390784) : null; $length = isset($v261e7b366d["length"]) ? $v261e7b366d["length"] : null; $pk = isset($v261e7b366d["primary_key"]) ? $v261e7b366d["primary_key"] : null; $pk = $pk == "1" || strtolower($pk) == "true"; $extra = isset($v261e7b366d["extra"]) ? $v261e7b366d["extra"] : null; $auto_increment = isset($v261e7b366d["auto_increment"]) ? $v261e7b366d["auto_increment"] : null; $auto_increment = $auto_increment == "1" || strtolower($auto_increment) == "true" || stripos($extra, "auto_increment") !== false; $unique = isset($v261e7b366d["unique"]) ? $v261e7b366d["unique"] : null; $unique = $unique == "1" || strtolower($unique) == "true"; $null = isset($v261e7b366d["null"]) ? $v261e7b366d["null"] : null; $null = $null == "1" || strtolower($null) == "true"; $default = isset($v261e7b366d["default"]) ? $v261e7b366d["default"] : null; $default_type = isset($v261e7b366d["default_type"]) ? $v261e7b366d["default_type"] : null; $collation = isset($v261e7b366d["collation"]) ? $v261e7b366d["collation"] : null; if (!empty($pe1390784)) foreach ($pe1390784 as $pe5c5e2fe => $v956913c90f) if ($pe5c5e2fe != "unsigned" && $pe5c5e2fe != "charset" && $pe5c5e2fe != "comment") eval("\$$pe5c5e2fe = \$v956913c90f;"); if ($auto_increment || stripos($extra, "auto_increment") !== false || stripos($extra, "identity") !== false) { $extra = preg_replace("/(^|\s)auto_increment(\s|$)/i", " ", $extra); $auto_increment = true; } $length = !self::ignoreColumnTypeDBProp($type, "length") && (is_numeric($length) || preg_match("/^([0-9]+),([0-9]+)$/", $length)) ? $length : self::getMandatoryLengthForColumnType($type); $auto_increment = !self::ignoreColumnTypeDBProp($type, "auto_increment") ? $auto_increment : null; $unique = !self::ignoreColumnTypeDBProp($type, "unique") && !$pk ? $unique : false; $null = !self::ignoreColumnTypeDBProp($type, "null") ? $null : null; $default = !self::ignoreColumnTypeDBProp($type, "default") ? $default : null; $collation = !self::ignoreColumnTypeDBProp($type, "collation") ? $collation : null; $pdbbe5385 = self::isAttributeValueReservedWord($default); $v3d15cdb3d4 = self::isReservedWordFunction($default); $v23ed8083a0 = in_array($type, self::getDBColumnNumericTypes()); $default = isset($default) && $v23ed8083a0 && !is_numeric($default) && !$pdbbe5385 && !$v3d15cdb3d4 ? null : $default; if (!isset($default) && isset($null) && !$null && !$pk) { $default = self::getDefaultValueForColumnType($type); $pdbbe5385 = self::isAttributeValueReservedWord($default); $v3d15cdb3d4 = self::isReservedWordFunction($default); } else if (isset($default) && is_string($default) && !strlen($default) && !$pk) { $default = self::getDefaultValueForColumnType($type); $pdbbe5385 = self::isAttributeValueReservedWord($default); $v3d15cdb3d4 = self::isReservedWordFunction($default); } $default_type = $default_type ? $default_type : (isset($default) && (is_numeric($default) || $pdbbe5385 || $v3d15cdb3d4) ? "numeric" : "string"); $v808a08b1f9["type"] = $type; $v808a08b1f9["primary_key"] = $pk; $v808a08b1f9["length"] = $length; $v808a08b1f9["auto_increment"] = $auto_increment; $v808a08b1f9["unique"] = $unique; $v808a08b1f9["null"] = $null; $v808a08b1f9["default"] = $default; $v808a08b1f9["collation"] = $collation; $length = $length && empty($v5d3813882f["ignore_length"]) ? "($length)" : ""; $auto_increment = $auto_increment && empty($v5d3813882f["ignore_auto_increment"]) && stripos($extra, "identity") === false ? "IDENTITY (1,1)" : ""; $unsigned = ""; $unique = $unique && empty($v5d3813882f["ignore_unique"]) ? "UNIQUE" : ""; $null = isset($null) && empty($v5d3813882f["ignore_null"]) ? ($null ? "NULL" : "NOT NULL") : ""; $default = isset($default) && empty($v5d3813882f["ignore_default"]) && !$auto_increment ? "DEFAULT " . ($default_type == "string" ? "'$default'" : $default) : ""; $charset = ""; $collation = !empty($collation) && empty($v5d3813882f["ignore_collation"]) ? "COLLATE $collation" : ""; $comment = ""; $extra = empty($v5d3813882f["ignore_extra"]) ? $extra : ""; $v77cb07b555 = !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $v3c76382d93 = trim(preg_replace("/[ ]+/", " ", "[$name] $type{$length} $unsigned $charset $collation $null $auto_increment $unique $default $extra $comment $v77cb07b555")); return $v3c76382d93; } } public static function getRenameTableStatement($pe8f357f7, $v38abe7147f, $v5d3813882f = false) { $v93973610e9 = self::getParsedTableEscapedSQL($pe8f357f7, $v5d3813882f); $pf87d7c43 = self::getParsedTableEscapedSQL($v38abe7147f, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; return "EXEC sp_rename $v93973610e9, $pf87d7c43 $v77cb07b555"; } public static function getModifyTableEncodingStatement($pc661dc6b, $pbebc8cef, $pf6d213c3, $v5d3813882f = false) { return null; } public static function getModifyTableStorageEngineStatement($pc661dc6b, $pf554201e, $v5d3813882f = false) { return null; } public static function getDropTableStatement($pc661dc6b, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; return "DROP TABLE IF EXISTS $v769bf5da97 $v77cb07b555"; } public static function getDropTableCascadeStatement($pc661dc6b, $v5d3813882f = false) { return self::getDropTableStatement($pc661dc6b, $v5d3813882f); } public static function getAddTableAttributeStatement($pc661dc6b, $v261e7b366d, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $v3c76382d93 = self::getCreateTableAttributeStatement($v261e7b366d); return "ALTER TABLE $v769bf5da97 ADD $v3c76382d93 $v77cb07b555"; } public static function getModifyTableAttributeStatement($pc661dc6b, $v261e7b366d, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; $v5eaddbc862 = self::getCreateTableAttributeStatement($v261e7b366d, array("ignore_default" => true, "ignore_unique" => true, "ignore_auto_increment" => true), $v808a08b1f9); if (!empty($v808a08b1f9["primary_key"]) && !empty($v808a08b1f9["extra"])) $v5eaddbc862 = self::getCreateTableAttributeStatement($v261e7b366d, array("ignore_default" => true, "ignore_unique" => true, "ignore_auto_increment" => true, "ignore_extra" => true), $v808a08b1f9); $v5e813b295b = isset($v261e7b366d["name"]) ? $v261e7b366d["name"] : null; $v4bfe0500a2 = null; $v6a54e01756 = isset($v808a08b1f9["default"]) && !empty($v261e7b366d["has_default"]); $v2be87570d1 = null; $v93ff269092 = rand(); if ($v6a54e01756) { $pdbbe5385 = self::isAttributeValueReservedWord($v808a08b1f9["default"]); $v3d15cdb3d4 = self::isReservedWordFunction($v808a08b1f9["default"]); $v4bfe0500a2 = is_numeric($v808a08b1f9["default"]) || $pdbbe5385 || $v3d15cdb3d4 ? $v808a08b1f9["default"] : "''" . $v808a08b1f9["default"] . "''"; $v2be87570d1 = is_numeric($v808a08b1f9["default"]) ? "((" . $v808a08b1f9["default"] . "))" : "(''" . $v808a08b1f9["default"] . "'')"; } $v3c76382d93 = "
			...
			BEGIN
				...
				EXEC (@drop_sql);
			END
			"; if (empty($v808a08b1f9["primary_key"]) && isset($v808a08b1f9["null"]) && !$v808a08b1f9["null"] && isset($v808a08b1f9["default"])) { $pdbbe5385 = self::isAttributeValueReservedWord($v808a08b1f9["default"]); $v3d15cdb3d4 = self::isReservedWordFunction($v808a08b1f9["default"]); $v4bfe0500a2 = is_numeric($v808a08b1f9["default"]) || $pdbbe5385 || $v3d15cdb3d4 ? $v808a08b1f9["default"] : "'" . $v808a08b1f9["default"] . "'"; $v3c76382d93 .= "
			...
			"; if (empty($v808a08b1f9["primary_key"]) && !empty($v808a08b1f9["unique"])) $v3c76382d93 .= "
			--add unique key
				ALTER TABLE $v769bf5da97 ADD CONSTRAINT uk__{$pc661dc6b}__{$v5e813b295b}__pf$v93ff269092 UNIQUE ($v5e813b295b);
			"; if (!empty($v808a08b1f9["auto_increment"])) { } return $v3c76382d93; } public static function getRenameTableAttributeStatement($pc661dc6b, $pfc66218f, $paa23699f, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; return "EXEC sp_rename '$v769bf5da97.$pfc66218f', '$paa23699f', 'COLUMN' $v77cb07b555"; } public static function getDropTableAttributeStatement($pc661dc6b, $v97915b9670, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; $v3c76382d93 = "
			DECLARE @drop_sql NVARCHAR(MAX) = '';
			...
			ALTER TABLE $v769bf5da97 DROP COLUMN [$v97915b9670] $v77cb07b555;"; return $v3c76382d93; } public static function getAddTablePrimaryKeysStatement($pc661dc6b, $pfdbbc383, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $pa28639ac = str_replace(" ", "_", strtolower($pc661dc6b)) . "_pk"; $pfdbbc383 = is_array($pfdbbc383) ? $pfdbbc383 : array($pfdbbc383); $v325ffa1d87 = array(); foreach ($pfdbbc383 as $v1b0cfa478b) { if (is_array($v1b0cfa478b)) { if (!empty($v1b0cfa478b["name"])) $v325ffa1d87[] = $v1b0cfa478b["name"]; } else if ($v1b0cfa478b) $v325ffa1d87[] = $v1b0cfa478b; } return "ALTER TABLE $v769bf5da97 ADD CONSTRAINT $pa28639ac PRIMARY KEY ([" . implode("], [", $v325ffa1d87) . "]) $v77cb07b555"; } public static function getDropTablePrimaryKeysStatement($pc661dc6b, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; return "DECLARE @sql NVARCHAR(MAX);
			   ...
			   EXEC sp_executeSQL @sql;"; } public static function getAddTableForeignKeyStatement($pc661dc6b, $pa7c14731, $v5d3813882f = false) { if ($pa7c14731 && (!empty($pa7c14731["attribute"]) || !empty($pa7c14731["child_column"]))) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $v6912eee73f = !empty($pa7c14731["on_delete"]) ? "ON DELETE " . $pa7c14731["on_delete"] : ""; $pd7c78775 = !empty($pa7c14731["on_update"]) ? "ON UPDATE " . $pa7c14731["on_update"] : ""; $v5e45ec9bb9 = !empty($pa7c14731["attribute"]) ? $pa7c14731["attribute"] : (isset($pa7c14731["child_column"]) ? $pa7c14731["child_column"] : null); $pe3b2d7ad = !empty($pa7c14731["reference_attribute"]) ? $pa7c14731["reference_attribute"] : (isset($pa7c14731["parent_column"]) ? $pa7c14731["parent_column"] : null); $pf8a2ba68 = !empty($pa7c14731["reference_table"]) ? $pa7c14731["reference_table"] : (isset($pa7c14731["parent_table"]) ? $pa7c14731["parent_table"] : null); $pa28639ac = !empty($pa7c14731["name"]) ? $pa7c14731["name"] : (isset($pa7c14731["constraint_name"]) ? $pa7c14731["constraint_name"] : null); $v13aa5fbc76 = !empty($pa7c14731["replication_code"]) ? $pa7c14731["replication_code"] : ""; $pf64b5abc = null; $ped0a6251 = is_array($v5e45ec9bb9) ? $v5e45ec9bb9 : array($v5e45ec9bb9); $v9256fc8d51 = is_array($pe3b2d7ad) ? $pe3b2d7ad : array($pe3b2d7ad); $v45be4caf5b = self::getParsedTableEscapedSQL($pf8a2ba68, $v5d3813882f); return "ALTER TABLE $v769bf5da97 ADD " . ($pa28639ac ? "CONSTRAINT [" . $pa28639ac . "] " : "") . " FOREIGN KEY ([" . implode('], [', $ped0a6251) . "]) REFERENCES " . $v45be4caf5b . " ([" . implode('], [', $v9256fc8d51) . "]) $v6912eee73f $pd7c78775 $v13aa5fbc76 $pf64b5abc $v77cb07b555"; } } public static function getDropTableForeignKeysStatement($pc661dc6b, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; return "WHILE 1=1
BEGIN
  SELECT 
...
SELECT '$pc661dc6b' as 'Table', REPLACE(@SQL, '\n    , ', ',\n    ') as 'Create Table'"; } public static function getShowCreateViewStatement($pa36e00ea, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pa36e00ea, $v5d3813882f); $pa36e00ea = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT '$pa36e00ea' as 'View', OBJECT_DEFINITION(OBJECT_ID('$pa36e00ea')) as 'Create View'"; } public static function getShowCreateTriggerStatement($v5ed3bce1d1, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($v5ed3bce1d1, $v5d3813882f); $v5ed3bce1d1 = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT '$v5ed3bce1d1' as 'Trigger', OBJECT_DEFINITION(OBJECT_ID('$v5ed3bce1d1')) as 'SQL Original Statement'"; } public static function getShowCreateProcedureStatement($pbda8f16d, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pbda8f16d, $v5d3813882f); $pbda8f16d = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT ROUTINE_NAME as 'Procedure', ROUTINE_DEFINITION as 'Create Procedure' FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'PROCEDURE' and ROUTINE_NAME = '$pbda8f16d'"; } public static function getShowCreateFunctionStatement($v2f4e66e00a, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($v2f4e66e00a, $v5d3813882f); $v2f4e66e00a = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT ROUTINE_NAME as 'Function', ROUTINE_DEFINITION as 'Create Function' FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'FUNCTION' and ROUTINE_NAME = '$v2f4e66e00a'"; } public static function getShowCreateEventStatement($v76392c9cad, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($v76392c9cad, $v5d3813882f); $v76392c9cad = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT '$v76392c9cad' as 'Event', OBJECT_DEFINITION(OBJECT_ID('$v76392c9cad')) as 'Create Event'"; } public static function getShowTablesStatement($pb67a2609, $v5d3813882f = false) { return str_replace("\n", " ", self::getTablesStatement($pb67a2609, $v5d3813882f)); } public static function getShowViewsStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT ". "v.TABLE_NAME AS 'view_name', ". "v.TABLE_SCHEMA AS 'view_schema', ". "v.VIEW_DEFINITION AS 'view_definition' ". "FROM INFORMATION_SCHEMA.VIEWS v ". "INNER JOIN sys.objects o ON SCHEMA_NAME(o.schema_id)=v.TABLE_SCHEMA AND o.name=v.TABLE_NAME AND o.type='V' AND o.is_ms_shipped=0 ". "WHERE v.TABLE_CATALOG=" . ($pb67a2609 ? "'$pb67a2609'" : "DB_NAME()") . ($pa51282b5 ? " AND v.TABLE_SCHEMA='$pa51282b5'" : "") . " ". "ORDER BY v.TABLE_NAME ASC"; } public static function getShowTriggersStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT trg.name AS 'trigger_name', tab.TABLE_NAME AS 'table_name', tab.TABLE_SCHEMA AS 'table_schema' ". "FROM sys.triggers trg ". "INNER JOIN INFORMATION_SCHEMA.TABLES tab ON tab.TABLE_NAME=OBJECT_NAME(trg.parent_id) AND tab.TABLE_SCHEMA=OBJECT_SCHEMA_NAME(trg.parent_id) ". "WHERE tab.TABLE_CATALOG=" . ($pb67a2609 ? "'$pb67a2609'" : "DB_NAME()") . ($pa51282b5 ? " AND tab.TABLE_SCHEMA='$pa51282b5'" : "") . " and trg.is_ms_shipped=0 ". "ORDER BY v.TABLE_NAME ASC"; } public static function getShowTableColumnsStatement($pc661dc6b, $pb67a2609 = false, $v5d3813882f = false) { return str_replace("\n", " ", self::getTableFieldsStatement($pc661dc6b, $pb67a2609, $v5d3813882f)); } public static function getShowForeignKeysStatement($pc661dc6b, $pb67a2609 = false, $v5d3813882f = false) { return str_replace("\t", "", self::getForeignKeysStatement($pc661dc6b, $pb67a2609, $v5d3813882f)); } public static function getShowProceduresStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT r.SPECIFIC_NAME AS 'procedure_name', r.ROUTINE_SCHEMA AS 'procedure_schema', r.ROUTINE_NAME AS 'routine_name', r.ROUTINE_TYPE AS 'procedure_type', r.ROUTINE_DEFINITION AS 'procedure_definition' ". "FROM INFORMATION_SCHEMA.ROUTINES r ". "INNER JOIN sys.objects o ON SCHEMA_NAME(o.schema_id)=r.ROUTINE_SCHEMA AND o.name=r.ROUTINE_NAME AND o.type='P' AND o.is_ms_shipped=0 ". "WHERE r.ROUTINE_TYPE='PROCEDURE' and r.ROUTINE_CATALOG=" . ($pb67a2609 ? "'$pb67a2609'" : "DB_NAME()") . ($pa51282b5 ? " AND r.ROUTINE_SCHEMA='$pa51282b5'" : ""); } public static function getShowFunctionsStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT r.ROUTINE_NAME as 'function_name', r.ROUTINE_SCHEMA AS 'function_schema', r.ROUTINE_NAME AS 'routine_name', r.ROUTINE_TYPE AS 'function_type', r.ROUTINE_DEFINITION AS 'function_definition' ". "FROM INFORMATION_SCHEMA.ROUTINES r ". "INNER JOIN sys.objects o ON SCHEMA_NAME(o.schema_id)=r.ROUTINE_SCHEMA AND o.name=r.ROUTINE_NAME AND o.type in ('AF', 'FN', 'FS', 'FT', 'IF', 'TF') AND o.is_ms_shipped=0 ". "WHERE r.ROUTINE_TYPE='FUNCTION' and r.ROUTINE_CATALOG=" . ($pb67a2609 ? "'$pb67a2609'" : "DB_NAME()") . ($pa51282b5 ? " AND r.ROUTINE_SCHEMA='$pa51282b5'" : ""); } public static function getShowEventsStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT o.name AS 'event_name', SCHEMA_NAME(o.schema_id) AS 'event_schema' ". "FROM sys.events e ". "INNER JOIN sys.objects o ON o.object_id=e.object_id AND o.is_ms_shipped=0 ". "INNER JOIN INFORMATION_SCHEMA.TABLES tab ON tab.TABLE_NAME=OBJECT_NAME(o.parent_object_id) AND tab.TABLE_SCHEMA=OBJECT_SCHEMA_NAME(o.parent_object_id)". "WHERE tab.TABLE_CATALOG=" . ($pb67a2609 ? "'$pb67a2609'" : "DB_NAME()") . ($pa51282b5 ? " AND SCHEMA_NAME(o.schema_id)='$pa51282b5'" : ""); } public static function getSetupTransactionStatement($v5d3813882f = false) { return "SET TRANSACTION ISOLATION LEVEL REPEATABLE READ"; } public static function getStartTransactionStatement($v5d3813882f = false) { return "BEGIN TRANSACTION ". "/* [transaction_name] WITH MARK [description] */"; } public static function getCommitTransactionStatement($v5d3813882f = false) { return "COMMIT TRANSACTION"; } public static function getStartDisableAutocommitStatement($v5d3813882f = false) { return "SET IMPLICIT_TRANSACTIONS ON;"; } public static function getEndDisableAutocommitStatement($v5d3813882f = false) { return "SET IMPLICIT_TRANSACTIONS OFF;"; } public static function getStartLockTableWriteStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getStartLockTableReadStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getEndLockTableStatement($v5d3813882f = false) { return null; } public static function getStartDisableKeysStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getEndDisableKeysStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getDropTriggerStatement($v5ed3bce1d1, $v5d3813882f = false) { $v6caad9d962 = self::getParsedTableEscapedSQL($v5ed3bce1d1, $v5d3813882f); return "DROP TRIGGER IF EXISTS $v6caad9d962;"; } public static function getDropProcedureStatement($pbda8f16d, $v5d3813882f = false) { $v7c7c261ebc = self::getParsedTableEscapedSQL($pbda8f16d, $v5d3813882f); return "DROP PROCEDURE IF EXISTS $v7c7c261ebc;"; } public static function getDropFunctionStatement($v2f4e66e00a, $v5d3813882f = false) { $v7992b8f618 = self::getParsedTableEscapedSQL($v2f4e66e00a, $v5d3813882f); return "DROP FUNCTION IF EXISTS $v7992b8f618;"; } public static function getDropEventStatement($v76392c9cad, $v5d3813882f = false) { $pdea5ed12 = self::getParsedTableEscapedSQL($v76392c9cad, $v5d3813882f); return "DROP EVENT IF EXISTS $pdea5ed12;"; } public static function getDropViewStatement($pa36e00ea, $v5d3813882f = false) { $pe8a320e9 = self::getParsedTableEscapedSQL($pa36e00ea, $v5d3813882f); return "DROP VIEW IF EXISTS $pe8a320e9;"; } public static function getShowTableCharsetsStatement($v5d3813882f = false) { return null; } public static function getShowColumnCharsetsStatement($v5d3813882f = false) { return null; } public static function getShowTableCollationsStatement($v5d3813882f = false) { return "SELECT name, description FROM sys.fn_helpcollations();"; } public static function getShowColumnCollationsStatement($v5d3813882f = false) { return self::getShowTableCollationsStatement($v5d3813882f); } public static function getShowDBStorageEnginesStatement($v5d3813882f = false) { return null; } } ?>
