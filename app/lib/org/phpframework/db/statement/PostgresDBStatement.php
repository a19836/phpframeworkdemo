...
trait PostgresDBStatement { public static function getCreateDBStatement($pb67a2609, $v5d3813882f = false) { $v3c76382d93 = "CREATE DATABASE \"" . $pb67a2609 . "\""; if (!empty($v5d3813882f["encoding"]) || !empty($v5d3813882f["collation"])) { $v3c76382d93 .= " WITH"; if (!empty($v5d3813882f["encoding"])) $v3c76382d93 .= " ENCODING '" . strtoupper($v5d3813882f["encoding"]) . "'"; if (!empty($v5d3813882f["collation"])) $v3c76382d93 .= " LC_COLLATE '" . strtoupper($v5d3813882f["collation"]) . "'"; } return $v3c76382d93; } public static function getDropDatabaseStatement($pb67a2609, $v5d3813882f = false) { return "/*!40000 DROP DATABASE IF EXISTS \"$pb67a2609\" */;"; } public static function getSelectedDBStatement($v5d3813882f = false) { return "SELECT current_database() AS db"; } public static function getDBsStatement($v5d3813882f = false) { return "SELECT datname AS name FROM pg_database"; } public static function getTablesStatement($pb67a2609 = false, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; $v3c76382d93 = "SELECT 
			...
			ORDER BY t.table_name ASC"; return $v3c76382d93; } public static function getTableFieldsStatement($pc661dc6b, $pb67a2609 = false, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; $pd5ae1c40 = isset($pbec62cc6["database"]) ? $pbec62cc6["database"] : null; $pb67a2609 = $pb67a2609 ? $pb67a2609 : $pd5ae1c40; $v3c76382d93 = "
		SELECT 
			isc.column_name, 
			isc.column_default, 
			isc.is_nullable, 
		...
		GROUP BY 
			...
			INNER JOIN information_schema.columns col ON col.table_schema = tc.table_schema AND col.table_name = tc.table_name AND col.ordinal_position=ANY(pgc.conkey);"; return $v3c76382d93; } public static function getCreateTableStatement($v87a92bb1ad, $v5d3813882f = false) { $v8c5df8072b = !empty($v87a92bb1ad["table_name"]) ? $v87a92bb1ad["table_name"] : (isset($v87a92bb1ad["name"]) ? $v87a92bb1ad["name"] : null); $v70378781f0 = !empty($v87a92bb1ad["table_storage_engine"]) ? $v87a92bb1ad["table_storage_engine"] : (isset($v87a92bb1ad["engine"]) ? $v87a92bb1ad["engine"] : null); $pfdbbc383 = isset($v87a92bb1ad["attributes"]) ? $v87a92bb1ad["attributes"] : null; $pf601a685 = ""; if (!empty($v0aaaac50d5) || !empty($pe8765fe8) || !empty($v70378781f0)) { $pf601a685 = "WITH "; $pf601a685 .= !empty($v70378781f0) ? "($v70378781f0) " : ""; } $pe83acfb1 = self::getParsedTableEscapedSQL($v8c5df8072b, $v5d3813882f); $v3c76382d93 = "CREATE TABLE $pe83acfb1 (\n"; if (is_array($pfdbbc383)) { $v890f3625e5 = array(); foreach ($pfdbbc383 as $v97915b9670) if (!empty($v97915b9670["name"])) { $v5e813b295b = $v97915b9670["name"]; $v597dd8d456 = isset($v97915b9670["primary_key"]) ? $v97915b9670["primary_key"] : null; $v597dd8d456 = $v597dd8d456 == "1" || strtolower($v597dd8d456) == "true"; if ($v597dd8d456) $v890f3625e5[] = $v5e813b295b; $peda0af84 = self::getCreateTableAttributeStatement($v97915b9670); $v3c76382d93 .= "  " . $peda0af84 . ",\n"; } if ($v890f3625e5) { $v3c76382d93 .= "  PRIMARY KEY (\"" . implode("\", \"", $v890f3625e5) . "\")"; } else { $v3c76382d93 = substr($v3c76382d93, 0, strlen($v3c76382d93) - 2); } } if (isset($v87a92bb1ad["unique_keys"]) && is_array($v87a92bb1ad["unique_keys"])) foreach ($v87a92bb1ad["unique_keys"] as $pbfa01ed1) if (!empty($pbfa01ed1["attribute"])) { $ped0a6251 = is_array($pbfa01ed1["attribute"]) ? $pbfa01ed1["attribute"] : array($pbfa01ed1["attribute"]); $v3c76382d93 .= ",   " . (!empty($pbfa01ed1["name"]) ? "CONSTRAINT " . $pbfa01ed1["name"] . " " : "") . " UNIQUE (\"" . implode('", "', $ped0a6251) . "\")"; } if (isset($v87a92bb1ad["foreign_keys"]) && is_array($v87a92bb1ad["foreign_keys"])) foreach ($v87a92bb1ad["foreign_keys"] as $pbfa01ed1) if (!empty($pbfa01ed1["attribute"]) || !empty($pbfa01ed1["child_column"])) { $v6912eee73f = !empty($pbfa01ed1["on_delete"]) ? "ON DELETE " . $pbfa01ed1["on_delete"] : ""; $pd7c78775 = !empty($pbfa01ed1["on_update"]) ? "ON UPDATE " . $pbfa01ed1["on_update"] : ""; $v5e45ec9bb9 = !empty($pbfa01ed1["attribute"]) ? $pbfa01ed1["attribute"] : (isset($pbfa01ed1["child_column"]) ? $pbfa01ed1["child_column"] : null); $pe3b2d7ad = !empty($pbfa01ed1["reference_attribute"]) ? $pbfa01ed1["reference_attribute"] : (isset($pbfa01ed1["parent_column"]) ? $pbfa01ed1["parent_column"] : null); $pf8a2ba68 = !empty($pbfa01ed1["reference_table"]) ? $pbfa01ed1["reference_table"] : (isset($pbfa01ed1["parent_table"]) ? $pbfa01ed1["parent_table"] : null); $pa28639ac = !empty($pbfa01ed1["name"]) ? $pbfa01ed1["name"] : (isset($pbfa01ed1["constraint_name"]) ? $pbfa01ed1["constraint_name"] : null); $ped0a6251 = is_array($v5e45ec9bb9) ? $v5e45ec9bb9 : array($v5e45ec9bb9); $v9256fc8d51 = is_array($pe3b2d7ad) ? $pe3b2d7ad : array($pe3b2d7ad); $v45be4caf5b = self::getParsedTableEscapedSQL($pf8a2ba68, $v5d3813882f); $v3c76382d93 .= ",\n   " . ($pa28639ac ? "CONSTRAINT " . $pa28639ac . " " : "") . " FOREIGN KEY (\"" . implode('", "', $ped0a6251) . "\") REFERENCES " . $v45be4caf5b . " (\"" . implode('", "', $v9256fc8d51) . "\") $v6912eee73f $pd7c78775"; } $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $v3c76382d93 .= "\n) $pf601a685 $v77cb07b555"; if (isset($v87a92bb1ad["index_keys"]) && is_array($v87a92bb1ad["index_keys"])) foreach ($v87a92bb1ad["index_keys"] as $pbfa01ed1) if (!empty($pbfa01ed1["attribute"])) { $v3fb9f41470 = !empty($pbfa01ed1["type"]) ? "USING " . $pbfa01ed1["type"] : ""; $ped0a6251 = is_array($pbfa01ed1["attribute"]) ? $pbfa01ed1["attribute"] : array($pbfa01ed1["attribute"]); $v3c76382d93 .= "\nCREATE INDEX " . (isset($pbfa01ed1["name"]) ? $pbfa01ed1["name"] : "") . " ON $pe83acfb1 $v3fb9f41470 (\"" . implode('", "', $ped0a6251) . "\")"; } return trim($v3c76382d93); } public static function getCreateTableAttributeStatement($v261e7b366d, $v5d3813882f = false, &$v808a08b1f9 = array()) { if (!empty($v261e7b366d["name"])) { $v5d3813882f = $v5d3813882f ? $v5d3813882f : array(); $name = trim($v261e7b366d["name"]); $type = isset($v261e7b366d["type"]) ? self::convertColumnTypeToDB($v261e7b366d["type"], $pe1390784) : null; $length = isset($v261e7b366d["length"]) ? $v261e7b366d["length"] : null; $pk = isset($v261e7b366d["primary_key"]) ? $v261e7b366d["primary_key"] : null; $pk = $pk == "1" || strtolower($pk) == "true"; $auto_increment = isset($v261e7b366d["auto_increment"]) ? $v261e7b366d["auto_increment"] : null; $auto_increment = $auto_increment == "1" || strtolower($auto_increment) == "true"; $unsigned = isset($v261e7b366d["unsigned"]) ? $v261e7b366d["unsigned"] : null; $unsigned = $unsigned == "1" || strtolower($unsigned) == "true"; $unique = isset($v261e7b366d["unique"]) ? $v261e7b366d["unique"] : null; $unique = $unique == "1" || strtolower($unique) == "true"; $null = isset($v261e7b366d["null"]) ? $v261e7b366d["null"] : null; $null = $null == "1" || strtolower($null) == "true"; $default = isset($v261e7b366d["default"]) ? $v261e7b366d["default"] : null; $default_type = isset($v261e7b366d["default_type"]) ? $v261e7b366d["default_type"] : null; $extra = isset($v261e7b366d["extra"]) ? $v261e7b366d["extra"] : null; $collation = isset($v261e7b366d["collation"]) ? $v261e7b366d["collation"] : null; if (!empty($pe1390784)) foreach ($pe1390784 as $pe5c5e2fe => $v956913c90f) if ($pe5c5e2fe != "charset" && $pe5c5e2fe != "comment") eval("\$$pe5c5e2fe = \$v956913c90f;"); if ($auto_increment || stripos($extra, "auto_increment") !== false) { $extra = preg_replace("/(^|\s)auto_increment(\s|$)/i", " ", $extra); $auto_increment = true; if (empty($v5d3813882f["do_not_convert_to_serial"])) $type = $type == "bigint" ? "bigserial" : ($type == "smallint" ? "smallserial" : "serial"); } $length = !self::ignoreColumnTypeDBProp($type, "length") && (is_numeric($length) || preg_match("/^([0-9]+),([0-9]+)$/", $length)) ? $length : self::getMandatoryLengthForColumnType($type); $unsigned = !self::ignoreColumnTypeDBProp($type, "unsigned") ? $unsigned : false; $unique = !self::ignoreColumnTypeDBProp($type, "unique") ? $unique : false; $null = !self::ignoreColumnTypeDBProp($type, "null") ? $null : null; $default = !self::ignoreColumnTypeDBProp($type, "default") ? $default : null; $collation = !self::ignoreColumnTypeDBProp($type, "collation") ? $collation : null; $pdbbe5385 = self::isAttributeValueReservedWord($default); $v3d15cdb3d4 = self::isReservedWordFunction($default); $v23ed8083a0 = in_array($type, self::getDBColumnNumericTypes()); $default = isset($default) && $v23ed8083a0 && !is_numeric($default) && !$pdbbe5385 && !$v3d15cdb3d4 ? null : $default; if (!isset($default) && isset($null) && !$null && !$pk) { $default = self::getDefaultValueForColumnType($type); $pdbbe5385 = self::isAttributeValueReservedWord($default); $v3d15cdb3d4 = self::isReservedWordFunction($default); } else if (isset($default) && is_string($default) && !strlen($default) && !$pk) { $default = self::getDefaultValueForColumnType($type); $pdbbe5385 = self::isAttributeValueReservedWord($default); $v3d15cdb3d4 = self::isReservedWordFunction($default); } $default_type = $default_type ? $default_type : (isset($default) && (is_numeric($default) || $pdbbe5385 || $v3d15cdb3d4) ? "numeric" : "string"); $v808a08b1f9["type"] = $type; $v808a08b1f9["primary_key"] = $pk; $v808a08b1f9["length"] = $length; $v808a08b1f9["auto_increment"] = $auto_increment; $v808a08b1f9["unsigned"] = $unsigned; $v808a08b1f9["unique"] = $unique; $v808a08b1f9["null"] = $null; $v808a08b1f9["default"] = $default; $v808a08b1f9["collation"] = $collation; $length = $length && empty($v5d3813882f["ignore_length"]) ? "($length)" : ""; $unsigned = $unsigned && empty($v5d3813882f["ignore_unsigned"]) ? "CHECK (\"$name\" > 0)" : ""; $unique = $unique && empty($v5d3813882f["ignore_unique"]) && !$pk ? "UNIQUE" : ""; $null = isset($null) && empty($v5d3813882f["ignore_null"]) ? ($null ? "NULL" : "NOT NULL") : ""; $default = isset($default) && empty($v5d3813882f["ignore_default"]) && !$auto_increment ? "DEFAULT " . ($default_type == "string" ? "'$default'" : $default) : ""; $charset = ""; $collation = !empty($collation) && empty($v5d3813882f["ignore_collation"]) ? "COLLATE '$collation'" : ""; $comment = ""; $extra = empty($v5d3813882f["ignore_extra"]) ? $extra : ""; $v77cb07b555 = !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; if ($unsigned && preg_match("/CHECK\s*\(+\s*\"?$name\"?\s*>/i", $extra)) $unsigned = ""; return trim(preg_replace("/[ ]+/", " ", "\"$name\" $type{$length} $unique $null $charset $collation $default $comment $extra $unsigned $v77cb07b555")); } } public static function getRenameTableStatement($pe8f357f7, $v38abe7147f, $v5d3813882f = false) { $v93973610e9 = self::getParsedTableEscapedSQL($pe8f357f7, $v5d3813882f); $pf87d7c43 = self::getParsedTableEscapedSQL($v38abe7147f, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; return "RENAME TABLE $v93973610e9 RENAME TO $pf87d7c43 $v77cb07b555"; } public static function getModifyTableEncodingStatement($pc661dc6b, $pbebc8cef, $pf6d213c3, $v5d3813882f = false) { return null; } public static function getModifyTableStorageEngineStatement($pc661dc6b, $pf554201e, $v5d3813882f = false) { return null; } public static function getDropTableStatement($pc661dc6b, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; return "DROP TABLE IF EXISTS $v769bf5da97 $v77cb07b555"; } public static function getDropTableCascadeStatement($pc661dc6b, $v5d3813882f = false) { $v5d3813882f["suffix"] = "CASCADE " . (isset($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""); return self::getDropTableStatement($pc661dc6b, $v5d3813882f); } public static function getAddTableAttributeStatement($pc661dc6b, $v261e7b366d, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $v3c76382d93 = self::getCreateTableAttributeStatement($v261e7b366d); return "ALTER TABLE $v769bf5da97 ADD COLUMN $v3c76382d93 $v77cb07b555"; } public static function getModifyTableAttributeStatement($pc661dc6b, $v261e7b366d, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; $v5eaddbc862 = self::getCreateTableAttributeStatement($v261e7b366d, array("do_not_convert_to_serial" => true, "ignore_null" => true, "ignore_default" => true, "ignore_unique" => true, "ignore_unsigned" => true, "ignore_auto_increment" => true), $v808a08b1f9); if (!empty($v808a08b1f9["primary_key"])) $v5eaddbc862 = self::getCreateTableAttributeStatement($v261e7b366d, array("do_not_convert_to_serial" => true, "ignore_null" => true, "ignore_default" => true, "ignore_unique" => true, "ignore_unsigned" => true, "ignore_auto_increment" => true, "ignore_extra" => true), $v808a08b1f9); $pbd1bc7b0 = strpos(trim($v5eaddbc862), '"', 1); $v5eaddbc862 = substr($v5eaddbc862, 0, $pbd1bc7b0 + 1) . " TYPE" . substr($v5eaddbc862, $pbd1bc7b0 + 1); $v5e813b295b = isset($v261e7b366d["name"]) ? $v261e7b366d["name"] : null; $v3c76382d93 = "--remove default value
			...
			"; } $v6a54e01756 = isset($v808a08b1f9["default"]) && !empty($v261e7b366d["has_default"]); if (!empty($v808a08b1f9["auto_increment"])) { $v3c76382d93 .= "
			...
			BEGIN
				...
				--raise notice 'set sequence to table: %', myvar;
		   	     EXECUTE myvar;
			END $$;
			"; } else if ($v6a54e01756) { $pdbbe5385 = self::isAttributeValueReservedWord($v808a08b1f9["default"]); $v3d15cdb3d4 = self::isReservedWordFunction($v808a08b1f9["default"]); $v4bfe0500a2 = is_numeric($v808a08b1f9["default"]) || $pdbbe5385 || $v3d15cdb3d4 ? $v808a08b1f9["default"] : "'" . $v808a08b1f9["default"] . "'"; $v3c76382d93 .= "
			--set default value
			ALTER TABLE $v769bf5da97 ALTER COLUMN \"$v5e813b295b\" SET DEFAULT $v4bfe0500a2;
			"; if (empty($v808a08b1f9["auto_increment"])) { $v3c76382d93 .= "
				--set auto increment constraint for PK: $v5e813b295b
				DO $$
				DECLARE myvar varchar = '';
				DECLARE sequence_name varchar = '';
			...
			DECLARE add_constraint smallint = " . (!empty($v808a08b1f9["unsigned"]) ? 1 : 0) . ";
			BEGIN
				SELECT 
					--tc.table_schema,
					--tc.table_name,
		...
		"; foreach ($pfdbbc383 as $v1b0cfa478b) if (is_array($v1b0cfa478b)) { self::getCreateTableAttributeStatement($v1b0cfa478b, null, $v808a08b1f9); if (!empty($v808a08b1f9["auto_increment"])) { $v5e813b295b = $v1b0cfa478b["name"]; $v3c76382d93 .= "
					...
					BEGIN
						...
						--raise notice 'set sequence to table: %', myvar;
				   	     EXECUTE myvar;
					END $$;
					"; } } return $v3c76382d93; } public static function getDropTablePrimaryKeysStatement($pc661dc6b, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $pa51282b5 = isset($pbec62cc6["schema"]) ? $pbec62cc6["schema"] : null; return "DO $$
				DECLARE myvar varchar = '';
				DECLARE sequence_name varchar = '';
				...
				BEGIN
					...
					IF myvar != '' THEN
						...
						EXECUTE myvar;
					END IF;
				END $$;"; } public static function getAddTableForeignKeyStatement($pc661dc6b, $pa7c14731, $v5d3813882f = false) { if ($pa7c14731 && (!empty($pa7c14731["attribute"]) || !empty($pa7c14731["child_column"]))) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $v6912eee73f = !empty($pa7c14731["on_delete"]) ? "ON DELETE " . $pa7c14731["on_delete"] : ""; $pd7c78775 = !empty($pa7c14731["on_update"]) ? "ON UPDATE " . $pa7c14731["on_update"] : ""; $v5e45ec9bb9 = !empty($pa7c14731["attribute"]) ? $pa7c14731["attribute"] : $pa7c14731["child_column"]; $pe3b2d7ad = !empty($pa7c14731["reference_attribute"]) ? $pa7c14731["reference_attribute"] : (isset($pa7c14731["parent_column"]) ? $pa7c14731["parent_column"] : null); $pf8a2ba68 = !empty($pa7c14731["reference_table"]) ? $pa7c14731["reference_table"] : (isset($pa7c14731["parent_table"]) ? $pa7c14731["parent_table"] : null); $pa28639ac = !empty($pa7c14731["name"]) ? $pa7c14731["name"] : (isset($pa7c14731["constraint_name"]) ? $pa7c14731["constraint_name"] : null); $ped0a6251 = is_array($v5e45ec9bb9) ? $v5e45ec9bb9 : array($v5e45ec9bb9); $v9256fc8d51 = is_array($pe3b2d7ad) ? $pe3b2d7ad : array($pe3b2d7ad); $v45be4caf5b = self::getParsedTableEscapedSQL($pf8a2ba68, $v5d3813882f); return "ALTER TABLE $v769bf5da97 ADD CONSTRAINT " . $pa28639ac . " FOREIGN KEY (\"" . implode('", "', $ped0a6251) . "\") REFERENCES " . $v45be4caf5b . " (\"" . implode('", "', $v9256fc8d51) . "\") $v6912eee73f $pd7c78775 $v77cb07b555"; } } public static function getDropTableForeignKeysStatement($pc661dc6b, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pc661dc6b, $v5d3813882f); $pc661dc6b = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; return "DO $$
DECLARE myvar varchar = '';
DECLARE t_row record;
BEGIN
	FOR t_row in 
...
ORDER BY constraint_name, seq_in_index $v77cb07b555"; } public static function getLoadTableDataFromFileStatement($pf3dc0762, $pc661dc6b, $v5d3813882f = false) { $v769bf5da97 = self::getParsedTableEscapedSQL($pc661dc6b, $v5d3813882f); $v77cb07b555 = $v5d3813882f && !empty($v5d3813882f["suffix"]) ? $v5d3813882f["suffix"] : ""; $pfdbbc383 = $v5d3813882f && !empty($v5d3813882f["attributes"]) ? "(" . (is_array($v5d3813882f["attributes"]) ? implode(", ", $v5d3813882f["attributes"]) : $v5d3813882f["attributes"]) . ")" : ""; $v52fe4649ca = !empty($v5d3813882f["fields_delimiter"]) ? $v5d3813882f["fields_delimiter"] : "\t"; return "COPY $v769bf5da97 $pfdbbc383 FROM '$pf3dc0762' WITH DELIMITER '$v52fe4649ca' $v77cb07b555"; } public static function getShowCreateTableStatement($pc661dc6b, $v5d3813882f = false) { return ""; } public static function getShowCreateViewStatement($pa36e00ea, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pa36e00ea, $v5d3813882f); $pa36e00ea = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "select '$pa36e00ea' as \"View\", pg_get_viewdef('$pa36e00ea') as \"Create View\""; } public static function getShowCreateTriggerStatement($v5ed3bce1d1, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($v5ed3bce1d1, $v5d3813882f); $v5ed3bce1d1 = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT tgname as \"Trigger\", pg_get_triggerdef(oid) as \"SQL Original Statement\" ". "FROM pg_trigger WHERE tgname='$v5ed3bce1d1'"; } public static function getShowCreateProcedureStatement($pbda8f16d, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($pbda8f16d, $v5d3813882f); $pbda8f16d = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT proname as \"Procedure\", pg_get_functiondef(f.oid) as \"Create Procedure\"
			...
			FROM pg_catalog.pg_proc f
			INNER JOIN pg_catalog.pg_namespace n ON (f.pronamespace = n.oid)
			WHERE proname='$v2f4e66e00a'"; } public static function getShowCreateEventStatement($v76392c9cad, $v5d3813882f = false) { $pbec62cc6 = self::parseTableName($v76392c9cad, $v5d3813882f); $v76392c9cad = isset($pbec62cc6["name"]) ? $pbec62cc6["name"] : null; return "SELECT tgname as \"Event\", pg_get_triggerdef(oid) as \"Create Event\" ". "FROM pg_trigger WHERE tgname='$v76392c9cad'"; } public static function getShowTablesStatement($pb67a2609, $v5d3813882f = false) { return str_replace("\t", "", self::getTablesStatement($pb67a2609, $v5d3813882f)); } public static function getShowViewsStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT 
				v.table_name AS \"view_name\",
				v.table_schema AS \"view_schema\",
				v.view_definition AS \"view_definition\"
			FROM information_schema.views v
			WHERE v.table_catalog=" . ($pb67a2609 ? "'$pb67a2609'" : "current_database()") . " AND " . ($pa51282b5 ? "v.table_schema='$pa51282b5'" : "v.table_schema!='pg_catalog' AND v.table_schema!='information_schema'") . " ". "ORDER BY v.table_name ASC"; } public static function getShowTriggersStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT TRIGGER_NAME AS \"trigger_name\", event_object_table AS \"table_name\", TRIGGER_SCHEMA AS \"table_schema\", ACTION_STATEMENT AS 'trigger_definition' ". "FROM INFORMATION_SCHEMA.TRIGGERS ". "WHERE TRIGGER_CATALOG='$pb67a2609' AND " . ($pa51282b5 ? "TRIGGER_SCHEMA='$pa51282b5'" : "TRIGGER_SCHEMA!='pg_catalog' AND TRIGGER_SCHEMA!='information_schema'") . " ". "ORDER BY TRIGGER_NAME ASC"; } public static function getShowTableColumnsStatement($pc661dc6b, $pb67a2609 = false, $v5d3813882f = false) { return str_replace("\n", " ", self::getTableFieldsStatement($pc661dc6b, $pb67a2609, $v5d3813882f)); } public static function getShowForeignKeysStatement($pc661dc6b, $pb67a2609 = false, $v5d3813882f = false) { return str_replace("\t", "", self::getForeignKeysStatement($pc661dc6b, $pb67a2609, $v5d3813882f)); } public static function getShowProceduresStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT p.oid, n.nspname as \"procedure_schema\", p.proname as \"procedure_name\", p.prosrc as \"procedure_definition\", p.proargnames as \"procedure_arg_names\", p.proargmodes as \"procedure_arg_modes\" ". "FROM pg_proc p ". "INNER JOIN pg_namespace n ON n.oid = p.pronamespace ". "INNER JOIN information_schema.routines rt ON rt.routine_catalog=" . ($pb67a2609 ? "'$pb67a2609'" : "current_database()") . " AND rt.routine_type='PROCEDURE' AND rt.routine_schema=n.nspname AND rt.routine_name=p.proname " . "WHERE n.nspname NOT LIKE 'pg%' AND n.nspname <> 'information_schema' " . ($pa51282b5 ? "AND rt.routine_schema='$pa51282b5' " : "") . "GROUP BY p.oid, n.nspname, p.proname"; } public static function getShowFunctionsStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT p.oid, n.nspname as \"function_schema\", p.proname as \"function_name\", p.prosrc as \"function_definition\", p.proargnames as \"function_arg_names\", p.proargmodes as \"function_arg_modes\" ". "FROM pg_proc p ". "INNER JOIN pg_namespace n ON n.oid = p.pronamespace ". "INNER JOIN information_schema.routines rt ON rt.routine_catalog=" . ($pb67a2609 ? "'$pb67a2609'" : "current_database()") . " AND rt.routine_type='FUNCTION' AND rt.routine_schema=n.nspname AND rt.routine_name=p.proname " . "WHERE n.nspname NOT LIKE 'pg%' AND n.nspname <> 'information_schema' " . ($pa51282b5 ? "AND rt.routine_schema='$pa51282b5' " : "") . "GROUP BY p.oid, n.nspname, p.proname"; } public static function getShowEventsStatement($pb67a2609, $v5d3813882f = false) { $pa51282b5 = $v5d3813882f && !empty($v5d3813882f["schema"]) ? $v5d3813882f["schema"] : null; return "SELECT TRIGGER_NAME AS \"event_name\", TRIGGER_SCHEMA AS \"event_schema\" ". "FROM INFORMATION_SCHEMA.TRIGGERS ". "WHERE TRIGGER_CATALOG=" . ($pb67a2609 ? "'$pb67a2609'" : "current_database()") . " AND TRIGGER_SCHEMA NOT LIKE 'pg%' AND TRIGGER_SCHEMA <> 'information_schema' " . ($pa51282b5 ? "AND TRIGGER_SCHEMA='$pa51282b5' " : ""); } public static function getSetupTransactionStatement($v5d3813882f = false) { return "SET TRANSACTION ISOLATION LEVEL REPEATABLE READ"; } public static function getStartTransactionStatement($v5d3813882f = false) { return "START TRANSACTION ". "/* [transaction_name] WITH MARK [description] */"; } public static function getCommitTransactionStatement($v5d3813882f = false) { return "COMMIT TRANSACTION"; } public static function getStartDisableAutocommitStatement($v5d3813882f = false) { return "SET AUTOCOMMIT TO OFF;"; } public static function getEndDisableAutocommitStatement($v5d3813882f = false) { return "SET AUTOCOMMIT TO ON;"; } public static function getStartLockTableWriteStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getStartLockTableReadStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getEndLockTableStatement($v5d3813882f = false) { return null; } public static function getStartDisableKeysStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getEndDisableKeysStatement($pc661dc6b, $v5d3813882f = false) { return null; } public static function getDropTriggerStatement($v5ed3bce1d1, $v5d3813882f = false) { $v6caad9d962 = self::getParsedTableEscapedSQL($v5ed3bce1d1, $v5d3813882f); return "DROP TRIGGER IF EXISTS $v6caad9d962;"; } public static function getDropProcedureStatement($pbda8f16d, $v5d3813882f = false) { $v7c7c261ebc = self::getParsedTableEscapedSQL($pbda8f16d, $v5d3813882f); return "DROP PROCEDURE IF EXISTS $v7c7c261ebc;"; } public static function getDropFunctionStatement($v2f4e66e00a, $v5d3813882f = false) { $v7992b8f618 = self::getParsedTableEscapedSQL($v2f4e66e00a, $v5d3813882f); return "DROP FUNCTION IF EXISTS $v7992b8f618;"; } public static function getDropEventStatement($v76392c9cad, $v5d3813882f = false) { $pdea5ed12 = self::getParsedTableEscapedSQL($v76392c9cad, $v5d3813882f); return "DROP EVENT TRIGGER IF EXISTS $pdea5ed12;"; } public static function getDropViewStatement($pa36e00ea, $v5d3813882f = false) { $pe8a320e9 = self::getParsedTableEscapedSQL($pa36e00ea, $v5d3813882f); return "DROP VIEW IF EXISTS $pe8a320e9;"; } public static function getShowTableCharsetsStatement($v5d3813882f = false) { return null; } public static function getShowColumnCharsetsStatement($v5d3813882f = false) { return null; } public static function getShowTableCollationsStatement($v5d3813882f = false) { return null; } public static function getShowColumnCollationsStatement($v5d3813882f = false) { return "SELECT collname FROM pg_collation"; } public static function getShowDBStorageEnginesStatement($v5d3813882f = false) { return null; } } ?>
