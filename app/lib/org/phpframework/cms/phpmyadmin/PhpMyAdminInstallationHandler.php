...
?>"; $v6490ea3a15 = preg_replace('/\?>\s*<\?php\s*/', "", $v6490ea3a15); $v5c1c342594 = file_put_contents($v13e76aba2d, $v6490ea3a15) !== false; } else $v5c1c342594 = true; } else { $v6490ea3a15 = self::f4d0bc7e944($v98a8251725); $v5c1c342594 = file_put_contents($v13e76aba2d, $v6490ea3a15) !== false; } $v6f181849e4 = $pb0d8d323 . "/tmp/"; if (is_dir($v6f181849e4)) chmod($v6f181849e4, 0755); return $v5c1c342594; } public static function isEnabled($pb0d8d323) { $v5c1c342594 = false; if ($pb0d8d323 && is_dir($pb0d8d323)) { $v13e76aba2d = $pb0d8d323 . "/config.inc.php"; if (file_exists($v13e76aba2d)) { $v6490ea3a15 = file_get_contents($v13e76aba2d); $v98a8251725 = self::f9bf676f9ab($pb0d8d323); $v64d618328f = preg_match("/include_once ". preg_quote($v98a8251725, "/") . ";/", $v6490ea3a15); $v5c1c342594 = $v64d618328f; } } return $v5c1c342594; } private static function f9bf676f9ab($pb0d8d323) { $pb0d8d323 = preg_replace("/\/+/", "/", $pb0d8d323); $v98a8251725 = substr($pb0d8d323, strlen(CMS_PATH)); $v98a8251725 = preg_replace("/(^\/|\/$)/", "", $v98a8251725); $v7354cde23e = substr_count($v98a8251725, '/') + 1; $v98a8251725 = "__DIR__ . '/" . str_repeat("../", $v7354cde23e) . "app/lib/org/phpframework/cms/phpmyadmin/init_db_credentials_for_phpmyadmin.php'"; return $v98a8251725; } private static function f4d0bc7e944($pd5f6432d) { $v40a0bbe826 = bin2hex(random_bytes(32)); return '<?php
/**
