...
?>'; if (file_exists($pf3dc0762)) { $v6490ea3a15 = trim(file_get_contents($pf3dc0762)); $v6490ea3a15 = preg_replace('/\$allowed_list_and_edit_users_types(\s*)=(\s*)([^;]*)(\s*);/i', '', $v6490ea3a15); $v6490ea3a15 = preg_replace('/if\s*\(\s*!\s*\$GLOBALS\s*\[\s*("|\')UserSessionActivitiesHandler("|\')\s*\]\s*\)\s*\{\s*@?(include_once|include)\s*\$EVC\s*\->\s*getUtilPath\s*\(\s*("|\')user_session_activities_handler("|\')\s*,\s*\$EVC\s*\->\s*getCommonProjectName\s*\(\s*\)\s*\)\s*;\s*@?initUserSessionActivitiesHandler\s*\(\s*\$EVC\s*\)\s*;\s*\}/i', '', $v6490ea3a15); $v6490ea3a15 = preg_replace('/if\s*\(\s*empty\(\s*\$GLOBALS\s*\[\s*("|\')UserSessionActivitiesHandler("|\')\s*\]\s*\)\s*\)\s*\{\s*@?(include_once|include)\s*\$EVC\s*\->\s*getUtilPath\s*\(\s*("|\')user_session_activities_handler("|\')\s*,\s*\$EVC\s*\->\s*getCommonProjectName\s*\(\s*\)\s*\)\s*;\s*if\s*\(\s*function_exists\s*\(\s*("|\')initUserSessionActivitiesHandler("|\')\s*\)\s*\)\s*@?initUserSessionActivitiesHandler\s*\(\s*\$EVC\s*\)\s*;\s*\}/i', '', $v6490ea3a15); $v6490ea3a15 = preg_replace('/if\s*\(\s*\$GLOBALS\[\s*("|\')UserSessionActivitiesHandler("|\')\s*\]\s*&&\s*\$allowed_list_and_edit_users_types\s*\)\s*\n*\s*\{\s*\n*\s*\$logged_user_data\s*=\s*\$GLOBALS\[\s*("|\')UserSessionActivitiesHandler("|\')\s*\]\-\>getUserData\(\)\s*;\s*\n*\s*\$logged_user_type_ids\s*=\s*\$logged_user_data(\s*&&\s*isset\s*\(\s*\$logged_user_data\[\s*("|\')user_type_ids("|\')\s*\]\s*\))?\s*\?\s*\$logged_user_data\s*\[\s*("|\')user_type_ids("|\')\s*\]\s*\:\s*null\s*;\s*\n*\s*\$allowed\s*=\s*false\s*;\s*\n*if\s*\(\s*is_array\s*\(\s*\$logged_user_type_ids\s*\)\s*\)\s*\n*\s*foreach\s*\(\s*\$logged_user_type_ids\s*as\s*\$ut_id\s*\)\s*\n*\s*if\s*\(\s*in_array\s*\(\s*\$ut_id\s*,\s*\$allowed_list_and_edit_users_types\s*\)\s*\)\s*\{\s*\n*\$allowed\s*=\s*true\s*;\s*\n*\s*break\s*;\s*\n*\s*\}\s*\n*\s*if\s*\(\s*\!\s*\$allowed\s*\)\s*\n*\s*\}\s*\n*/i', '', $v6490ea3a15); $v6490ea3a15 = preg_replace('/\$[\w\$=\s]+\s*=\s*null\s*;\s*/iu', '', $v6490ea3a15); $v6490ea3a15 .= $pfe5fee27; $v6490ea3a15 = str_replace(array("?><?php", "?><?", "\r"), "", $v6490ea3a15); $v6490ea3a15 = preg_replace("/\?>\s*<\?php/", "", $v6490ea3a15); $v6490ea3a15 = preg_replace("/\?>\s*<\?/", "", $v6490ea3a15); $v6490ea3a15 = preg_replace("/\n+/", "\n", preg_replace("/\s*\n\s*/", "\n", $v6490ea3a15)); } else { $v6490ea3a15 = $pfe5fee27; if (!is_dir($v17be587282)) mkdir($v17be587282, 0755, true); } return is_dir($v17be587282) && file_put_contents($pf3dc0762, $v6490ea3a15) !== false; } public static function addVarsFile($v188b4f5fa6, $pd763cc84, $v761f4d757f) { $v067674f4e4 = ''; if ($v761f4d757f) foreach ($v761f4d757f as $v1cfba8c105 => $pa6209df1) $v067674f4e4 .= '$' . $v1cfba8c105 . ' = "' . addcslashes($pa6209df1, '"') . '";' . "\n"; $v067674f4e4 = '<?php
' . trim($v067674f4e4) . '
?>'; $pf3dc0762 = $v188b4f5fa6->getConfigPath($pd763cc84); $v17be587282 = dirname($pf3dc0762); if (file_exists($pf3dc0762)) { $v6490ea3a15 = trim(file_get_contents($pf3dc0762)); if ($v761f4d757f) foreach ($v761f4d757f as $v1cfba8c105 => $pa6209df1) { do { preg_match('/(\$' . $v1cfba8c105 . ')(\s*)=(\s*)/iu', $v6490ea3a15, $pbae7526c, PREG_OFFSET_CAPTURE); if (!empty($pbae7526c[0])) { $v6107abf109 = $pbae7526c[0]; $v5c7334c53d = $v6107abf109[0]; $pac65f06f = $v6107abf109[1]; $v79b7cb19d1 = $v66327139f0 = false; $pe2ae3be9 = strlen($v6490ea3a15); $v5c74807c6a = $pac65f06f + strlen($v5c7334c53d); $pd2282eb2 = $pe2ae3be9; for ($v9d27441e80 = $v5c74807c6a; $v9d27441e80 < $pe2ae3be9; $v9d27441e80++) { $pc288256e = $v6490ea3a15[$v9d27441e80]; if ($pc288256e == '"' && !$v66327139f0 && !TextSanitizer::isCharEscaped($v6490ea3a15, $v9d27441e80)) $v79b7cb19d1 = !$v79b7cb19d1; else if ($pc288256e == "'" && !$v79b7cb19d1 && !TextSanitizer::isCharEscaped($v6490ea3a15, $v9d27441e80)) $v66327139f0 = !$v66327139f0; else if ($pc288256e == ";" && !$v66327139f0 && !$v79b7cb19d1) { $pd2282eb2 = $v9d27441e80 + 1; if (substr($v6490ea3a15, $pd2282eb2, 1) == "\n") $pd2282eb2++; break; } } $v391cc249fc = substr($v6490ea3a15, $pac65f06f, $pd2282eb2 - $pac65f06f); $v6490ea3a15 = str_replace($v391cc249fc, "", $v6490ea3a15); } } while ($pbae7526c && !empty($pbae7526c[0])); } $v6490ea3a15 .= $v067674f4e4; $v6490ea3a15 = str_replace(array("?><?php", "?><?", "\r"), "", $v6490ea3a15); $v6490ea3a15 = preg_replace("/\?>\s*<\?php/", "", $v6490ea3a15); $v6490ea3a15 = preg_replace("/\?>\s*<\?/", "", $v6490ea3a15); $v6490ea3a15 = preg_replace("/\n+/", "\n", preg_replace("/\s*\n\s*/", "\n", $v6490ea3a15)); } else { $v6490ea3a15 = $v067674f4e4; if (!is_dir($v17be587282)) mkdir($v17be587282, 0755, true); } return is_dir($v17be587282) && file_put_contents($pf3dc0762, $v6490ea3a15) !== false; } public static function createPageFile($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $pe7333513, &$v2e8aa9d64e, &$v1b7f0d0c99, &$v0fd98ea3ab, $v1d696dbd12, $v7f5911d32d, $pccb248b8 = false, $v28bb4bea47 = false, &$pef34936b = false, &$pb39a0a9c = false) { $v250a1176c9 = self::mee7f8e059cfa($v7f5911d32d); $pfbb6ee46 = isset($v7f5911d32d["tag"]) ? $v7f5911d32d["tag"] : null; $v876c18d646 = isset($v7f5911d32d["properties"]["files_to_create"]) ? $v7f5911d32d["properties"]["files_to_create"] : null; $v53a57f1353 = isset($v7f5911d32d["properties"]["page_settings"]) ? $v7f5911d32d["properties"]["page_settings"] : null; $v7943b46e77 = null; $pf6b7bac7 = trim($pf6b7bac7); if ($pf6b7bac7 && substr($pf6b7bac7, -1) != "/") $pf6b7bac7 .= "/"; $v7943b46e77 = !empty($v7f5911d32d["properties"]["authentication_type"]) ? array( "authentication_type" => isset($v7f5911d32d["properties"]["authentication_type"]) ? $v7f5911d32d["properties"]["authentication_type"] : null, "authentication_users" => isset($v7f5911d32d["properties"]["authentication_users"]) ? $v7f5911d32d["properties"]["authentication_users"] : null, ) : null; if ($pfbb6ee46 == "page") { $v30d38c7973 = self::md1303a72d528($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $pe7333513, $v2e8aa9d64e, $v1b7f0d0c99, $v0fd98ea3ab, $v1d696dbd12, $v7f5911d32d, $pef34936b, $pb39a0a9c); } else $v30d38c7973 = self::mcfa7aa8fab54($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $pe7333513, $v2e8aa9d64e, $v1b7f0d0c99, $v0fd98ea3ab, $v1d696dbd12, $v7f5911d32d, $pccb248b8, $v28bb4bea47 . $v250a1176c9 . "/", false, $v7943b46e77, $pef34936b, $pb39a0a9c); if (!$v30d38c7973) return false; if ($pccb248b8) { $v0fd98ea3ab .= ($v0fd98ea3ab && !empty($v30d38c7973["js"]) ? "\n" : "") . (isset($v30d38c7973["js"]) ? $v30d38c7973["js"] : ""); $v30d38c7973["js"] = ""; } else { $v40b70e70c3 = self::f3eb8f3f6a9($v1b7f0d0c99); if ($v40b70e70c3) $v30d38c7973["js"] = $v40b70e70c3 . "\n" . $v0fd98ea3ab . "\n" . (isset($v30d38c7973["js"]) ? $v30d38c7973["js"] : ""); } $v5c1c342594 = self::f67d92f51be($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v98a8251725 . $v28bb4bea47 . $v250a1176c9, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $pe7333513, $v2e8aa9d64e, $v30d38c7973, isset($v7f5911d32d["id"]) ? $v7f5911d32d["id"] : null, $v876c18d646, "local", $v7943b46e77, $pef34936b, $v53a57f1353, $pb39a0a9c); return $v5c1c342594; } private static function md1303a72d528($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $pe7333513, &$v2e8aa9d64e, &$v1b7f0d0c99, &$v0fd98ea3ab, $v1d696dbd12, $v7f5911d32d, &$pef34936b, &$pb39a0a9c) { $v250a1176c9 = self::mee7f8e059cfa($v7f5911d32d); $pef349725 = isset($v7f5911d32d["properties"]) ? $v7f5911d32d["properties"] : null; $v9df16de072 = isset($pef349725["join_type"]) ? $pef349725["join_type"] : null; $v5ed3bcae90 = isset($pef349725["links"]) ? $pef349725["links"] : null; $pa752cc18 = isset($pef349725["pre_form_settings"]) ? $pef349725["pre_form_settings"] : null; $v09aa1ddf8f = isset($pef349725["pos_form_settings"]) ? $pef349725["pos_form_settings"] : null; $v678baef824 = isset($v7f5911d32d["exits"]["default_exit"]) ? $v7f5911d32d["exits"]["default_exit"] : null; $v678baef824 = !empty($v678baef824[0]) ? $v678baef824 : array($v678baef824); $v1f377b389c = isset($v7f5911d32d["tasks"]) ? $v7f5911d32d["tasks"] : null; $v7943b46e77 = !empty($v7f5911d32d["properties"]["authentication_type"]) ? array( "authentication_type" => isset($v7f5911d32d["properties"]["authentication_type"]) ? $v7f5911d32d["properties"]["authentication_type"] : null, "authentication_users" => isset($v7f5911d32d["properties"]["authentication_users"]) ? $v7f5911d32d["properties"]["authentication_users"] : null, ) : null; $v5ed3bcae90 = self::f3429787ad7($v5ed3bcae90); $v370576c033 = $v9df16de072 == "tabs"; $v30d38c7973 = array( "actions" => array(), "css" => "", "js" => "", ); if ($pa752cc18) { if (!empty($pa752cc18["actions"])) { $pa752cc18["actions"] = isset($pa752cc18["actions"]["action_type"]) || isset($pa752cc18["actions"]["action_value"]) ? $pa752cc18["actions"] : array($pa752cc18["actions"]); $v30d38c7973["actions"] = $pa752cc18["actions"]; } if (!empty($pa752cc18["css"])) $v30d38c7973["css"] = $pa752cc18["css"]; if (!empty($pa752cc18["js"])) $v30d38c7973["js"] = $pa752cc18["js"]; } if ($v1f377b389c) { $v516837ee42 = $v370576c033 ? "tabs_tasks_html" : false; foreach ($v1f377b389c as $pd12cba7e => $pa53fc09c) { $v068fa04e3e = self::mcfa7aa8fab54($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $pe7333513, $v2e8aa9d64e, $v1b7f0d0c99, $v0fd98ea3ab, $v1d696dbd12, $pa53fc09c, $v7f5911d32d, $v250a1176c9 . "/", $v516837ee42, $v7943b46e77, $pef34936b, $pb39a0a9c); if (!$v068fa04e3e) return false; $v30d38c7973["actions"] = array_merge($v30d38c7973["actions"], $v068fa04e3e["actions"]); $v30d38c7973["css"] .= !empty($v068fa04e3e["css"]) ? "\n\n" . $v068fa04e3e["css"] : ""; $v30d38c7973["js"] .= !empty($v068fa04e3e["js"]) ? "\n\n" . $v068fa04e3e["js"] : ""; } if ($v370576c033) { $pf8ed4912 = '<div class="tabs">
	<ul>'; $v151122e7dd = ''; $v43dd7d0051 = 0; foreach ($v1f377b389c as $pd12cba7e => $pa53fc09c) { $v9acc88059e = isset($pa53fc09c["label"]) ? ucwords(strtolower(str_replace("_", " ", $pa53fc09c["label"]))) : ""; $pf8ed4912 .= '
	...
	' . $v151122e7dd . '
		...
		<li class="link link-free ' . (isset($pdeee6a59["class"]) ? $pdeee6a59["class"] : "") . '">
			' . (isset($pdeee6a59["previous_html"]) ? $pdeee6a59["previous_html"] : "") . '
			<a href="' . (isset($pdeee6a59["url"]) ? $pdeee6a59["url"] : "") . '" title="' . (isset($pdeee6a59["title"]) ? $pdeee6a59["title"] : "") . '"' . (!empty($pdeee6a59["target"]) ? 'target="' . $pdeee6a59["target"] . '"' : '') . '>' . (isset($pdeee6a59["value"]) ? $pdeee6a59["value"] : "") . '</a>
			' . (isset($pdeee6a59["next_html"]) ? $pdeee6a59["next_html"] : "") . '
		</li>'; } if ($v678baef824) for ($v43dd7d0051 = 0; $v43dd7d0051 < count($v678baef824); $v43dd7d0051++) { $v5b242fbd41 = $v678baef824[$v43dd7d0051]; $v965b5b3a0d = isset($v5b242fbd41["label"]) ? $v5b242fbd41["label"] : null; $v002556527f = isset($v5b242fbd41["properties"]["connection_type"]) ? $v5b242fbd41["properties"]["connection_type"] : null; $pbae0a0a1 = isset($v5b242fbd41["properties"]["connection_title"]) ? $v5b242fbd41["properties"]["connection_title"] : null; $pdcf4a554 = isset($v5b242fbd41["properties"]["connection_class"]) ? $v5b242fbd41["properties"]["connection_class"] : null; $v3ee652c2b9 = isset($v5b242fbd41["properties"]["connection_target"]) ? $v5b242fbd41["properties"]["connection_target"] : null; $pf6db3176 = isset($v5b242fbd41["task_id"]) ? $v5b242fbd41["task_id"] : null; $v7b98c1186c = self::f1c3b9b59c1($v1d696dbd12, $pf6db3176); $pc76e0209 = isset($v7b98c1186c["tag"]) ? $v7b98c1186c["tag"] : null; if ($v7b98c1186c && $pc76e0209 != "page") $v7b98c1186c = self::f2fa4395443($v1d696dbd12, $v7b98c1186c); if ($v7b98c1186c) { $pb0067554 = '{$project_url_prefix}' . $v98a8251725 . self::mee7f8e059cfa($v7b98c1186c); $pe0a01068 = isset($v7b98c1186c["label"]) ? ucwords(strtolower(str_replace("_", " ", $v7b98c1186c["label"]))) : ""; $v965b5b3a0d = $v965b5b3a0d ? $v965b5b3a0d : $pe0a01068; $pbae0a0a1 = $pbae0a0a1 ? $pbae0a0a1 : $v965b5b3a0d; if ($v002556527f == "popup") { $v1b7f0d0c99["iframe_popup"] = true; $v81edb34617 .= '
		...
		</li>'; } } if ($v81edb34617) $v30d38c7973["actions"][] = array( "result_var_name" => "", "action_type" => "html", "condition_type" => "execute_always", "condition_value" => "", "action_value" => array( "ptl" => array( "code" => '<ul class="links">' . $v81edb34617 . "\n</ul>" ) ) ); if ($v09aa1ddf8f) { if (!empty($v09aa1ddf8f["actions"])) { $v09aa1ddf8f["actions"] = isset($v09aa1ddf8f["actions"]["action_type"]) || isset($v09aa1ddf8f["actions"]["action_value"]) ? $v09aa1ddf8f["actions"] : array($v09aa1ddf8f["actions"]); $v30d38c7973["actions"] = array_merge($v30d38c7973["actions"], $v09aa1ddf8f["actions"]); } if (!empty($v09aa1ddf8f["css"])) $v30d38c7973["css"] .= "\n\n" . $v09aa1ddf8f["css"]; if (!empty($v09aa1ddf8f["js"])) $v30d38c7973["js"] .= "\n\n" . $v09aa1ddf8f["js"]; } return $v30d38c7973; } private static function mcfa7aa8fab54($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $pe7333513, &$v2e8aa9d64e, &$v1b7f0d0c99, &$v0fd98ea3ab, $v1d696dbd12, $v7f5911d32d, $pccb248b8, $v28bb4bea47, $v516837ee42 = false, $v7943b46e77 = null, &$pef34936b = false, &$pb39a0a9c = false) { $v8282c7dd58 = isset($v7f5911d32d["id"]) ? $v7f5911d32d["id"] : null; $pfbb6ee46 = isset($v7f5911d32d["tag"]) ? $v7f5911d32d["tag"] : null; $pef349725 = isset($v7f5911d32d["properties"]) ? $v7f5911d32d["properties"] : null; $pe59b744b = isset($pef349725["choose_db_table"]) ? $pef349725["choose_db_table"] : null; $v9d7547e4d6 = isset($pe59b744b["db_table"]) ? $pe59b744b["db_table"] : null; $v872f5b4dbb = isset($pe59b744b["db_driver"]) ? $pe59b744b["db_driver"] : null; $v6cc00e79ac = isset($pe59b744b["db_type"]) ? $pe59b744b["db_type"] : null; $v8b13fa2358 = isset($pe59b744b["include_db_driver"]) ? $pe59b744b["include_db_driver"] : null; $pfdbbc383 = isset($pef349725["attributes"]) ? $pef349725["attributes"] : null; $v55bd236ac1 = isset($pef349725["action"]) ? $pef349725["action"] : null; $v5ed3bcae90 = isset($pef349725["links"]) ? $pef349725["links"] : null; $pa752cc18 = isset($pef349725["pre_form_settings"]) ? $pef349725["pre_form_settings"] : null; $v09aa1ddf8f = isset($pef349725["pos_form_settings"]) ? $pef349725["pos_form_settings"] : null; $v487b7d34ae = isset($pef349725["brokers_services_and_rules"]) ? $pef349725["brokers_services_and_rules"] : null; $pabde73f0 = isset($pef349725["pagination"]) ? $pef349725["pagination"] : null; $v876c18d646 = isset($pef349725["files_to_create"]) ? $pef349725["files_to_create"] : null; $v1f377b389c = isset($v7f5911d32d["tasks"]) ? $v7f5911d32d["tasks"] : null; $v678baef824 = isset($v7f5911d32d["exits"]["default_exit"]) ? $v7f5911d32d["exits"]["default_exit"] : null; $v678baef824 = !empty($v678baef824[0]) ? $v678baef824 : array($v678baef824); $pa929f3e8 = isset($pef349725["users_perms"]) ? $pef349725["users_perms"] : null; $pef34936b = array(); if (is_array($pa929f3e8)) { if (array_key_exists("user_type_id", $pa929f3e8) || array_key_exists("activity_id", $pa929f3e8)) $pa929f3e8 = array($pa929f3e8); foreach ($pa929f3e8 as $pd69fb7d0 => $v74b37bf978) if (isset($v74b37bf978["user_type_id"]) && is_numeric($v74b37bf978["user_type_id"]) && isset($v74b37bf978["activity_id"]) && is_numeric($v74b37bf978["activity_id"])) $pef34936b[] = $v74b37bf978; } $v5ed3bcae90 = self::f3429787ad7($v5ed3bcae90); $v9a4a47d31e = array( $v9d7547e4d6 => isset($pe59b744b["db_table_alias"]) ? $pe59b744b["db_table_alias"] : null ); $v44ffadba90 = $pccb248b8 && isset($pccb248b8["tag"]) && ($pccb248b8["tag"] == "listing" || $pccb248b8["tag"] == "form" || $pccb248b8["tag"] == "view"); $pa8f6b97e = self::f57c62455ca($v7f5911d32d, $pccb248b8); if ($pfbb6ee46 == "listing") { $v4ff9a1a8d7 = isset($pef349725["listing_type"]) ? $pef349725["listing_type"] : null; $pb3f8356a = $v4ff9a1a8d7 == "tree" ? "list_form" : ($v4ff9a1a8d7 == "multi_form" ? "multiple_form" : "list_table"); } else $pb3f8356a = $v44ffadba90 && !$pa8f6b97e ? "multiple_form" : "single_form"; $v28bb4bea47 .= self::mee7f8e059cfa($v7f5911d32d) . "/"; if (($pb3f8356a == "list_table" || $pb3f8356a == "list_form") && $pabde73f0 && !empty($pabde73f0["active"])) { if ($v44ffadba90) { $pabde73f0["on_click_js_func"] = "loadEmbededPageWithNewNavigation"; $v1b7f0d0c99["ajax_navigation"] = true; } else if ($v516837ee42) { $pabde73f0["on_click_js_func"] = "loadTabPageWithNewNavigation"; $v1b7f0d0c99["ajax_tab_navigation"] = true; } } else if ($pb3f8356a == "multiple_form") { if ($v44ffadba90) { $pabde73f0 = array("on_click_js_func" => "loadEmbededPageWithNewNavigation"); $v1b7f0d0c99["ajax_navigation"] = true; } else if ($v516837ee42) { $pabde73f0["on_click_js_func"] = "loadTabPageWithNewNavigation"; $v1b7f0d0c99["ajax_tab_navigation"] = true; } } else $pabde73f0 = array("active" => false); $v108a6b4e42 = array(); if ($pfdbbc383) foreach ($pfdbbc383 as $pe5c5e2fe => $v97915b9670) { $v7162e23723 = !empty($v97915b9670["name"]) ? $v97915b9670["name"] : $pe5c5e2fe; $v108a6b4e42[$v7162e23723] = $v97915b9670; } $pfdbbc383 = $v108a6b4e42; $v30857f7eca[$v9d7547e4d6] = array( "panel_type" => $pb3f8356a, "panel_id" => $v8282c7dd58, "panel_class" => "task-panel " . $v8282c7dd58 . (!empty($pef349725["interface_class"]) ? " " . $pef349725["interface_class"] : ""), "panel_previous_html" => isset($pef349725["interface_previous_html"]) ? $pef349725["interface_previous_html"] : null, "panel_next_html" => isset($pef349725["interface_next_html"]) ? $pef349725["interface_next_html"] : null, "form_type" => "settings", "attributes" => array_keys($pfdbbc383), "actions" => array( "links" => $v5ed3bcae90, "attributes_settings" => $pfdbbc383, ), "pagination" => $pabde73f0, "conditions" => array(), ); if (!empty($pe59b744b["db_table_conditions"])) { if (isset($pe59b744b["db_table_conditions"]["attribute"]) || isset($pe59b744b["db_table_conditions"]["value"])) $pe59b744b["db_table_conditions"] = array($pe59b744b["db_table_conditions"]); foreach ($pe59b744b["db_table_conditions"] as $pd69fb7d0 => $v2566fc2579) $v30857f7eca[$v9d7547e4d6]["conditions"][] = array( "column" => $v2566fc2579["attribute"], "table" => $pe59b744b["db_table_parent"] ? $pe59b744b["db_table_parent"] : $v9d7547e4d6, "value" => $v2566fc2579["value"], ); } if (!empty($pe59b744b["db_table_parent"])) $v30857f7eca[$v9d7547e4d6]["table_parent"] = $pe59b744b["db_table_parent"]; if ($v487b7d34ae) foreach ($v487b7d34ae as $v15972e4042 => $pa00bfad8) { $pbb76dfac = false; $v88bb618d40 = isset($pa00bfad8["brokers_layer_type"]) ? $pa00bfad8["brokers_layer_type"] : null; switch ($v88bb618d40) { case "callbusinesslogic": case "callibatisquery": case "callhibernatemethod": $pbb76dfac = empty($pa00bfad8["service_id"]); break; case "getquerydata": case "setquerydata": $pbb76dfac = empty($pa00bfad8["sql"]); break; } if ($pbb76dfac) unset($v487b7d34ae[$v15972e4042]); } $v30857f7eca[$v9d7547e4d6]["brokers"] = $v487b7d34ae; $pf5de42d9 = (!empty($v487b7d34ae["insert"]) || !empty($v30857f7eca[$v9d7547e4d6]["actions"]["insert"])) && empty($v487b7d34ae["update"]) && empty($v487b7d34ae["delete"]) && empty($v30857f7eca[$v9d7547e4d6]["actions"]["update"]) && empty($v30857f7eca[$v9d7547e4d6]["actions"]["delete"]); if ($pb3f8356a == "single_form" && empty($v487b7d34ae["get"]) && !$pf5de42d9) $v30857f7eca[$v9d7547e4d6]["actions"]["get"] = array("action" => "get"); if ($pb3f8356a != "single_form" && empty($v487b7d34ae["get_all"])) { if ($v44ffadba90) { $v1ab8360145 = isset($pccb248b8["properties"]["choose_db_table"]["db_table"]) ? $pccb248b8["properties"]["choose_db_table"]["db_table"] : null; if ($v1ab8360145 != $v9d7547e4d6) $v30857f7eca[$v9d7547e4d6]["table_parent"] = $v1ab8360145; $paf1bc6f6 = self::f96b3f1ab58($v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v8ffce2a791, $pa0462a8e, $v872f5b4dbb, $v6cc00e79ac, $v1ab8360145, $v9d7547e4d6); $v30857f7eca[$v9d7547e4d6]["conditions"] = array_merge($v30857f7eca[$v9d7547e4d6]["conditions"], $paf1bc6f6); } else if (!empty($v487b7d34ae["parents_get_all"]) && !empty($v487b7d34ae["parents_count"])) { $v30857f7eca[$v9d7547e4d6]["brokers"]["get_all"] = $v487b7d34ae["parents_get_all"]; $v30857f7eca[$v9d7547e4d6]["brokers"]["count"] = $v487b7d34ae["parents_count"]; } else if (!empty($pe59b744b["db_table_parent"])) { $paf1bc6f6 = self::f96b3f1ab58($v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v8ffce2a791, $pa0462a8e, $v872f5b4dbb, $v6cc00e79ac, $pe59b744b["db_table_parent"], $v9d7547e4d6); $v30857f7eca[$v9d7547e4d6]["conditions"] = array_merge($v30857f7eca[$v9d7547e4d6]["conditions"], $paf1bc6f6); } } self::ma4259f841757($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, "single_", "insert", $v44ffadba90, $pb3f8356a, $v516837ee42, $v7943b46e77, $pef34936b); self::ma4259f841757($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, "single_", "update", $v44ffadba90, $pb3f8356a, $v516837ee42, $v7943b46e77, $pef34936b); self::ma4259f841757($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, "single_", "delete", $v44ffadba90, $pb3f8356a, $v516837ee42, $v7943b46e77, $pef34936b); self::ma4259f841757($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, "multiple_", "insert", $v44ffadba90, $pb3f8356a, $v516837ee42, $v7943b46e77, $pef34936b); self::ma4259f841757($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, "multiple_", "update", $v44ffadba90, $pb3f8356a, $v516837ee42, $v7943b46e77, $pef34936b); self::ma4259f841757($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, "multiple_", "delete", $v44ffadba90, $pb3f8356a, $v516837ee42, $v7943b46e77, $pef34936b); if ($v1f377b389c) { $v5768afccea = "ajax"; foreach ($v1f377b389c as $pd12cba7e => $pa53fc09c) { $pd12cba7e = isset($pa53fc09c["id"]) ? $pa53fc09c["id"] : null; $v9e98e70fd3 = isset($pa53fc09c["label"]) ? $pa53fc09c["label"] : null; $v2e6ac2dd33 = isset($pa53fc09c["properties"]) ? $pa53fc09c["properties"] : null; $v0ec3afeef5 = isset($v2e6ac2dd33["parent_link_value"]) ? $v2e6ac2dd33["parent_link_value"] : null; $pfc1f8ace = isset($v2e6ac2dd33["parent_link_title"]) ? $v2e6ac2dd33["parent_link_title"] : null; $paab95b02 = isset($v2e6ac2dd33["interface_type"]) ? $v2e6ac2dd33["interface_type"] : null; $pb21bb581 = '{$project_url_prefix}' . $v98a8251725 . $v28bb4bea47 . self::mee7f8e059cfa($pa53fc09c); $pfb80a61e = $paab95b02 == "popup" ? "return openPopup(this, '$pb21bb581')" : "return openEmbed(this, '$pb21bb581')"; $v1b7f0d0c99[$paab95b02] = true; $v30857f7eca[$v9d7547e4d6]["actions"]["links"][] = array( "url" => "javascript:void(0)", "value" => strlen($v0ec3afeef5) ? $v0ec3afeef5 : $v9e98e70fd3, "title" => strlen($pfc1f8ace) ? $pfc1f8ace : $v9e98e70fd3, "class" => isset($v2e6ac2dd33["parent_link_class"]) ? $v2e6ac2dd33["parent_link_class"] : null, "extra_attributes" => array( array("name" => "onClick", "value" => $pfb80a61e) ), "previous_html" => isset($v2e6ac2dd33["parent_link_previous_html"]) ? $v2e6ac2dd33["parent_link_previous_html"] : null, "next_html" => isset($v2e6ac2dd33["parent_link_next_html"]) ? $v2e6ac2dd33["parent_link_next_html"] : null, ); if ($v7943b46e77) { $pa53fc09c["properties"]["authentication_type"] = isset($v7943b46e77["authentication_type"]) ? $v7943b46e77["authentication_type"] : null; $pa53fc09c["properties"]["authentication_users"] = isset($v7943b46e77["authentication_users"]) ? $v7943b46e77["authentication_users"] : null; } if (!self::createPageFile($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v5768afccea, $v2e8aa9d64e, $v1b7f0d0c99, $v0fd98ea3ab, $v1d696dbd12, $pa53fc09c, $v7f5911d32d, $v28bb4bea47, $pef34936b, $pb39a0a9c)) return false; } } if ($v678baef824) for ($v43dd7d0051 = 0; $v43dd7d0051 < count($v678baef824); $v43dd7d0051++) { $v5b242fbd41 = $v678baef824[$v43dd7d0051]; $v965b5b3a0d = isset($v5b242fbd41["label"]) ? $v5b242fbd41["label"] : null; $v002556527f = isset($v5b242fbd41["properties"]["connection_type"]) ? $v5b242fbd41["properties"]["connection_type"] : null; $pbae0a0a1 = isset($v5b242fbd41["properties"]["connection_title"]) ? $v5b242fbd41["properties"]["connection_title"] : null; $pdcf4a554 = isset($v5b242fbd41["properties"]["connection_class"]) ? $v5b242fbd41["properties"]["connection_class"] : null; $v3ee652c2b9 = isset($v5b242fbd41["properties"]["connection_target"]) ? $v5b242fbd41["properties"]["connection_target"] : null; $pf6db3176 = isset($v5b242fbd41["task_id"]) ? $v5b242fbd41["task_id"] : null; $v7b98c1186c = self::f1c3b9b59c1($v1d696dbd12, $pf6db3176); $pc76e0209 = isset($v7b98c1186c["tag"]) ? $v7b98c1186c["tag"] : null; if ($v7b98c1186c && $pc76e0209 != "page") $v7b98c1186c = self::f2fa4395443($v1d696dbd12, $v7b98c1186c); if ($v7b98c1186c) { $pb0067554 = '{$project_url_prefix}' . $v98a8251725 . self::mee7f8e059cfa($v7b98c1186c); $pe0a01068 = isset($v7b98c1186c["label"]) ? ucwords(strtolower(str_replace("_", " ", $v7b98c1186c["label"]))) : ""; $v965b5b3a0d = $v965b5b3a0d ? $v965b5b3a0d : $pe0a01068; $pbae0a0a1 = $pbae0a0a1 ? $pbae0a0a1 : $v965b5b3a0d; if ($v002556527f == "popup") { $v1b7f0d0c99["iframe_popup"] = true; $v30857f7eca[$v9d7547e4d6]["actions"]["links"][] = array( "url" => "javascript:void(0)", "value" => $v965b5b3a0d, "title" => $pbae0a0a1, "class" => $pdcf4a554, "extra_attributes" => array( array("name" => "onClick", "value" => "return openIframePopup(this, '$pb0067554')") ), ); } else if ($v002556527f == "parent") { $v1b7f0d0c99["parent"] = true; $v30857f7eca[$v9d7547e4d6]["actions"]["links"][] = array( "url" => "javascript:void(0)", "value" => $v965b5b3a0d, "title" => $pbae0a0a1, "class" => $pdcf4a554, "extra_attributes" => array( array("name" => "onClick", "value" => "return openParentLocation(this, '$pb0067554')") ), ); } else $v30857f7eca[$v9d7547e4d6]["actions"]["links"][] = array( "url" => $pb0067554, "value" => $v965b5b3a0d, "title" => $pbae0a0a1, "class" => $pdcf4a554, "target" => $v3ee652c2b9, ); } } $v0b166cf50c = self::f4280f7a6c1($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v872f5b4dbb); $v826d0ddb62 = self::f90bb9f56e7($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v872f5b4dbb); $pb09c0b5b = self::f8a1714bd98($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v8b13fa2358); $v30d38c7973 = CMSPresentationFormSettingsUIHandler::getFormSettings($v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, null, $v0b166cf50c, $v826d0ddb62, $pb09c0b5b, $v872f5b4dbb, $v8b13fa2358, $v6cc00e79ac, $v9a4a47d31e, $v30857f7eca, false, $v0fd98ea3ab, $v516837ee42, $pef34936b, $pb39a0a9c); if ($pa752cc18) { if (!empty($pa752cc18["actions"])) { $pa752cc18["actions"] = isset($pa752cc18["actions"]["action_type"]) || isset($pa752cc18["actions"]["action_value"]) ? $pa752cc18["actions"] : array($pa752cc18["actions"]); $v30d38c7973["actions"] = array_merge($pa752cc18["actions"], $v30d38c7973["actions"]); } if (!empty($pa752cc18["css"])) $v30d38c7973["css"] = $pa752cc18["css"] . (!empty($v30d38c7973["css"]) ? "\n\n" . $v30d38c7973["css"] : ""); if (!empty($pa752cc18["js"])) $v30d38c7973["js"] = $pa752cc18["js"] . (!empty($v30d38c7973["js"]) ? "\n\n" . $v30d38c7973["js"] : ""); } if ($v09aa1ddf8f) { if (!empty($v09aa1ddf8f["actions"])) { $v09aa1ddf8f["actions"] = isset($v09aa1ddf8f["actions"]["action_type"]) || isset($v09aa1ddf8f["actions"]["action_value"]) ? $v09aa1ddf8f["actions"] : array($v09aa1ddf8f["actions"]); $v30d38c7973["actions"] = array_merge($v30d38c7973["actions"], $v09aa1ddf8f["actions"]); } if (!empty($v09aa1ddf8f["css"])) $v30d38c7973["css"] .= "\n\n" . $v09aa1ddf8f["css"]; if (!empty($v09aa1ddf8f["js"])) $v30d38c7973["js"] .= "\n\n" . $v09aa1ddf8f["js"]; } $v30d38c7973["actions"] = array( array( "result_var_name" => "", "action_type" => "group", "condition_type" => "execute_always", "condition_value" => "", "action_value" => array( "group_name" => "", "actions" => isset($v30d38c7973["actions"]) ? $v30d38c7973["actions"] : null, ), ) ); return $v30d38c7973; } private static function ma4259f841757($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, &$v2e8aa9d64e, $v28bb4bea47, &$v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, $v8ff80a1320, $v256e3a39a7, $v44ffadba90, $pb3f8356a, $v516837ee42, $v7943b46e77, $pef34936b) { $v9f2f9d92a3 = $v8ff80a1320 . $v256e3a39a7; if (!empty($v55bd236ac1[$v9f2f9d92a3])) { $v313ffa5f74 = '{$project_url_prefix}' . $v98a8251725 . substr($v28bb4bea47, 0, -1) . "_"; $pa8b4b2c5 = $pb3f8356a == "list_table" || $pb3f8356a == "list_form"; $pbf2a75a9 = $v8ff80a1320 == "multiple_"; $pa0def03f = isset($v55bd236ac1[$v9f2f9d92a3 . "_confirmation_message"]) ? $v55bd236ac1[$v9f2f9d92a3 . "_confirmation_message"] : null; $v6ed826eaa0 = isset($v55bd236ac1[$v9f2f9d92a3 . "_ok_msg_message"]) ? $v55bd236ac1[$v9f2f9d92a3 . "_ok_msg_message"] : null; $v63ab3e3366 = isset($v55bd236ac1[$v9f2f9d92a3 . "_ok_msg_redirect_url"]) ? $v55bd236ac1[$v9f2f9d92a3 . "_ok_msg_redirect_url"] : null; $v19e19f0053 = isset($v55bd236ac1[$v9f2f9d92a3 . "_error_msg_message"]) ? $v55bd236ac1[$v9f2f9d92a3 . "_error_msg_message"] : null; $pfc6b8f45 = isset($v55bd236ac1[$v9f2f9d92a3 . "_error_msg_redirect_url"]) ? $v55bd236ac1[$v9f2f9d92a3 . "_error_msg_redirect_url"] : null; if ($pbf2a75a9 && ($v256e3a39a7 == "insert" || $v256e3a39a7 == "update") && !empty($v55bd236ac1["multiple_insert"]) && !empty($v55bd236ac1["multiple_update"])) $v9f2f9d92a3 = "multiple_insert_update"; if ($v44ffadba90 || $v516837ee42 || ($pa8b4b2c5 && $v8ff80a1320 == "single_")) { $v30857f7eca[$v9d7547e4d6]["actions"][$v9f2f9d92a3] = array( "action" => $v9f2f9d92a3, "action_type" => "ajax_on_click", "ajax_url" => $v313ffa5f74 . $v9f2f9d92a3, "confirmation_message" => $pa0def03f, "ok_msg_message" => $v6ed826eaa0, "ok_msg_redirect_url" => $v63ab3e3366, "error_msg_message" => $v19e19f0053, "error_msg_redirect_url" => $pfc6b8f45, ); self::f3bf480b134($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, $v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, $v8ff80a1320, $v256e3a39a7, $v9f2f9d92a3, $pbf2a75a9, $v7943b46e77, $pef34936b); } else if ($pb3f8356a == "multiple_form" && $v9f2f9d92a3 == "single_insert") $v30857f7eca[$v9d7547e4d6]["actions"][$v9f2f9d92a3] = array( "action" => $v9f2f9d92a3, "action_type" => $v44ffadba90 || $v516837ee42 ? "ajax_on_click" : "", "ajax_url" => $v44ffadba90 || $v516837ee42 ? $v313ffa5f74 . $v9f2f9d92a3 : null, "ok_msg_message" => $v6ed826eaa0, "ok_msg_redirect_url" => $v63ab3e3366, "error_msg_message" => $v19e19f0053, "error_msg_redirect_url" => $pfc6b8f45, ); else $v30857f7eca[$v9d7547e4d6]["actions"][$v9f2f9d92a3] = array( "action" => $v9f2f9d92a3, "action_type" => "", "confirmation_message" => $pa0def03f, "ok_msg_message" => $v6ed826eaa0, "ok_msg_redirect_url" => $v63ab3e3366, "error_msg_message" => $v19e19f0053, "error_msg_redirect_url" => $pfc6b8f45, ); } } private static function f3bf480b134($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, $v98a8251725, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, &$v2e8aa9d64e, $v28bb4bea47, $v30857f7eca, $v8282c7dd58, $v876c18d646, $pe59b744b, $v9a4a47d31e, $v9d7547e4d6, $v487b7d34ae, $v55bd236ac1, $v8ff80a1320, $v256e3a39a7, $v9f2f9d92a3, $pbf2a75a9, $v7943b46e77, $pef34936b) { $pef3a5b70 = array( $v9d7547e4d6 => array( "form_type" => isset($v30857f7eca["form_type"]) ? $v30857f7eca["form_type"] : null, "brokers" => array(), "actions" => array(), ) ); if ($v9f2f9d92a3 == "multiple_insert_update") { $v9f2f9d92a3 = "multiple_insert_update"; $pe86870b8 = array($v256e3a39a7, $v256e3a39a7 == "insert" ? "update" : "insert"); } else $pe86870b8 = array($v256e3a39a7); foreach ($pe86870b8 as $pe9daf1fc) { if (empty($v487b7d34ae[$pe9daf1fc])) $pef3a5b70[$v9d7547e4d6]["actions"][$v9f2f9d92a3] = array( "action" => $v9f2f9d92a3, "action_type" => "", ); else { $pef3a5b70[$v9d7547e4d6]["brokers"][$pe9daf1fc] = $v487b7d34ae[$pe9daf1fc]; if ($pe9daf1fc == "update") $pef3a5b70[$v9d7547e4d6]["brokers"]["update_pks"] = isset($v487b7d34ae["update_pks"]) ? $v487b7d34ae["update_pks"] : null; else if ($pe9daf1fc != "insert") $pef3a5b70[$v9d7547e4d6]["brokers"]["get"] = isset($v487b7d34ae["get"]) ? $v487b7d34ae["get"] : null; } } if ($pbf2a75a9) $pef3a5b70[$v9d7547e4d6]["actions"][$v9f2f9d92a3] = array( "action" => $v9f2f9d92a3, "action_type" => "", ); $v872f5b4dbb = isset($pe59b744b["db_driver"]) ? $pe59b744b["db_driver"] : null; $v6cc00e79ac = isset($pe59b744b["db_type"]) ? $pe59b744b["db_type"] : null; $v8b13fa2358 = isset($pe59b744b["include_db_driver"]) ? $pe59b744b["include_db_driver"] : null; $v0b166cf50c = self::f4280f7a6c1($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v872f5b4dbb); $v826d0ddb62 = self::f90bb9f56e7($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v872f5b4dbb); $pb09c0b5b = self::f8a1714bd98($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v8b13fa2358); $v6f4044e7e2 = CMSPresentationFormSettingsUIHandler::getFormSettings($v3d55458bcd, $v5039a77f9d, $pdb9e96e6, $v4bf8d90f04, $pfce4d1b3, $v8ffce2a791, $pa0462a8e, $pa32be502, null, $v0b166cf50c, $v826d0ddb62, $pb09c0b5b, $v872f5b4dbb, $v8b13fa2358, $v6cc00e79ac, $v9a4a47d31e, $pef3a5b70, true, "", false, $pef34936b, $pb39a0a9c); self::f67d92f51be($v188b4f5fa6, $v3ae34feaaf, $v29c163a46f, $v98a8251725 . substr($v28bb4bea47, 0, -1) . "_" . $v9f2f9d92a3, $pc4aa460d, $pffbf7c43, $pa9e9a096, $pf6b7bac7, $pa7b9f5d0, $v3069750558, $pea98b5ae, "ajax", $v2e8aa9d64e, $v6f4044e7e2, $v8282c7dd58, $v876c18d646, "ajax", $v7943b46e77, $pef34936b, null, $pb39a0a9c); } private static function f90bb9f56e7($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v872f5b4dbb) { $pc4223ce1 = $v188b4f5fa6->getPresentationLayer()->getBrokers(); if ($v872f5b4dbb) { $pab752e34 = WorkFlowBeansFileHandler::getBrokersLocalDBBrokerNameForChildBrokerDBDriver($v3d55458bcd, $v5039a77f9d, $pc4223ce1, $v872f5b4dbb); if ($pab752e34) return $pab752e34; } } private static function f8a1714bd98($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v8b13fa2358) { if ($v8b13fa2358) return true; $pc4223ce1 = $v188b4f5fa6->getPresentationLayer()->getBrokers(); $v7a0994a134 = WorkFlowBeansFileHandler::getLayerBrokersSettings($v3d55458bcd, $v5039a77f9d, $pc4223ce1); return isset($v7a0994a134["db_brokers"]) && count($v7a0994a134["db_brokers"]) > 1; } private static function f4280f7a6c1($v188b4f5fa6, $v3d55458bcd, $v5039a77f9d, $v872f5b4dbb) { $pc4223ce1 = $v188b4f5fa6->getPresentationLayer()->getBrokers(); if ($pc4223ce1) foreach ($pc4223ce1 as $v2b2cf4c0eb => $pd922c2f7) if (is_a($pd922c2f7, "IDataAccessBrokerClient")) return $v2b2cf4c0eb; return null; } private static function f3eb8f3f6a9($v1b7f0d0c99) { $v40b70e70c3 = ''; if (!empty($v1b7f0d0c99["ajax_navigation"])) $v40b70e70c3 .= '
...
'; if (!empty($v1b7f0d0c99["ajax_tab_navigation"])) $v40b70e70c3 .= '
...
'; if (!empty($v1b7f0d0c99["embeded"])) $v40b70e70c3 .= '
...
'; if (!empty($v1b7f0d0c99["popup"])) $v40b70e70c3 .= '
...
'; if (!empty($v1b7f0d0c99["iframe_popup"])) $v40b70e70c3 .= '
...
'; if (!empty($v1b7f0d0c99["parent"])) $v40b70e70c3 .= '
...
'; if (!empty($v1b7f0d0c99["embeded"]) || !empty($v1b7f0d0c99["popup"]) || !empty($v1b7f0d0c99["ajax_navigation"]) || !empty($v1b7f0d0c99["ajax_tab_navigation"])) $v40b70e70c3 .= '
...
$block_settings[$block_id] = array(
	...
	"validation_ttl" => ' . ($v35727ff744 ? '(!empty($_GET["hide"]) ? 0 : 5) . ""' : '""') . ',
	"validation_blocks_execution" => "do_nothing",
