...
'; } public static function getContextMenus($pe847b157, $pcc05179c, $pf2237784 = false) { $paaa29e9a = '<li class="line_break" vendor_framework="laravel"></li>
	...
	<li class="laravel_terminal" vendor_framework="laravel"><a onClick="return goTo(this, \'laravel_terminal_url\', event)"> Laravel Terminal</a></li>'; return '
