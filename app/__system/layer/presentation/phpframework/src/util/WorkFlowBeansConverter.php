...
<beans>
	...
	<!-- PRESENTATION -->'; $v02a69d4e0f = $this->mfc06e2bf54d4($v7f5911d32d); $v241205aec6 .= isset($v02a69d4e0f[0]) ? $v02a69d4e0f[0] : null; $v4bc43beec7 = isset($v02a69d4e0f[1]) ? $v02a69d4e0f[1] : null; $v241205aec6 .= '
			
	<bean name="' . $v49bdd49c66 . 'PLayer" path="lib.org.phpframework.layer.presentation.PresentationLayer">
		<constructor_arg reference="' . $pb77a7e67 . '_p_vars" />

		<property name="isDefaultLayer" value="' . (!empty($v7f5911d32d["start"]) ? 1 : 0) . '" />
...
</beans>'; if (!$this->f94a03ace64(self::f736d852839($v7f5911d32d["label"]) . "_pl", $v241205aec6)) $v5c1c342594 = false; } return $v5c1c342594; } private function f3bb0cb9725($v8218e04d0b = array()) { $v5c1c342594 = true; $v8218e04d0b = $v8218e04d0b && !is_array($v8218e04d0b) ? array($v8218e04d0b) : $v8218e04d0b; $v1d696dbd12 = $this->v8cd3e3837d->getTasksByLayerTag("businesslogic"); foreach ($v1d696dbd12 as $v7f5911d32d) { if (empty($v7f5911d32d["properties"]["active"]) || ($v8218e04d0b && isset($v7f5911d32d["id"]) && !in_array($v7f5911d32d["id"], $v8218e04d0b))) continue 1; $v7f5911d32d["label"] = isset($v7f5911d32d["label"]) ? $v7f5911d32d["label"] : null; self::mac0ace304e61($v7f5911d32d["label"]); $pb77a7e67 = self::mea7bdac9ad9e($v7f5911d32d["label"]); $v49bdd49c66 = self::mcb6114f75351($v7f5911d32d["label"]); $v241205aec6 = '<?xml version="1.0" encoding="UTF-8"?>
<beans>
	<bean name="CommonService" namespace="' . $pb77a7e67 . '" path="CommonService" path_prefix="<?php echo (isset($vars["business_logic_modules_common_path"]) ? $vars["business_logic_modules_common_path"] : "");?>" extension="php">
...
<beans>
	...
	<!-- BUSINESS LOGIC -->'; $v02a69d4e0f = $this->mfc06e2bf54d4($v7f5911d32d); $v241205aec6 .= isset($v02a69d4e0f[0]) ? $v02a69d4e0f[0] : null; $v4bc43beec7 = isset($v02a69d4e0f[1]) ? $v02a69d4e0f[1] : null; $v241205aec6 .= '
...
</beans>'; if (!$this->f94a03ace64(self::f736d852839($v7f5911d32d["label"]) . "_bll", $v241205aec6, $v7f5911d32d["properties"])) $v5c1c342594 = false; } return $v5c1c342594; } private function md1a96577b4ca($v8218e04d0b = array()) { $v5c1c342594 = true; $v8218e04d0b = $v8218e04d0b && !is_array($v8218e04d0b) ? array($v8218e04d0b) : $v8218e04d0b; $v1d696dbd12 = $this->v8cd3e3837d->getTasksByLayerTag("dataaccess"); foreach ($v1d696dbd12 as $v7f5911d32d) { if (empty($v7f5911d32d["properties"]["active"]) || ($v8218e04d0b && isset($v7f5911d32d["id"]) && !in_array($v7f5911d32d["id"], $v8218e04d0b))) continue 1; $v7f5911d32d["label"] = isset($v7f5911d32d["label"]) ? $v7f5911d32d["label"] : null; self::mac0ace304e61($v7f5911d32d["label"]); $pb77a7e67 = self::mea7bdac9ad9e($v7f5911d32d["label"]); $v49bdd49c66 = self::mcb6114f75351($v7f5911d32d["label"]); $v241205aec6 = '<?xml version="1.0" encoding="UTF-8"?>
<beans>
	<import relative="1">app.xml</import>
	'; $v02a69d4e0f = $this->mfc06e2bf54d4($v7f5911d32d); $v241205aec6 .= isset($v02a69d4e0f[0]) ? $v02a69d4e0f[0] : null; $v4bc43beec7 = isset($v02a69d4e0f[1]) ? $v02a69d4e0f[1] : null; if (isset($v7f5911d32d["properties"]["type"]) && $v7f5911d32d["properties"]["type"] == "ibatis") { $v241205aec6 .= '
	<!-- IBATIS -->
...
</beans>'; if (!$this->f94a03ace64(self::f736d852839($v7f5911d32d["label"]) . "_dal", $v241205aec6, $v7f5911d32d["properties"])) $v5c1c342594 = false; } return $v5c1c342594; } private function mcebcbe562723($v8218e04d0b = array()) { $v5c1c342594 = true; $v8218e04d0b = $v8218e04d0b && !is_array($v8218e04d0b) ? array($v8218e04d0b) : $v8218e04d0b; $v1d696dbd12 = $this->v8cd3e3837d->getTasksByLayerTag("db"); foreach ($v1d696dbd12 as $v7f5911d32d) { if (empty($v7f5911d32d["properties"]["active"]) || ($v8218e04d0b && isset($v7f5911d32d["id"]) && !in_array($v7f5911d32d["id"], $v8218e04d0b))) continue 1; $v7f5911d32d["label"] = isset($v7f5911d32d["label"]) ? $v7f5911d32d["label"] : null; self::mac0ace304e61($v7f5911d32d["label"]); $pb77a7e67 = self::mea7bdac9ad9e($v7f5911d32d["label"]); $v49bdd49c66 = self::mcb6114f75351($v7f5911d32d["label"]); $v241205aec6 = '<?xml version="1.0" encoding="UTF-8"?>
<beans>
	<import relative="1">app.xml</import>'; $v02a69d4e0f = $this->mfc06e2bf54d4($v7f5911d32d); $v241205aec6 .= isset($v02a69d4e0f[0]) ? $v02a69d4e0f[0] : null; $v4bc43beec7 = isset($v02a69d4e0f[1]) ? $v02a69d4e0f[1] : null; $v241205aec6 .= '
...
</beans>'; if (!$this->f94a03ace64(self::f736d852839($v7f5911d32d["label"]) . "_dbl", $v241205aec6, $v7f5911d32d["properties"])) $v5c1c342594 = false; } return $v5c1c342594; } private function md7749ec7c299($v8218e04d0b = array()) { $v5c1c342594 = true; $v8218e04d0b = $v8218e04d0b && !is_array($v8218e04d0b) ? array($v8218e04d0b) : $v8218e04d0b; $v1d696dbd12 = $this->v8cd3e3837d->getTasksByLayerTag("dbdriver"); foreach ($v1d696dbd12 as $v7f5911d32d) { if (empty($v7f5911d32d["properties"]["active"]) || ($v8218e04d0b && isset($v7f5911d32d["id"]) && !in_array($v7f5911d32d["id"], $v8218e04d0b))) continue 1; $v7f5911d32d["label"] = isset($v7f5911d32d["label"]) ? $v7f5911d32d["label"] : null; self::mac0ace304e61($v7f5911d32d["label"]); $pb77a7e67 = self::mea7bdac9ad9e($v7f5911d32d["label"]); $v49bdd49c66 = self::mcb6114f75351($v7f5911d32d["label"]); $v1335217393 = DB::getDriverClassNameByType(isset($v7f5911d32d["properties"]["type"]) ? $v7f5911d32d["properties"]["type"] : null); $v3ae55a9a2e = "lib.org.phpframework.db.driver." . ($v1335217393 ? $v1335217393 : "MySqlDB"); $v241205aec6 = '<?xml version="1.0" encoding="UTF-8"?>
<beans>
	<import relative="1">app.xml</import>
...
<beans>
...
</beans>'; return $this->f94a03ace64("app", $v241205aec6); } private function mfc06e2bf54d4($v7f5911d32d) { $pd0ce49e4 = ''; $v4bc43beec7 = ''; $pca9f244a = array(); $pfbb6ee46 = isset($v7f5911d32d["tag"]) ? $v7f5911d32d["tag"] : null; switch($pfbb6ee46) { case $this->pfc8be585["db"]: $pca9f244a = array( $this->pfc8be585["dbdriver"] ); break; case $this->pfc8be585["dataaccess"]: $pca9f244a = array( $this->pfc8be585["db"] ); break; case $this->pfc8be585["businesslogic"]: case $this->pfc8be585["presentation"]: $pca9f244a = array( $this->pfc8be585["businesslogic"], $this->pfc8be585["dataaccess"], $this->pfc8be585["db"] ); break; } if (!empty($v7f5911d32d["exits"]["layer_exit"])) { $v6939304e91 = isset($v7f5911d32d["exits"]["layer_exit"][0]) ? $v7f5911d32d["exits"]["layer_exit"] : array($v7f5911d32d["exits"]["layer_exit"]); if ($v6939304e91) { $v7f5911d32d["label"] = isset($v7f5911d32d["label"]) ? $v7f5911d32d["label"] : null; $v49bdd49c66 = self::mcb6114f75351($v7f5911d32d["label"]); $v1d696dbd12 = $this->v8cd3e3837d->getWorkflowData(); $v3b29dfd1b9 = array(); $pc37695cb = count($v6939304e91); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v0b70a1f3bc = isset($v6939304e91[$v43dd7d0051]["task_id"]) ? $v6939304e91[$v43dd7d0051]["task_id"] : null; foreach ($v1d696dbd12["tasks"] as $pe7f1e9cf) { $v52ad7996a2 = isset($pe7f1e9cf["id"]) ? $pe7f1e9cf["id"] : null; if ($v52ad7996a2 == $v0b70a1f3bc && isset($pe7f1e9cf["tag"]) && in_array($pe7f1e9cf["tag"], $pca9f244a) && !empty($pe7f1e9cf["properties"]["active"])) { $pe7f1e9cf["label"] = isset($pe7f1e9cf["label"]) ? $pe7f1e9cf["label"] : null; self::mac0ace304e61($pe7f1e9cf["label"]); $pc08d1c60 = self::mea7bdac9ad9e($pe7f1e9cf["label"]); $v4666f035e6 = self::mcb6114f75351($pe7f1e9cf["label"]); $pc7752d7e = self::f6c6524d3a5($pe7f1e9cf["label"]); $v89d5e3abfb = isset($pe7f1e9cf["properties"]["layer_brokers"]) ? $pe7f1e9cf["properties"]["layer_brokers"] : null; $v3033e34359 = isset($v6939304e91[$v43dd7d0051]["properties"]) ? $v6939304e91[$v43dd7d0051]["properties"] : null; $v002556527f = isset($v3033e34359["connection_type"]) ? $v3033e34359["connection_type"] : null; $v890189c188 = "lib.org.phpframework.broker.client.local.Local"; $v7f47ccc31b = ""; $pc2cdfd1b = ""; if (empty($v89d5e3abfb[$v002556527f]["active"])) $v002556527f = ""; if (empty($v3b29dfd1b9[$v52ad7996a2]) || !in_array($v002556527f, $v3b29dfd1b9[$v52ad7996a2])) { $v3b29dfd1b9[$v52ad7996a2][] = $v002556527f; if ($v002556527f) { $v890189c188 = "lib.org.phpframework.broker.client.$v002556527f." . strtoupper($v002556527f); $v7f47ccc31b = self::f18f75624e4($v002556527f); if (isset($v3033e34359["connection_settings"]) && is_array($v3033e34359["connection_settings"]) && !empty($v3033e34359["connection_settings"]["vars_name"])) { $v45de354860 = $v3033e34359["connection_settings"]["vars_name"]; $v61fc24eb6d = isset($v3033e34359["connection_settings"]["vars_value"]) ? $v3033e34359["connection_settings"]["vars_value"] : null; $v3033e34359["connection_settings"] = array(); if (!is_array($v45de354860)) { $v45de354860 = array($v45de354860); $v61fc24eb6d = array($v61fc24eb6d); } foreach ($v45de354860 as $pd69fb7d0 => $v5e813b295b) if ($v5e813b295b) $v3033e34359["connection_settings"][$v5e813b295b] = $v61fc24eb6d[$pd69fb7d0]; } else $v3033e34359["connection_settings"] = array(); if (!empty($v89d5e3abfb[$v002556527f])) { $v3033e34359["connection_settings"] = array_merge($v89d5e3abfb[$v002556527f], $v3033e34359["connection_settings"]); unset($v3033e34359["connection_settings"]["active"]); unset($v3033e34359["connection_settings"]["other_settings"]); } $v3033e34359["connection_settings"]["response_type"] = isset($v3033e34359["connection_response_type"]) ? $v3033e34359["connection_response_type"] : null; $pc2cdfd1b = self::f3820df7a8a($v3033e34359); $pc2cdfd1b = $pc2cdfd1b ? $pc2cdfd1b . "\n\t" : ""; } if ($pe7f1e9cf["tag"] == $this->pfc8be585["dataaccess"]) { if (isset($pe7f1e9cf["properties"]["type"]) && $pe7f1e9cf["properties"]["type"] == "ibatis") { if ($v002556527f) $pd0ce49e4 .= '
	...
	<import relative="1">' . self::f736d852839($pe7f1e9cf["label"]) . '_dbdriver.xml</import>'; $v4bc43beec7 .= '
		<function name="addBroker">
			...
			<parameter value="' . $pc7752d7e . '" />
		</function>'; break; } } } } } } } return array($pd0ce49e4, $v4bc43beec7); } private function meaae65e4b8c9($v7f5911d32d) { $paffeffd6 = ''; $v8282c7dd58 = isset($v7f5911d32d["id"]) ? $v7f5911d32d["id"] : null; $pfbb6ee46 = isset($v7f5911d32d["tag"]) ? $v7f5911d32d["tag"] : null; $v37adac6c55 = array(); switch($pfbb6ee46) { case $this->pfc8be585["dbdriver"]: $v37adac6c55 = array( $this->pfc8be585["db"], $this->pfc8be585["businesslogic"], $this->pfc8be585["presentation"] ); break; case $this->pfc8be585["db"]: $v37adac6c55 = array( $this->pfc8be585["dataaccess"], $this->pfc8be585["businesslogic"], $this->pfc8be585["presentation"] ); break; case $this->pfc8be585["dataaccess"]: $v37adac6c55 = array( $this->pfc8be585["businesslogic"], $this->pfc8be585["presentation"] ); break; case $this->pfc8be585["businesslogic"]: $v37adac6c55 = array( $this->pfc8be585["businesslogic"], $this->pfc8be585["presentation"] ); break; case $this->pfc8be585["presentation"]: $v37adac6c55 = array(); break; } if ($v37adac6c55) { $v7f5911d32d["label"] = isset($v7f5911d32d["label"]) ? $v7f5911d32d["label"] : null; $v49bdd49c66 = self::mcb6114f75351($v7f5911d32d["label"]); $v1d696dbd12 = $this->v8cd3e3837d->getWorkflowData(); $v484bcb5f4d = false; if (!empty($v1d696dbd12["tasks"])) foreach ($v1d696dbd12["tasks"] as $pe7f1e9cf) if (!empty($pe7f1e9cf["exits"]["layer_exit"]) && !empty($pe7f1e9cf["properties"]["active"])) { $v6939304e91 = isset($pe7f1e9cf["exits"]["layer_exit"][0]) ? $pe7f1e9cf["exits"]["layer_exit"] : array($pe7f1e9cf["exits"]["layer_exit"]); if ($v6939304e91) { $pc37695cb = count($v6939304e91); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v0b70a1f3bc = isset($v6939304e91[$v43dd7d0051]["task_id"]) ? $v6939304e91[$v43dd7d0051]["task_id"] : null; if ($v0b70a1f3bc == $v8282c7dd58 && isset($pe7f1e9cf["tag"]) && in_array($pe7f1e9cf["tag"], $v37adac6c55)) { $v3033e34359 = isset($v6939304e91[$v43dd7d0051]["properties"]) ? $v6939304e91[$v43dd7d0051]["properties"] : null; $v002556527f = isset($v3033e34359["connection_type"]) ? $v3033e34359["connection_type"] : null; if (!$v002556527f || empty($v7f5911d32d["properties"]["layer_brokers"][$v002556527f]["active"])) { $v484bcb5f4d = true; break; } } } if ($v484bcb5f4d) break; } } if ($v484bcb5f4d) { if ($pfbb6ee46 == $this->pfc8be585["dataaccess"]) { if (isset($v7f5911d32d["properties"]["type"]) && $v7f5911d32d["properties"]["type"] == "ibatis") $paffeffd6 .= '
	...
	<bean name="' . $v49bdd49c66 . 'HDABrokerServer" path="lib.org.phpframework.broker.server.local.LocalHibernateDataAccessBrokerServer">
		<constructor_arg reference="' . $v49bdd49c66 . 'HDALayer" />
	</bean>'; } else if ($pfbb6ee46 == $this->pfc8be585["businesslogic"]) $paffeffd6 .= '
	<bean name="' . $v49bdd49c66 . 'BLBrokerServer" path="lib.org.phpframework.broker.server.local.LocalBusinessLogicBrokerServer">
		<constructor_arg reference="' . $v49bdd49c66 . 'BLLayer" />
	</bean>'; else if ($pfbb6ee46 == $this->pfc8be585["db"]) $paffeffd6 .= '
	<bean name="' . $v49bdd49c66 . 'DBBrokerServer" path="lib.org.phpframework.broker.server.local.LocalDBBrokerServer">
		<constructor_arg reference="' . $v49bdd49c66 . 'DBLayer" />
	</bean>'; } $v7a4c0ba9ac = isset($v7f5911d32d["properties"]["layer_brokers"]) ? $v7f5911d32d["properties"]["layer_brokers"] : null; if ($v7a4c0ba9ac) foreach ($v7a4c0ba9ac as $v676be2c810 => $v6e62221446) if (!empty($v6e62221446["active"])) { $v890189c188 = "lib.org.phpframework.broker.server.$v676be2c810." . strtoupper($v676be2c810); $v7f47ccc31b = self::f18f75624e4($v676be2c810); if (isset($v6e62221446["other_settings"]) && is_array($v6e62221446["other_settings"]) && !empty($v6e62221446["other_settings"]["vars_name"])) { $v45de354860 = isset($v6e62221446["other_settings"]["vars_name"]) ? $v6e62221446["other_settings"]["vars_name"] : null; $v61fc24eb6d = isset($v6e62221446["other_settings"]["vars_value"]) ? $v6e62221446["other_settings"]["vars_value"] : null; if (!is_array($v45de354860)) { $v45de354860 = array($v45de354860); $v61fc24eb6d = array($v61fc24eb6d); } foreach ($v45de354860 as $pd69fb7d0 => $v5e813b295b) if ($v5e813b295b) $v6e62221446[$v5e813b295b] = $v61fc24eb6d[$pd69fb7d0]; } unset($v6e62221446["url"]); unset($v6e62221446["http_auth"]); unset($v6e62221446["user_pwd"]); unset($v6e62221446["other_settings"]); unset($v6e62221446["global_variables"]); unset($v6e62221446["active"]); $pc2cdfd1b = self::f3820df7a8a(array("connection_settings" => $v6e62221446)); if ($pfbb6ee46 == $this->pfc8be585["dataaccess"]) { if (isset($v7f5911d32d["properties"]["type"]) && $v7f5911d32d["properties"]["type"] == "ibatis") $paffeffd6 .= '
