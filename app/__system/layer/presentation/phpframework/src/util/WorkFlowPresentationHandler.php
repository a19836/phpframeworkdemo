...
include_once $EVC->getUtilPath("LayoutTypeProjectHandler"); class WorkFlowPresentationHandler { public static function getHeader($peb014cfd, $v37d269c4fa, $pcfdeae4e = false, $v8555f2f905 = false, $pbd963c11 = false, $v8c5b4fe0d4 = false) { $pf8ed4912 = '
		...
		'; $pf8ed4912 .= $pcfdeae4e ? $pcfdeae4e->getHeader(array("tasks_css_and_js" => true, "icons_and_edit_code_already_included" => $v8c5b4fe0d4)) : ""; if (strpos($pf8ed4912, 'vendor/jsbeautify/js/lib/beautify.js') === false) $pf8ed4912 = '
				...
				<script language="javascript" type="text/javascript" src="' . $peb014cfd . 'lib/myhtmlbeautify/MyHtmlBeautify.js"></script>
			...
			<link rel="stylesheet" href="' . $v37d269c4fa . 'vendor/codehighlight/styles/default.css" type="text/css" charset="utf-8" />
			<script language="javascript" type="text/javascript" src="' . $v37d269c4fa . 'vendor/codehighlight/highlight.pack.js"></script>
		...
		var save_file_manager_function_url = \'' . $v3d4207e17a . '\';
					...
					'; } } } return $pf8ed4912; } public static function getBusinessLogicBrokersHtml($v6e9af47944, $pf7b73b3a, $v46a478e94c) { $pf8ed4912 = ''; if ($v6e9af47944) { $pc37695cb = count($v6e9af47944); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $v6e9af47944[$v43dd7d0051]; if (!empty($v7aeaf992f5[2])) { $v94a9c171e3 = str_replace("#bean_file_name#", $v7aeaf992f5[1], str_replace("#bean_name#", $v7aeaf992f5[2], $pf7b73b3a)); $pf8ed4912 .= 'main_layers_properties.' . $v7aeaf992f5[2] . ' = {ui: {
						folder: {
							get_sub_files_url: "' . $v94a9c171e3 . '",
						},
						cms_common: {
		...
		'; } public static function getDataAccessBrokersHtml($v9fda9fad47, $pf7b73b3a) { $pf8ed4912 = ''; if ($v9fda9fad47) { $pc37695cb = count($v9fda9fad47); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $v9fda9fad47[$v43dd7d0051]; if (!empty($v7aeaf992f5[2])) { $v94a9c171e3 = str_replace("#bean_file_name#", $v7aeaf992f5[1], str_replace("#bean_name#", $v7aeaf992f5[2], $pf7b73b3a)); $pf8ed4912 .= 'main_layers_properties.' . $v7aeaf992f5[2] . ' = {ui: {
						folder: {
							get_sub_files_url: "' . $v94a9c171e3 . '",
						},
						cms_common: {
				...
				<div class="broker' . ($pc37695cb == 1 ? " single_broker" : "") . '">
					<label>Broker:</label>
					<select onChange="updateDBDriverOnBrokerNameChange(this)">'; for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $pfb662071[$v43dd7d0051]; $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $pf8ed4912 .= '<option bean_file_name="' . $v0af1ea195f . '" bean_name="' . $v1993417971 . '" value="' . $v04bc9d45ce . '">' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</option>'; } $pf8ed4912 .= '
					</select>
				</div>
				<div class="db_driver">
				...
				<div class="broker' . ($pc37695cb == 1 ? " single_broker" : "") . '">
					...
					<select onChange="updateDBDriverOnBrokerNameChange(this)">'; for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $v9fda9fad47[$v43dd7d0051]; $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $pf8ed4912 .= '<option bean_file_name="' . $v0af1ea195f . '" bean_name="' . $v1993417971 . '" value="' . $v04bc9d45ce . '">' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</option>'; } $pf8ed4912 .= '
					</select>
				</div>
				<div class="db_driver">
					<label>DB Driver:</label>
				...
				<div class="broker' . ($pc37695cb == 1 ? " single_broker" : "") . '">
					<label>Broker:</label>
					<select onChange="updateDBDriverOnBrokerNameChange(this);updateLayerUrlFileManager(this)">'; for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $pf864769c[$v43dd7d0051]; $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $pf8ed4912 .= '<option bean_file_name="' . $v0af1ea195f . '" bean_name="' . $v1993417971 . '" value="' . $v04bc9d45ce . '">' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</option>'; } $pf8ed4912 .= '
					</select>
				</div>
				<div class="db_driver">
					<label>DB Driver:</label>
				...
				<div class="broker' . ($pc37695cb == 1 ? " single_broker" : "") . '">
					<label>Broker:</label>
					<select onChange="updateDBDriverOnBrokerNameChange(this);updateLayerUrlFileManager(this)">'; for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $paf75a67c[$v43dd7d0051]; $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $pf8ed4912 .= '<option bean_file_name="' . $v0af1ea195f . '" bean_name="' . $v1993417971 . '" value="' . $v04bc9d45ce . '">' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</option>'; } $pf8ed4912 .= '
					</select>
				</div>
				<div class="db_driver">
					<label>DB Driver:</label>
			...
			<div id="choose_hibernate_object_method_from_file_manager" class="myfancypopup choose_from_file_manager with_title">
				...
				<div class="broker' . ($pc37695cb == 1 ? " single_broker" : "") . '">
					<label>Broker:</label>
					<select onChange="updateLayerUrlFileManager(this)">'; for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $v6e9af47944[$v43dd7d0051]; $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $pf8ed4912 .= '<option bean_file_name="' . $v0af1ea195f . '" bean_name="' . $v1993417971 . '" value="' . $v04bc9d45ce . '">' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</option>'; } $pf8ed4912 .= '
					</select>
				</div>
				<ul class="mytree">
					<li>
				...
				<div class="broker' . ($pc37695cb == 1 ? " single_broker" : "") . '">
					<label>Broker:</label>
					<select onChange="updateLayerUrlFileManager(this)">'; for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v7aeaf992f5 = $pb0e92e25[$v43dd7d0051]; $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $pf8ed4912 .= '<option bean_file_name="' . $v0af1ea195f . '" bean_name="' . $v1993417971 . '" value="' . $v04bc9d45ce . '">' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</option>'; } $pf8ed4912 .= '
					</select>
				</div>
				<ul class="mytree">
					<li>
			...
			<ul class="mytree">'; if (isset($v6e9af47944)) foreach ($v6e9af47944 as $v7aeaf992f5) { $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $v195d5f6856 .= '
				<li>
					<label>' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</label>
					<ul url="' . str_replace("#bean_file_name#", $v0af1ea195f, str_replace("#bean_name#", $v1993417971, $pf7b73b3a)) . '"></ul>
				</li>'; } if (isset($pb0e92e25)) foreach ($pb0e92e25 as $v7aeaf992f5) { $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $v195d5f6856 .= '
				<li>
					<label>' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</label>
					<ul url="' . str_replace("#bean_file_name#", $v0af1ea195f, str_replace("#bean_name#", $v1993417971, $pf7b73b3a)) . '"></ul>
				</li>'; } $v195d5f6856 .= '
			...
			<div id="choose_block_from_file_manager" class="myfancypopup choose_from_file_manager with_title">
				<div class="title">Choose a Block</div>
				<ul class="mytree">'; if (isset($pb0e92e25)) foreach ($pb0e92e25 as $v7aeaf992f5) { $v04bc9d45ce = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $v0af1ea195f = isset($v7aeaf992f5[1]) ? $v7aeaf992f5[1] : null; $v1993417971 = isset($v7aeaf992f5[2]) ? $v7aeaf992f5[2] : null; $pf8ed4912 .= '
					<li>
						<label>' . $v04bc9d45ce . ($v1993417971 ? '' : ' (Rest)') . '</label>
						<ul url="' . str_replace("#bean_file_name#", $v0af1ea195f, str_replace("#bean_name#", $v1993417971, $pf7b73b3a)) . '"></ul>
					</li>'; } $pf8ed4912 .= '
			...
			</div>'; } return $pf8ed4912; } public static function getCodeEditorMenuHtml($v5d3813882f) { $v2101769c38 = !empty($v5d3813882f["show_pretty_print"]) ? $v5d3813882f["show_pretty_print"] : true; $pe7b2a888 = !empty($v5d3813882f["generate_tasks_flow_from_code_label"]) ? $v5d3813882f["generate_tasks_flow_from_code_label"] : "Generate Diagram from Code"; $pd880cf7e = !empty($v5d3813882f["generate_tasks_flow_from_code_func"]) ? $v5d3813882f["generate_tasks_flow_from_code_func"] : "generateTasksFlowFromCode"; $v13b5585fac = !empty($v5d3813882f["generate_code_from_tasks_flow_label"]) ? $v5d3813882f["generate_code_from_tasks_flow_label"] : "Generate Code From Diagram"; $v0fa2a905e0 = !empty($v5d3813882f["generate_code_from_tasks_flow_func"]) ? $v5d3813882f["generate_code_from_tasks_flow_func"] : "generateCodeFromTasksFlow"; $pb085e184 = !empty($v5d3813882f["save_func"]) ? $v5d3813882f["save_func"] : null; return '<ul>
			...
			<li class="save" title="Save"><a onClick="' . $pb085e184 . '()"><i class="icon save"></i> Save</a></li>
		</ul>'; } public static function getCodeEditorHtml($v067674f4e4, $v48e4e778a5, $pefdd2109, $v3d55458bcd, $v5039a77f9d, $v188b4f5fa6, $pdf77ee66, $v8ffce2a791, $pa0462a8e, $v9b98e0e818, $pf7b73b3a, $pe6619ae3, $pd0054995, $v9106c07f80, $v5988353a93 = false, $v5d3813882f = null) { $v446c479876 = (isset($_COOKIE["main_navigator_side"]) && $_COOKIE["main_navigator_side"] == "main_navigator_reverse") || (isset($_COOKIE["admin_type"]) && $_COOKIE["admin_type"] == "simple") ? "" : "reverse"; $v318c0a296c = isset($v5d3813882f["layout_ui_editor_html"]) ? $v5d3813882f["layout_ui_editor_html"] : null; $pf04b670f = isset($v5d3813882f["layout_ui_editor_class"]) ? $v5d3813882f["layout_ui_editor_class"] : null; $pf8ed4912 = '
			<div class="code_menu" onClick="openSubmenu(this)">
				' . self::getCodeEditorMenuHtml($v48e4e778a5) . '
			</div>
			<div class="layout-ui-editor ' . $v446c479876 . ' ' . $pf04b670f . ' fixed-side-properties hide-template-widgets-options">
			...
			<div class="myfancypopup db_table_uis_diagram_block with_iframe_title" create_page_presentation_uis_diagram_block_url="' . $pd0054995 . '">
				<iframe></iframe>
			</div>'; return $pf8ed4912; } public static function getTabContentTemplateLayoutTreeHtml($v3d55458bcd, $v5039a77f9d, $v08d9602741, $pdf77ee66, $v8ffce2a791, $pa0462a8e, $pf7b73b3a, $v9106c07f80) { $v9ab35f1f0d = $v08d9602741->getPresentationLayer(); if (empty($v9ab35f1f0d->settings["presentation_modules_path"])) launch_exception(new Exception("'PresentationLayer->settings[presentation_modules_path]' cannot be undefined!")); $pe61ee068 = $v08d9602741->getCommonProjectName() . "/" . $v9ab35f1f0d->settings["presentation_modules_path"]; $pf8ed4912 = '<script>
