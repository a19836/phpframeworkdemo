...
include_once $EVC->getUtilPath("WorkFlowDataAccessHandler"); include_once $EVC->getUtilPath("WorkFlowBrokersSelectedDBVarsHandler"); class WorkFlowQueryHandler { const TASK_QUERY_TYPE = "d0d250c0"; const TASK_QUERY_TAG = "query"; private $pcfdeae4e; private $pcd2aca48; private $v00161f0c07; private $v9b98e0e818; private $v5e788adf08; private $pc66a0204; private $v5a331eab7e; private $pd76831fc; private $v5e4089f2c3; private $v9d043dd3df; private $v197630b0cc; private $v1167f1d261; public function __construct($pcfdeae4e, $pcd2aca48, $v00161f0c07, $v9b98e0e818, $v5e788adf08, $pc66a0204, $v5a331eab7e, $pd76831fc, $v5e4089f2c3, $v9d043dd3df, $v197630b0cc, $v1167f1d261) { $this->pcfdeae4e = $pcfdeae4e; $this->pcd2aca48 = $pcd2aca48; $this->v00161f0c07 = $v00161f0c07; $this->v9b98e0e818 = $v9b98e0e818; $this->v5e788adf08 = $v5e788adf08; $this->pc66a0204 = $pc66a0204; $this->v5a331eab7e = $v5a331eab7e; $this->pd76831fc = $pd76831fc; $this->v5e4089f2c3 = $v5e4089f2c3; $this->v9d043dd3df = $v9d043dd3df; $this->v197630b0cc = $v197630b0cc; $this->v1167f1d261 = $v1167f1d261; } public static function getSelectedDBBrokersDriversTablesAndAttributes($pe54bee2d, $pdb9e96e6, $v875c215016 = false, $v1bdf90f0ab = false, $pb154d332 = false, $v1eb9193558 = null) { $pc4223ce1 = $pe54bee2d->getBrokers(); $v9b98e0e818 = array(); $v5e788adf08 = $pc66a0204 = $pf0f5722a = $v4fda6fa047 = $v5a331eab7e = $pd76831fc = $v5e4089f2c3 = $v9d043dd3df = null; if ($pc4223ce1) { foreach ($pc4223ce1 as $v2b2cf4c0eb => $pd922c2f7) { $v9b98e0e818[$v2b2cf4c0eb] = $pd922c2f7->getDBDriversName(); if ($pb154d332 && $v1eb9193558) $v1eb9193558->filterLayerBrokersDBDriversNamesFromLayoutName($pe54bee2d, $v9b98e0e818[$v2b2cf4c0eb], $pb154d332); if ($v1bdf90f0ab && empty($v5e788adf08) && !empty($v9b98e0e818[$v1bdf90f0ab])) { $v5e788adf08 = $v2b2cf4c0eb; $pc66a0204 = isset($v9b98e0e818[$v1bdf90f0ab][0]) ? $v9b98e0e818[$v1bdf90f0ab][0] : null; } else if (empty($pf0f5722a) && $v9b98e0e818[$v2b2cf4c0eb]) { $pf0f5722a = $v2b2cf4c0eb; $v4fda6fa047 = isset($v9b98e0e818[$v2b2cf4c0eb][0]) ? $v9b98e0e818[$v2b2cf4c0eb][0] : null; } } if (empty($v5e788adf08) && $pf0f5722a) { $v5e788adf08 = $pf0f5722a; $pc66a0204 = $v4fda6fa047; } } if ($v5e788adf08 && $pc66a0204) { $v5e053dece2 = WorkFlowTasksFileHandler::getDBDiagramTaskFilePath($pdb9e96e6, "db_diagram", $pc66a0204); $v5a331eab7e = file_exists($v5e053dece2) ? "diagram" : "db"; if ($v5a331eab7e == "diagram") { $v094d1a2778 = new WorkFlowDataAccessHandler(); $v094d1a2778->setTasksFilePath($v5e053dece2); $v1d696dbd12 = $v094d1a2778->getTasks(); $v5e4089f2c3 = !empty($v1d696dbd12["tasks"]) ? array_keys($v1d696dbd12["tasks"]) : array(); $pd76831fc = !empty($v875c215016) ? $v875c215016 : $v5e4089f2c3[0]; $v9d043dd3df = isset($v1d696dbd12["tasks"][$pd76831fc]) ? $v1d696dbd12["tasks"][$pd76831fc] : null; $v9d043dd3df = isset($v9d043dd3df["properties"]["table_attr_names"]) ? $v9d043dd3df["properties"]["table_attr_names"] : null; } else { $v1502dfe376 = $pe54bee2d->getBroker($v5e788adf08)->getFunction("listTables", null, array("db_driver" => $pc66a0204)); $v5e4089f2c3 = array(); if ($v1502dfe376) foreach ($v1502dfe376 as $pa9848378) $v5e4089f2c3[] = isset($pa9848378["name"]) ? $pa9848378["name"] : null; if ($v875c215016) { $v9a4d5f4ed3 = $pe54bee2d->getBroker($v5e788adf08)->getFunction("isTableInNamesList", array($v5e4089f2c3, $v875c215016), array("db_driver" => $pc66a0204)); $pd76831fc = $v9a4d5f4ed3 ? $v875c215016 : (isset($v5e4089f2c3[0]) ? $v5e4089f2c3[0] : null); } else $pd76831fc = isset($v5e4089f2c3[0]) ? $v5e4089f2c3[0] : null; $v9d043dd3df = $pe54bee2d->getBroker($v5e788adf08)->getFunction("listTableFields", $pd76831fc, array("db_driver" => $pc66a0204)); $v9d043dd3df = array_keys($v9d043dd3df); } } return array( "brokers" => $pc4223ce1, "db_drivers" => $v9b98e0e818, "selected_db_broker" => $v5e788adf08, "selected_db_driver" => $pc66a0204, "selected_type" => $v5a331eab7e, "selected_table" => $pd76831fc, "selected_tables_name" => $v5e4089f2c3, "selected_table_attrs" => $v9d043dd3df, ); } public function getDataAccessObjHtml($v69f1629ff2, $pab85d90e = false, $v30857f7eca = null) { $pf8ed4912 = '
				...
				<div class="relationships_tabs">
					...
					<div id="relationships_tabs-1">
						...
						<div id="relationships_tabs-2">
							<div class="parameters_maps">
								...
								<div class="parameters">'; if (!empty($v69f1629ff2["parameter_map"])) { $pc37695cb = count($v69f1629ff2["parameter_map"]); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) $pf8ed4912 .= $this->getParameterMapHTML("map", $v69f1629ff2["parameter_map"][$v43dd7d0051], $this->v197630b0cc, $this->v1167f1d261, true); } $pf8ed4912 .= '
								</div>
							</div>
						</div>'; } $pf8ed4912 .= '
					<div id="relationships_tabs-3">
						<div class="results_maps">
							...
							<div class="results">'; if (!empty($v69f1629ff2["result_map"])) { $pc37695cb = count($v69f1629ff2["result_map"]); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) $pf8ed4912 .= $this->getResultMapHTML("map", $v69f1629ff2["result_map"][$v43dd7d0051], $this->v197630b0cc, $this->v1167f1d261, true); } $pf8ed4912 .= '
							</div>
						</div>
					</div>'; $pf8ed4912 .= '
					<div id="relationships_tabs-4">' . $this->getInludeHTMLBlock(isset($v69f1629ff2["import"]) ? $v69f1629ff2["import"] : null) . '</div>'; $pf8ed4912 .= '	
				</div>
				...
				<div class="contents">
					...
					<div class="db_driver" ' . ($this->v5e788adf08 ? '' : 'style="display:none"') . '>
						...
						<select onChange="updateDBTables(this)">
							<option></option>'; if (!empty($this->v9b98e0e818[$this->v5e788adf08])) { $pc37695cb = count($this->v9b98e0e818[$this->v5e788adf08]); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) $pf8ed4912 .= '	<option ' . ($this->pc66a0204 == $this->v9b98e0e818[$this->v5e788adf08][$v43dd7d0051] ? 'selected' : '') . '>' . $this->v9b98e0e818[$this->v5e788adf08][$v43dd7d0051] . '</option>'; } $pf8ed4912 .= '		</select>
					</div>
		...
		<div class="map" ' . ($paeae9fca == "map" ? 'style="display:block;"' : 'style="display:none;"') . '>
			...
			<div class="map_id">
				<label>ID:</label>
				<input type="text" value="' . (isset($v2967293505["@"]["id"]) ? $v2967293505["@"]["id"] : "") . '" placeHolder="Id/Name" onBlur="validateMapId(this, \'parameter\');" />
			</div>
			<div class="map_class">
				<label>Class:</label>
				<input type="text" value="' . (isset($v2967293505["@"]["class"]) ? $v2967293505["@"]["class"] : "") . '" />
			...
			<table>
				...
				<tbody class="fields">'; $v9367d5be85 = isset($v2967293505["childs"]["parameter"]) ? $v2967293505["childs"]["parameter"] : null; if ($v9367d5be85) { $pc37695cb = count($v9367d5be85); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $pc5faab2f = isset($v9367d5be85[$v43dd7d0051]["@"]) ? $v9367d5be85[$v43dd7d0051]["@"] : null; $v2d257aa038 = isset($pc5faab2f["input_name"]) ? $pc5faab2f["input_name"] : null; $pc3160b38 = isset($pc5faab2f["input_type"]) ? $pc5faab2f["input_type"] : null; $v28eefd61c1 = isset($pc5faab2f["output_name"]) ? $pc5faab2f["output_name"] : null; $paa11e516 = isset($pc5faab2f["output_type"]) ? $pc5faab2f["output_type"] : null; $v2d235becd6 = isset($pc5faab2f["mandatory"]) ? $pc5faab2f["mandatory"] : null; $pf8ed4912 .= $this->getParameterHTML($v197630b0cc, $v1167f1d261, $v2d257aa038, $pc3160b38, $v28eefd61c1, $paa11e516, $v2d235becd6); } } else $pf8ed4912 .= $this->getParameterHTML($v197630b0cc, $v1167f1d261); $pf8ed4912 .= '	</tbody>
			</table>
		...
		<div class="map" ' . ($pbd9f98de == "map" ? 'style="display:block;"' : 'style="display:none;"') . '>
			...
			<div class="map_id">
				<label>ID:</label>
				<input type="text" value="' . (isset($pce128343["@"]["id"]) ? $pce128343["@"]["id"] : "") . '" placeHolder="Id/Name" onFocus="disableTemporaryAutoSaveOnInputFocus(this)" onBlur="undoDisableTemporaryAutoSaveOnInputBlur(this); validateMapId(this, \'result\');" />
			</div>
			<div class="map_class">
				<label>Class:</label>
				<input type="text" value="' . (isset($pce128343["@"]["class"]) ? $pce128343["@"]["class"] : "") . '" />
				<span class="icon search" onClick="getParameterClassFromFileManager(this)">Search</span>
			</div>
			<table>
				<thead class="fields_title">
				...
				<tbody class="fields">'; $pee4c7870 = isset($pce128343["childs"]["result"]) ? $pce128343["childs"]["result"] : null; if ($pee4c7870) { $pc37695cb = count($pee4c7870); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v9ad1385268 = isset($pee4c7870[$v43dd7d0051]["@"]) ? $pee4c7870[$v43dd7d0051]["@"] : null; $v62c8f119b8 = isset($v9ad1385268["input_name"]) ? $v9ad1385268["input_name"] : null; $v9a0ea4ceef = isset($v9ad1385268["input_type"]) ? $v9ad1385268["input_type"] : null; $paec69141 = isset($v9ad1385268["output_name"]) ? $v9ad1385268["output_name"] : null; $pff175929 = isset($v9ad1385268["output_type"]) ? $v9ad1385268["output_type"] : null; $ped26e6bc = isset($v9ad1385268["mandatory"]) ? $v9ad1385268["mandatory"] : null; $pf8ed4912 .= $this->getResultHTML($v197630b0cc, $v1167f1d261, $v62c8f119b8, $v9a0ea4ceef, $paec69141, $pff175929, $ped26e6bc); } } else $pf8ed4912 .= $this->getResultHTML($v197630b0cc, $v1167f1d261); $pf8ed4912 .= '	</tbody>
			</table>
		</div>'; return $pf8ed4912; } public function getQueriesBlockHtml($v987a981e39, $pab85d90e = false, $pa1c701b0 = false, $v483eef20da = true, $v30857f7eca = null) { $pf8ed4912 = ""; if ($v987a981e39) { $pc37695cb = count($v987a981e39); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v16eb00c1d7 = $v987a981e39[$v43dd7d0051]; $v1cbfbb49c5 = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "id"); $v5e813b295b = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "name"); $v217e7cf3c0 = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "parameter_class"); $v2967293505 = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "parameter_map"); $v21ff8db28c = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "result_class"); $pce128343 = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "result_map"); $pfdbbc383 = isset($v16eb00c1d7["childs"]["attribute"]) ? $v16eb00c1d7["childs"]["attribute"] : null; $v9994512d98 = isset($v16eb00c1d7["childs"]["key"]) ? $v16eb00c1d7["childs"]["key"] : null; $paf1bc6f6 = isset($v16eb00c1d7["childs"]["condition"]) ? $v16eb00c1d7["childs"]["condition"] : null; $pe4b1434e = isset($v16eb00c1d7["childs"]["group_by"]) ? $v16eb00c1d7["childs"]["group_by"] : null; $v04003a4f53 = isset($v16eb00c1d7["childs"]["sort"]) ? $v16eb00c1d7["childs"]["sort"] : null; $v552b831ecd = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "limit"); $v7e4b517c18 = WorkFlowDataAccessHandler::getNodeValue($v16eb00c1d7, "start"); $v3c76382d93 = isset($v16eb00c1d7["value"]) ? $v16eb00c1d7["value"] : null; $v93ff269092 = rand(0, 1000); $v016220e8f0 = $pab85d90e ? $v5e813b295b : $v1cbfbb49c5; $v539082ff30 = array( "type" => $pa1c701b0, "name" => $v016220e8f0, "parameter_class" => $v217e7cf3c0, "parameter_map" => $v2967293505, "result_class" => $v21ff8db28c, "result_map" => $pce128343, "attributes" => $pfdbbc383, "keys" => $v9994512d98, "conditions" => $paf1bc6f6, "groups_by" => $pe4b1434e, "sorts" => $v04003a4f53, "limit" => $v552b831ecd, "start" => $v7e4b517c18, "sql" => $v3c76382d93 ); $v90746d4d9c = array( "init_ui" => true, "init_workflow" => true, "minimize" => $v483eef20da, ); $v30857f7eca = $v30857f7eca ? array_merge($v90746d4d9c, $v30857f7eca) : $v90746d4d9c; $pbe1051a0 = $this->getQueryBlockHtml($pab85d90e, $v30857f7eca, $v539082ff30); $pbe1051a0 = str_replace("#rand#", $v93ff269092, $pbe1051a0); $pf8ed4912 .= $pbe1051a0; } } return $pf8ed4912; } public function getQueryBlockHtml($pab85d90e = false, $v30857f7eca = false, $v539082ff30 = false) { $v6cf0577ade = isset($v30857f7eca["init_ui"]) ? $v30857f7eca["init_ui"] : null; $v483eef20da = isset($v30857f7eca["minimize"]) ? $v30857f7eca["minimize"] : null; $v6d756b21eb = isset($v30857f7eca["encapsulate_parameter_and_result_settings"]) ? $v30857f7eca["encapsulate_parameter_and_result_settings"] : null; $pa1c701b0 = isset($v539082ff30["type"]) ? $v539082ff30["type"] : null; $v5e813b295b = isset($v539082ff30["name"]) ? $v539082ff30["name"] : null; $v217e7cf3c0 = isset($v539082ff30["parameter_class"]) ? $v539082ff30["parameter_class"] : null; $v2967293505 = isset($v539082ff30["parameter_map"]) ? $v539082ff30["parameter_map"] : null; $v21ff8db28c = isset($v539082ff30["result_class"]) ? $v539082ff30["result_class"] : null; $pce128343 = isset($v539082ff30["result_map"]) ? $v539082ff30["result_map"] : null; $pfdbbc383 = isset($v539082ff30["attributes"]) ? $v539082ff30["attributes"] : null; $v9994512d98 = isset($v539082ff30["keys"]) ? $v539082ff30["keys"] : null; $paf1bc6f6 = isset($v539082ff30["conditions"]) ? $v539082ff30["conditions"] : null; $pe4b1434e = isset($v539082ff30["groups_by"]) ? $v539082ff30["groups_by"] : null; $v04003a4f53 = isset($v539082ff30["sorts"]) ? $v539082ff30["sorts"] : null; $v552b831ecd = isset($v539082ff30["limit"]) ? $v539082ff30["limit"] : null; $v7e4b517c18 = isset($v539082ff30["start"]) ? $v539082ff30["start"] : null; $v3c76382d93 = isset($v539082ff30["sql"]) ? $v539082ff30["sql"] : null; if ($pab85d90e) { $pba9aec33 = array("one_to_one", "one_to_many", "many_to_one", "many_to_many"); $pcdd6ebdf = true; } else { $pba9aec33 = array("insert", "update", "delete", "select", "procedure"); $pcdd6ebdf = $pa1c701b0 == "select"; } $pf8ed4912 = '
		...
		</div>'; return $pf8ed4912; } public function getQueryInsertUpdateDeleteHtml($pfdbbc383 = false, $paf1bc6f6 = false) { $pc661dc6b = isset($pfdbbc383[0]) ? WorkFlowDataAccessHandler::getNodeValue($pfdbbc383[0], "table") : ""; $pc661dc6b = $pc661dc6b ? $pc661dc6b : ($paf1bc6f6 ? WorkFlowDataAccessHandler::getNodeValue($paf1bc6f6[0], "table") : ""); $pf8ed4912 = '
		...
		<div id="query_insert_update_delete_tabs_#rand#-2" class="conditions query_insert_update_delete_tab">
			<table>
				...
				<tbody class="fields">'; if ($paf1bc6f6) { $pc37695cb = count($paf1bc6f6); for ($v9d27441e80 = 0; $v9d27441e80 < $pc37695cb; $v9d27441e80++) { $v32dd06ab9b = $paf1bc6f6[$v9d27441e80]; if (!empty($v32dd06ab9b["@"]) || !empty($v32dd06ab9b["childs"])) { $v9ea12a829c = WorkFlowDataAccessHandler::getNodeValue($v32dd06ab9b, "column"); $v19a7745bc6 = WorkFlowDataAccessHandler::getNodeValue($v32dd06ab9b, "operator"); $v67db1bd535 = WorkFlowDataAccessHandler::getNodeValue($v32dd06ab9b, "value"); $pf8ed4912 .= self::getQueryConditionHtml2($v9ea12a829c, $v19a7745bc6, $v67db1bd535); } } } $pf8ed4912 .= '
				</tbody>
			</table>
