 ...
 */
 include_once get_lib("org.phpframework.workflow.WorkFlowTaskHandler"); include_once $EVC->getUtilPath("WorkFlowBrokersSelectedDBVarsHandler"); include_once $EVC->getUtilPath("WorkFlowUIHandler"); include_once $EVC->getUtilPath("WorkFlowQueryHandler"); include_once $EVC->getUtilPath("WorkFlowPresentationHandler"); include_once $EVC->getUtilPath("CMSPresentationUIAutomaticFilesHandler"); include_once $EVC->getUtilPath("LayoutTypeProjectHandler"); include_once $EVC->getUtilPath("LayoutTypeProjectUIHandler"); class SequentialLogicalActivityUIHandler { public static function getHeader($v08d9602741, $v188b4f5fa6, $pdf77ee66, $v8ffce2a791, $pa0462a8e, $pa32be502, $peb014cfd, $v37d269c4fa, $pf3d7391b, $v3d55458bcd, $v5039a77f9d, $v4bf8d90f04, $pfce4d1b3, $pb154d332, $pebb3f429 = false) { $v0a9dad1fe0 = ""; $v1fac4509df = isset($pebb3f429["main_div_selector"]) ? $pebb3f429["main_div_selector"] : null; $v125cfae519 = isset($pebb3f429["allowed_tasks_tag"]) ? $pebb3f429["allowed_tasks_tag"] : null; $pd0cdca01 = isset($pebb3f429["extra_tasks_folder_path"]) ? $pebb3f429["extra_tasks_folder_path"] : null; $v521be90a09 = isset($pebb3f429["tasks_groups_by_tag"]) ? $pebb3f429["tasks_groups_by_tag"] : null; $pac87cfac = isset($pebb3f429["ui_menu_widgets_selector"]) ? $pebb3f429["ui_menu_widgets_selector"] : null; if (!$v125cfae519) $v125cfae519 = array("slaitemsingle", "slaitemgroup"); if (!$v521be90a09) $v521be90a09 = array( "SLA Groups/Actions" => array("slaitemsingle", "slaitemgroup") ); if (!$pac87cfac) $pac87cfac = ".sla_ui_menu_widgets_backup"; $v9ab35f1f0d = $v188b4f5fa6->getPresentationLayer(); $v6c1c99fc85 = CMSPresentationLayerHandler::getPresentationLayerProjectsFiles($v3d55458bcd, $v5039a77f9d, $pa0462a8e, $v8ffce2a791); $v1eb9193558 = new LayoutTypeProjectHandler($pdf77ee66, $v3d55458bcd, $v5039a77f9d, $pa0462a8e, $v8ffce2a791); $v1eb9193558->filterPresentationLayerProjectsByUserAndLayoutPermissions($v6c1c99fc85, $pb154d332, null, array( "do_not_filter_by_layout" => array( "bean_name" => $v8ffce2a791, "bean_file_name" => $pa0462a8e, "project" => $v9ab35f1f0d->getSelectedPresentationId(), ) )); $v6c1c99fc85 = array_keys($v6c1c99fc85); $pc4223ce1 = $v9ab35f1f0d->getBrokers(); $v7a0994a134 = WorkFlowBeansFileHandler::getLayerBrokersSettings($v3d55458bcd, $v5039a77f9d, $pc4223ce1, '$EVC->getBroker'); $v8671b32a11 = WorkFlowBeansFileHandler::getLayerNameFromBeanObject($v8ffce2a791, $v9ab35f1f0d) . " (Self)"; $pb0e92e25 = array( array($v8671b32a11, $pa0462a8e, $v8ffce2a791) ); $v89e7b130c6 = array("default" => '$EVC->getPresentationLayer()'); $v7a0994a134["presentation_brokers"] = $pb0e92e25; $v7a0994a134["presentation_brokers_obj"] = $v89e7b130c6; $v6e9af47944 = $v7a0994a134["business_logic_brokers"]; $v5421227efb = $v7a0994a134["business_logic_brokers_obj"]; $v9fda9fad47 = $v7a0994a134["data_access_brokers"]; $pdeced6cd = $v7a0994a134["data_access_brokers_obj"]; $pf864769c = $v7a0994a134["ibatis_brokers"]; $v6a3a9f9182 = $v7a0994a134["ibatis_brokers_obj"]; $paf75a67c = $v7a0994a134["hibernate_brokers"]; $pbf7e8fcb = $v7a0994a134["hibernate_brokers_obj"]; $v5483bfa973 = $v7a0994a134["db_brokers"]; $v78844cd25d = $v7a0994a134["db_brokers_obj"]; $pb7b19dbe = array( $v8671b32a11 => isset($pb0e92e25[0]) ? $pb0e92e25[0] : null ); $v1f410c3f6b = array( $v89e7b130c6["default"] => $v8671b32a11, ); foreach ($v6e9af47944 as $v7aeaf992f5) { $v2b2cf4c0eb = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $pb7b19dbe[$v2b2cf4c0eb] = $v7aeaf992f5; $v1f410c3f6b[ $v5421227efb[$v2b2cf4c0eb] ] = $v2b2cf4c0eb; } foreach ($v9fda9fad47 as $v7aeaf992f5) { $v2b2cf4c0eb = isset($v7aeaf992f5[0]) ? $v7aeaf992f5[0] : null; $pb7b19dbe[$v2b2cf4c0eb] = $v7aeaf992f5; $v1f410c3f6b[ $pdeced6cd[$v2b2cf4c0eb] ] = $v2b2cf4c0eb; } $v2aa21ff4fa = array("createform", "callfunction", "callobjectmethod", "restconnector", "soapconnector"); $v125cfae519 = is_array($v125cfae519) ? $v125cfae519 : ($v125cfae519 ? array($v125cfae519) : array()); $v125cfae519 = $v125cfae519 ? array_merge($v2aa21ff4fa, $v125cfae519) : $v2aa21ff4fa; if ($pdeced6cd) { $v125cfae519[] = "query"; $v125cfae519[] = "getquerydata"; $v125cfae519[] = "setquerydata"; if ($v6a3a9f9182) $v125cfae519[] = "callibatisquery"; if ($pbf7e8fcb) $v125cfae519[] = "callhibernatemethod"; } else if ($v78844cd25d) { $v125cfae519[] = "query"; $v125cfae519[] = "getquerydata"; $v125cfae519[] = "setquerydata"; } if ($v5421227efb) $v125cfae519[] = "callbusinesslogic"; $pecad7cca = new WorkFlowTaskHandler($v4bf8d90f04, $pfce4d1b3); $pecad7cca->setCacheRootPath(LAYER_CACHE_PATH); $pecad7cca->setAllowedTaskTags($v125cfae519); if ($pd0cdca01) $pecad7cca->addTasksFolderPath($pd0cdca01); $v0fec18f1f9 = array( "disabled" => array("createform", "callfunction", "callobjectmethod", "restconnector", "soapconnector", "query", "getquerydata", "setquerydata", "callibatisquery", "callhibernatemethod", "callbusinesslogic"), ); $v521be90a09 = is_array($v521be90a09) ? $v521be90a09 : ($v521be90a09 ? array($v521be90a09) : array()); $v521be90a09 = $v521be90a09 ? array_merge($v0fec18f1f9, $v521be90a09) : $v0fec18f1f9; $pcfdeae4e = new WorkFlowUIHandler($pecad7cca, $peb014cfd, $v37d269c4fa, $pf3d7391b, $v3d55458bcd, $v4bf8d90f04, $pfce4d1b3); $pcfdeae4e->setTasksGroupsByTag($v521be90a09); $v524bbc0f84 = $pecad7cca->getLoadedTasksSettings(); $v830c74e006 = array(); $v0e9b8a0e96 = array(); foreach ($v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { if (is_array($v003bc751fd)) { $v1b1c6a10a2 = isset($v003bc751fd["tag"]) ? $v003bc751fd["tag"] : null; $v830c74e006[$v1b1c6a10a2] = isset($v003bc751fd["task_properties_html"]) ? $v003bc751fd["task_properties_html"] : null; $v0e9b8a0e96[$v1b1c6a10a2] = isset($v003bc751fd["settings"]["callback"]["on_load_task_properties"]) ? $v003bc751fd["settings"]["callback"]["on_load_task_properties"] : null; } } } $pe44aa1fe = WorkFlowBrokersSelectedDBVarsHandler::getBrokersSelectedDBVars($pc4223ce1); $v9b98e0e818 = isset($pe44aa1fe["db_brokers_drivers"]) ? $pe44aa1fe["db_brokers_drivers"] : null; $pd7f46171 = isset($pe44aa1fe["dal_broker"]) ? $pe44aa1fe["dal_broker"] : null; $pc66a0204 = isset($pe44aa1fe["db_driver"]) ? $pe44aa1fe["db_driver"] : null; $v5a331eab7e = isset($pe44aa1fe["type"]) ? $pe44aa1fe["type"] : null; if ($v9b98e0e818) foreach ($v9b98e0e818 as $v0a5deb92d8 => &$pb56484b3) $v1eb9193558->filterLayerBrokersDBDriversNamesFromLayoutName($v9ab35f1f0d, $pb56484b3, $pb154d332); $pea5fed5d = LayoutTypeProjectUIHandler::getFilterByLayoutURLQuery($pb154d332); $pa0c6ce9a = $peb014cfd . "phpframework/dataaccess/get_query_properties?bean_name=#bean_name#&bean_file_name=#bean_file_name#&db_driver=#db_driver#&db_type=#db_type#&path=#path#&query_type=#query_type#&query=#query#&obj=#obj#&relationship_type=#relationship_type#"; $v4ee0f690b1 = $peb014cfd . "phpframework/dataaccess/get_query_result_properties?bean_name=#bean_name#&bean_file_name=#bean_file_name#&db_driver=" . $pc66a0204 . "&module_id=#module_id#&query_type=#query_type#&query=#query#&rel_name=#rel_name#&obj=#obj#&relationship_type=#relationship_type#"; $v9d21f98a2c = $peb014cfd . "phpframework/businesslogic/get_business_logic_properties?bean_name=#bean_name#&bean_file_name=#bean_file_name#&path=#path#&service=#service#"; $v06d0841ec2 = $peb014cfd . "phpframework/businesslogic/get_business_logic_result_properties?bean_name=#bean_name#&bean_file_name=#bean_file_name#&module_id=#module_id#&service=#service#&db_driver=" . $pc66a0204; $v4d78e2ccd0 = $peb014cfd . "phpframework/presentation/get_util_result_properties?bean_name=$v8ffce2a791&bean_file_name=$pa0462a8e&path=$pa32be502&class_path=#class_path#&class_name=#class_name#&method=#method#&db_driver=" . $pc66a0204; $v26f1ca5c9c = $peb014cfd . "phpframework/db/get_broker_db_drivers?bean_name=$v8ffce2a791&bean_file_name=$pa0462a8e&broker=#broker#&item_type=presentation"; $v79a281fbbc = $peb014cfd . "phpframework/admin/edit_task_source?bean_name=$v8ffce2a791&bean_file_name=$pa0462a8e$pea5fed5d&path=$pa32be502"; $v5912710733 = $peb014cfd . 'phpframework/sequentiallogicalactivity/get_input_data_method_settings'; $pac9213a9 = $peb014cfd . "phpframework/sequentiallogicalactivity/get_sla_action_result_properties"; $v0bc2b49b83 = $peb014cfd . "phpframework/sequentiallogicalactivity/convert_sla_settings_to_php_code?bean_name=$v8ffce2a791&bean_file_name=$pa0462a8e&path=$pa32be502"; $pb03d3981 = $peb014cfd . "phpframework/sequentiallogicalactivity/create_sla_settings_code"; $v960400fcd0 = $peb014cfd . "phpframework/sequentiallogicalactivity/create_sla_resource?bean_name=$v8ffce2a791&bean_file_name=$pa0462a8e$pea5fed5d&path=$pa32be502"; $v0a9dad1fe0 .= WorkFlowPresentationHandler::getFileManagerTreePopupHeader($peb014cfd); $pa8dedb03 = '
		...
		//prepare sla urls
		var get_input_data_method_settings_url = \'' . $v5912710733 . '\';
		...
		'; $v567e6991bf = false; if ($v9b98e0e818) { $v567e6991bf = true; $v546cf76c77 = new WorkFlowTaskHandler($v4bf8d90f04, $pfce4d1b3); $v546cf76c77->setCacheRootPath(LAYER_CACHE_PATH); $v546cf76c77->setAllowedTaskTags(array("query")); $pb692084d = new WorkFlowUIHandler($v546cf76c77, $peb014cfd, $v37d269c4fa, $pf3d7391b, $v3d55458bcd, $v4bf8d90f04, $pfce4d1b3); $v0a1f4a55aa = new WorkFlowQueryHandler($pb692084d, $peb014cfd, $v37d269c4fa, $v9b98e0e818, $pd7f46171, $pc66a0204, $v5a331eab7e, "", array(), array(), array(), array()); $pbb688020 = $v0a1f4a55aa->getDataAccessJavascript($v8ffce2a791, $pa0462a8e, $pa32be502, "presentation", null, null); $pa8dedb03 .= str_replace('<script>', '', str_replace('</script>', '', $pbb688020)); $pa8dedb03 .= 'get_broker_db_data_url += "&global_default_db_driver_broker=' . (isset($GLOBALS["default_db_broker"]) ? $GLOBALS["default_db_broker"] : "") . '";'; $pf8ed4912 = $v0a1f4a55aa->getGlobalTaskFlowChar(); $pf8ed4912 .= $v0a1f4a55aa->getQueryBlockHtml(); $pa8dedb03 .= 'var query_task_html = \'' . addcslashes(str_replace("\n", "", $pf8ed4912), "\\'") . '\';'; if ($v1fac4509df) { $pf8ed4912 = $v0a1f4a55aa->getChooseQueryTableOrAttributeHtml("choose_db_table_or_attribute"); $pa8dedb03 .= '
				...
				'; } $pa8dedb03 .= WorkFlowBrokersSelectedDBVarsHandler::printSelectedDBVarsJavascriptCode($peb014cfd, $v8ffce2a791, $pa0462a8e, null); } else if ($v1fac4509df) { $v0a2a46479f = WorkFlowBeansFileHandler::getLocalBeanLayersFromBrokers($v3d55458bcd, $v5039a77f9d, $pc4223ce1, true, true, $v8b7470d48c, $pf8d1e53c); $pd7f46171 = ""; $pc66a0204 = ""; $v5a331eab7e = "db"; $pbfd2d1c4 = array(); foreach ($v0a2a46479f as $v14b72a9b5d => $v5ce4bd29b6) { if (is_a($v5ce4bd29b6, "DataAccessLayer") || is_a($v5ce4bd29b6, "DBLayer")) { $v3cf0cdca2d = isset($pf8d1e53c[$v14b72a9b5d]) ? $pf8d1e53c[$v14b72a9b5d] : null; $pb56484b3 = is_a($v5ce4bd29b6, "DBLayer") ? $v5ce4bd29b6->getDBDriversName() : $v5ce4bd29b6->getBrokersDBDriversName(); $v1eb9193558->filterLayerBrokersDBDriversNamesFromLayoutName($v9ab35f1f0d, $pb56484b3, $pb154d332); if ($pb56484b3) { $pd7f46171 = isset($v3cf0cdca2d[0]) ? $v3cf0cdca2d[0] : null; $pc66a0204 = isset($pb56484b3[0]) ? $pb56484b3[0] : null; foreach ($v3cf0cdca2d as $pe4f3a4ec) $pbfd2d1c4[$pe4f3a4ec] = $pb56484b3; } } } if ($pbfd2d1c4) { $v567e6991bf = true; $pe44aa1fe = array( "dal_broker" => $pd7f46171, "db_driver" => $pc66a0204, "type" => $v5a331eab7e, "db_table" => "", "db_brokers_drivers" => $pbfd2d1c4 ); $v0a1f4a55aa = new WorkFlowQueryHandler(null, $peb014cfd, $v37d269c4fa, isset($pe44aa1fe["db_brokers_drivers"]) ? $pe44aa1fe["db_brokers_drivers"] : null, $pd7f46171, $pc66a0204, $v5a331eab7e, "", array(), array(), array(), array()); $pf8ed4912 = $v0a1f4a55aa->getChooseQueryTableOrAttributeHtml("choose_db_table_or_attribute"); $pa8dedb03 .= '
				var choose_db_table_or_attribute_elm = $( \'' . addcslashes(str_replace("\n", "", $pf8ed4912), "\\'") . '\' );
		...
		var db_blob_types = ' . json_encode(ObjTypeHandler::getDBBlobTypes()) . ';'; $v7726c9ee2f = array_values( array_map('strtolower', array_unique( array_merge( ObjTypeHandler::getDBAttributeNameCreatedDateAvailableValues(), ObjTypeHandler::getDBAttributeNameModifiedDateAvailableValues(), ObjTypeHandler::getDBAttributeNameCreatedUserIdAvailableValues(), ObjTypeHandler::getDBAttributeNameModifiedUserIdAvailableValues() ) ) ) ); $pa8dedb03 .= '
		var internal_attribute_names = ' . json_encode($v7726c9ee2f) . ';'; return array( "head" => $v0a9dad1fe0, "js_head" => $pa8dedb03, "tasks_contents" => $v830c74e006, "layer_brokers_settings" => $v7a0994a134, "presentation_projects" => $v6c1c99fc85, "db_drivers" => $v9b98e0e818, "WorkFlowTaskHandler" => $pecad7cca, "WorkFlowUIHandler" => $pcfdeae4e, "set_workflow_file_url" => isset($v8555f2f905) ? $v8555f2f905 : null, "get_workflow_file_url" => isset($v238161ae8d) ? $v238161ae8d : null, ); } public static function getWorkflowHeader($v188b4f5fa6, $pdf77ee66, $v8ffce2a791, $pa0462a8e, $pa32be502, $peb014cfd, $v37d269c4fa, $pf3d7391b, $v3d55458bcd, $v5039a77f9d, $v4bf8d90f04, $pfce4d1b3, $pb154d332, $pecad7cca, $pebb3f429 = false) { $v8484328271 = isset($pebb3f429["workflow_tasks_id"]) ? $pebb3f429["workflow_tasks_id"] : null; $pd9acc397 = isset($pebb3f429["path_extra"]) ? $pebb3f429["path_extra"] : null; if ($v8484328271) { $pec987416 = $v8484328271 . "&path_extra=_$pd9acc397"; $v240665d486 = $v8484328271 . "_tmp&path_extra=_{$pd9acc397}_" . rand(0, 1000); $v8555f2f905 = $peb014cfd . "workflow/set_workflow_file?path={$pec987416}"; $v238161ae8d = $peb014cfd . "workflow/get_workflow_file?path={$pec987416}"; $pfb41478d = $peb014cfd . "workflow/get_workflow_file?path={$v240665d486}"; $paa9d13a1 = $peb014cfd . "workflow/set_workflow_file?path={$v240665d486}"; $pc8fa5eaa = $peb014cfd . "phpframework/sequentiallogicalactivity/create_sla_workflow_file_from_settings?path={$v240665d486}&loaded_tasks_settings_cache_id=" . $pecad7cca->getLoadedTasksSettingsCacheId(); $v5335d566a3 = $peb014cfd . "phpframework/sequentiallogicalactivity/create_sla_settings_from_workflow_file?path={$v240665d486}"; $pa8dedb03 = '
			...
			<div class="sla">
				...
				' . $v79d9dffbb9 . '
				' . $v166b6fac8f . '
			</div>'; return $pf8ed4912; } public static function getTasksFlowHtml($v08d9602741, $peb014cfd, $v37d269c4fa, $v3e187ca1b8, $v4bf8d90f04, $pfce4d1b3, $v6490ea3a15, $v9b98e0e818, $v6c1c99fc85, $pcfdeae4e, $pebb3f429 = null) { $pb085e184 = $pebb3f429 && isset($pebb3f429["save_func"]) ? $pebb3f429["save_func"]: null; $pf8ed4912 = '
			<div id="ui">
			...
			</div>'; return $pf8ed4912; } public static function getGroupsFlowHtml($v08d9602741, $v188b4f5fa6, $peb014cfd, $v37d269c4fa, $v3e187ca1b8, $v4bf8d90f04, $pfce4d1b3, $v6490ea3a15, $v9b98e0e818, $v6c1c99fc85, $pebb3f429 = null) { $v7cb32cf01b = $pebb3f429 && isset($pebb3f429["extra_short_actions_html"]) ? $pebb3f429["extra_short_actions_html"] : ""; $pf8ed4912 = '
			<div id="sla_groups_flow" class="sla_groups_flow">
				...
				<ul class="sla_groups sla_main_groups">
					<li class="sla_group_item sla_group_default">
						' . self::getGroupItemHtml($v08d9602741, $v188b4f5fa6, $peb014cfd, $v37d269c4fa, $v3e187ca1b8, $v4bf8d90f04, $pfce4d1b3, $v6490ea3a15, $v9b98e0e818, $v6c1c99fc85) . '
					</li>
					<li class="sla_group_empty_items">There are no groups available...</li>
				</ul>
			</div>'; return $pf8ed4912; } public static function getGroupItemHtml($v08d9602741, $v188b4f5fa6, $peb014cfd, $v37d269c4fa, $v3e187ca1b8, $v4bf8d90f04, $pfce4d1b3, $v6490ea3a15, $v9b98e0e818, $v6c1c99fc85) { $pefdd2109 = self::getUIMenuWidgetsHTML($v08d9602741, $peb014cfd, $v3e187ca1b8, $v4bf8d90f04, $pfce4d1b3); $pf77b4bb0 = $v188b4f5fa6->getModulePath("common/CommonModuleUI", $v08d9602741->getCommonProjectName()); $v4bc3e85ad1 = file_exists($pf77b4bb0); $v1cf81e6c0f = $v188b4f5fa6->getModulePath("user/UserUtil", $v08d9602741->getCommonProjectName()); $v9ff7f1bef8 = file_exists($v1cf81e6c0f); $pf8ed4912 = '
		...
		<div class="selected_task_properties sla_group_body">
			...
			<section class="html_action_body">
				<!-- FORM -->
				' . (isset($v6490ea3a15["createform"]) ? $v6490ea3a15["createform"] : "") . '
			...
			<section class="broker_action_body">
				' . (isset($v6490ea3a15["callbusinesslogic"]) ? $v6490ea3a15["callbusinesslogic"] : "") . '
				' . (isset($v6490ea3a15["callibatisquery"]) ? $v6490ea3a15["callibatisquery"] : "") . '
				' . (isset($v6490ea3a15["callhibernatemethod"]) ? $v6490ea3a15["callhibernatemethod"] : "") . '
				' . (isset($v6490ea3a15["getquerydata"]) ? $v6490ea3a15["getquerydata"] : "") . '
				' . (isset($v6490ea3a15["setquerydata"]) ? $v6490ea3a15["setquerydata"] : "") . '
				' . (isset($v6490ea3a15["callfunction"]) ? $v6490ea3a15["callfunction"] : "") . '
				' . (isset($v6490ea3a15["callobjectmethod"]) ? $v6490ea3a15["callobjectmethod"] : "") . '
				' . (isset($v6490ea3a15["restconnector"]) ? $v6490ea3a15["restconnector"] : "") . '
				' . (isset($v6490ea3a15["soapconnector"]) ? $v6490ea3a15["soapconnector"] : "") . '
			</section>
