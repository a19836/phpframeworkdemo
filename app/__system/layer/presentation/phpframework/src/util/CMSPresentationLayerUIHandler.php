...
<link rel="stylesheet" href="' . $peb014cfd . 'lib/jquerylayoutuieditor/css/style.css" type="text/css" charset="utf-8" />
<link rel="stylesheet" href="' . $peb014cfd . 'lib/jquerylayoutuieditor/css/widget_resource.css" type="text/css" charset="utf-8" />

<script language="javascript" type="text/javascript" src="' . $peb014cfd . 'lib/jquerylayoutuieditor/js/TextSelection.js"></script>
<script language="javascript" type="text/javascript" src="' . $peb014cfd . 'lib/jquerylayoutuieditor/js/LayoutUIEditor.js"></script>
<script language="javascript" type="text/javascript" src="' . $peb014cfd . 'lib/jquerylayoutuieditor/js/CreateWidgetContainerClassObj.js"></script>
<script language="javascript" type="text/javascript" src="' . $peb014cfd . 'lib/jquerylayoutuieditor/js/LayoutUIEditorFormField.js"></script>
<script language="javascript" type="text/javascript" src="' . $peb014cfd . 'lib/jquerylayoutuieditor/js/LayoutUIEditorWidgetResource.js"></script>
...
'; return $pf8ed4912; } public static function getChoosePresentationIncludeFromFileManagerPopupHtml($v8ffce2a791, $pa0462a8e, $pf7b73b3a, $v54c4a1fbb7, $pe2f0f7f1, $v828ff69e5c, $pb0e92e25, $v8aefdcedb9 = "MyFancyPopup") { $pdf10c8d2 = !empty($pb0e92e25[0][0]) ? $pb0e92e25[0][0] : $v8ffce2a791; return '<div id="choose_presentation_include_from_file_manager" class="myfancypopup choose_from_file_manager with_title">
		...
		</div>'; } public static function getTemplateRegionBlockHtmlEditorPopupHtml($pefdd2109) { $v446c479876 = isset($_COOKIE["main_navigator_side"]) && $_COOKIE["main_navigator_side"] == "main_navigator_reverse" ? "" : "reverse"; return '<div class="template_region_block_html_editor_popup myfancypopup">
			...
			<div class="includes">
				...
				<div class="items">'; if ($pc06f1034) { $pc37695cb = count($pc06f1034); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $pc24afc88 = $pc06f1034[$v43dd7d0051]; $pbdb96933 = isset($pc24afc88["path"]) ? $pc24afc88["path"] : null; $v1daf7d6151 = isset($pc24afc88["path_type"]) ? $pc24afc88["path_type"] : null; $pee6ea13c = isset($pc24afc88["once"]) ? $pc24afc88["once"] : null; $v154d33eec4 = PHPUICodeExpressionHandler::getArgumentCode($pbdb96933, $v1daf7d6151); $pf8ed4912 .= self::getIncludeHtml($v154d33eec4, $pee6ea13c); } } $pf8ed4912 .= '	</div>
			...
			<div class="template_params">
				...
				<div class="items">'; $v0db218b458 = array(); if ($v7b2ad4afbf) { if ($v3fd37663c7) { $pc37695cb = count($v3fd37663c7); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v58b61e02bc = $v3fd37663c7[$v43dd7d0051]; if ($v58b61e02bc && !isset($v0db218b458[$v58b61e02bc])) { $v72eb975550 = isset($v1fb4b254d3[$v58b61e02bc]) ? $v1fb4b254d3[$v58b61e02bc] : null; $pd6bf10d2 = isset($v45e5141563[$v58b61e02bc]) ? $v45e5141563[$v58b61e02bc] : null; $pf8ed4912 .= self::getTemplateParamHtml($v58b61e02bc, $v72eb975550, $pd6bf10d2); } $v0db218b458[$v58b61e02bc] = true; } } if ($v45e5141563) { foreach ($v45e5141563 as $v58b61e02bc => $pd6bf10d2) { if ($v58b61e02bc && !isset($v0db218b458[$v58b61e02bc])) { $v72eb975550 = isset($v1fb4b254d3[$v58b61e02bc]) ? $v1fb4b254d3[$v58b61e02bc] : null; $pf8ed4912 .= self::getTemplateParamHtml($v58b61e02bc, $v72eb975550, $pd6bf10d2); $v0db218b458[$v58b61e02bc] = true; } } } } $pf8ed4912 .= '</div>
			...
			<select onChange="onChangeRegionBlockParamType(this)">
				...
				<option' . (strpos($v67db1bd535, "\n") === false && (substr($v67db1bd535, 0, 1) == '$' || substr($v67db1bd535, 0, 2) == '@$') && strpos($v67db1bd535, "->") === false ? ' selected' : '') . '>variable</option>
			</select>
			...
			<select onchange="onChangeIncludeType(this)">
				...
				<option' . ((substr($v154d33eec4, 0, 1) == '$' || substr($v154d33eec4, 0, 2) == '@$') && strpos($v154d33eec4, "->") === false ? ' selected' : '') . '>variable</option>
			</select>
			...
			<select onChange="onChangeTemplateParamType(this)"' . ($v89d55da87e ? " disabled" : "") . '>
				...
				<option' . ($peb283674 ? ' selected' : '') . '>text</option>
				<option' . (!$peb283674 && (substr($v67db1bd535, 0, 1) == '$' || substr($v67db1bd535, 0, 2) == '@$') && strpos($v67db1bd535, "->") === false ? ' selected' : '') . '>variable</option>
