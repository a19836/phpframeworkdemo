...
<script type="text/javascript" src="' . $this->v00161f0c07 . 'vendor/jqueryuitouchpunch/jquery.ui.touch-punch.min.js"></script>'; if (!$v5d3813882f["taskflowchart_already_included"]) { if ($this->pf3d7391b["jsplumb"]) $v0a9dad1fe0 .= '
...
'; if ($v5d3813882f["ui_editor"] || $this->pecad7cca->getTasksByPrefix("createform", 1) || $this->pecad7cca->getTasksByPrefix("inlinehtml", 1)) $v0a9dad1fe0 .= '
...
'; return $v6e611b5051; } public function printTasksList() { $pf8ed4912 = '<ul class="tasks_groups">'; $v20fbb86a18 = array(); foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { $v1b1c6a10a2 = $v003bc751fd["tag"]; if ($v1b1c6a10a2) $v20fbb86a18[$v1b1c6a10a2] = array($pc8421459, $v003bc751fd); } $pc3b3502c = array(); if (is_array($this->v521be90a09)) { foreach ($this->v521be90a09 as $pfc00b2ed => $v8a9674a7c9) { if ($v8a9674a7c9) { $v26c1ea2796 = ""; $pc37695cb = count($this->v4c6473be39); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v1b1c6a10a2 = $this->v4c6473be39[$v43dd7d0051]; if (in_array($v1b1c6a10a2, $v8a9674a7c9)) { $v7f5911d32d = $v20fbb86a18[$v1b1c6a10a2]; $pc8421459 = $v7f5911d32d[0]; $v003bc751fd = $v7f5911d32d[1]; if ($pc8421459 && $v003bc751fd) { $pc3b3502c[] = $pc8421459; $v26c1ea2796 .= $this->mff0e0fe7a0dd($pc8421459, $v003bc751fd); } } } $pc37695cb = count($v8a9674a7c9); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v1b1c6a10a2 = $v8a9674a7c9[$v43dd7d0051]; $v7f5911d32d = $v20fbb86a18[$v1b1c6a10a2]; $pc8421459 = $v7f5911d32d[0]; $v003bc751fd = $v7f5911d32d[1]; if ($pc8421459 && $v003bc751fd && !in_array($pc8421459, $pc3b3502c)) { $pc3b3502c[] = $pc8421459; $v26c1ea2796 .= $this->mff0e0fe7a0dd($pc8421459, $v003bc751fd); } } if ($v26c1ea2796) { $v3bfa9d9b8f = "tasks_group_" . str_replace(array(" ", "-"), "_", strtolower($pfc00b2ed)); $pf8ed4912 .= '<li class="tasks_group ' . $v3bfa9d9b8f . '">'; $pf8ed4912 .= '<div class="tasks_group_label">' . $pfc00b2ed . '</div>'; $pf8ed4912 .= '<div class="tasks_group_tasks">'; $pf8ed4912 .= $v26c1ea2796; $pf8ed4912 .= '</div>
