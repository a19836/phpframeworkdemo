...
<script type="text/javascript" src="' . $this->v00161f0c07 . 'vendor/jqueryuitouchpunch/jquery.ui.touch-punch.min.js"></script>'; if (empty($v5d3813882f["taskflowchart_already_included"])) { if (!empty($this->pf3d7391b["jsplumb"])) $v0a9dad1fe0 .= '
<!-- Add JSPlumb main JS and CSS files -->
<script language="javascript" type="text/javascript" src="' . $this->pf3d7391b["jsplumb"] . 'build/1.3.16/js/jquery.jsPlumb-1.3.16-all-min.js"></script>
'; $v0a9dad1fe0 .= '
<!-- Add LeaderLine main JS and CSS files -->
<link rel="stylesheet" href="' . $this->pf3d7391b["taskflowchart"] . 'lib/leaderline/leader-line.css" type="text/css" charset="utf-8" />
<script language="javascript" type="text/javascript" src="' . $this->pf3d7391b["taskflowchart"] . 'lib/leaderline/leader-line.js"></script>
<script language="javascript" type="text/javascript" src="' . $this->pf3d7391b["taskflowchart"] . 'lib/leaderline/LeaderLineFlowHandler.js"></script>

<!-- Add TaskFlowChart main JS and CSS files -->
<link rel="stylesheet" href="' . $this->pf3d7391b["taskflowchart"] . 'css/style.css" type="text/css" charset="utf-8" />
<link rel="stylesheet" href="' . $this->pf3d7391b["taskflowchart"] . 'css/print.css" type="text/css" charset="utf-8" media="print" />
<script type="text/javascript" src="' . $this->pf3d7391b["taskflowchart"] . 'js/ExternalLibHandler.js"></script>
<script type="text/javascript" src="' . $this->pf3d7391b["taskflowchart"] . 'js/TaskFlowChart.js"></script>
...
<script language="javascript" type="text/javascript" src="' . $this->v00161f0c07 . 'vendor/jquerymycontextmenu/js/jquery.mycontextmenu.js"></script>
...
'; } if (empty($v5d3813882f["icons_and_edit_code_already_included"])) $v0a9dad1fe0 .= '
...
'; if (!empty($v5d3813882f["ui_editor"]) || $this->pecad7cca->getTasksByPrefix("createform", 1) || $this->pecad7cca->getTasksByPrefix("inlinehtml", 1)) $v0a9dad1fe0 .= '
<!-- Layout UI Editor - Color -->
<script language="javascript" type="text/javascript" src="' . $this->v00161f0c07 . 'js/color.js"></script>
...
<link rel="stylesheet" href="' . $this->pcd2aca48 . 'lib/jquerylayoutuieditor/lib/materialdesigniconicfont/css/material-design-iconic-font.min.css">

<!-- Layout UI Editor - JQuery Nestable2 -->
<link rel="stylesheet" href="' . $this->pcd2aca48 . 'lib/jquerylayoutuieditor/lib/nestable2/jquery.nestable.min.css" type="text/css" charset="utf-8" />
<script language="javascript" type="text/javascript" src="' . $this->pcd2aca48 . 'lib/jquerylayoutuieditor/lib/nestable2/jquery.nestable.min.js"></script>

<!-- Layout UI Editor - HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
<!--[if lt IE 9]>
	 <script src="' . $this->pcd2aca48 . 'lib/jquerylayoutuieditor/lib/jqueryuidroppableiframe/js/html5_ie8/html5shiv.min.js"></script>
	 <script src="' . $this->pcd2aca48 . 'lib/jquerylayoutuieditor/lib/jqueryuidroppableiframe/js/html5_ie8/respond.min.js"></script>
<![endif]-->

<!-- Layout UI Editor - Add Iframe droppable fix -->
<script type="text/javascript" src="' . $this->pcd2aca48 . 'lib/jquerylayoutuieditor/lib/jqueryuidroppableiframe/js/jquery-ui-droppable-iframe-fix.js"></script>    

<!-- Layout UI Editor - Add Iframe droppable fix - IE10 viewport hack for Surface/desktop Windows 8 bug -->
<script src="' . $this->pcd2aca48 . 'lib/jquerylayoutuieditor/lib/jqueryuidroppableiframe/js/ie10-viewport-bug-workaround.js"></script>
...
<script language="javascript" type="text/javascript" src="' . $this->pcd2aca48 . 'js/layout_ui_editor_widget_resource_options.js"></script>
'; else if (!empty($v5d3813882f["tasks_css_and_js"])) $v0a9dad1fe0 .= '
<!-- Add MD5 JS File -->
<script language="javascript" type="text/javascript" src="' . $this->v00161f0c07 . 'vendor/jquery/js/jquery.md5.js"></script>
'; if (!empty($v5d3813882f["tasks_css_and_js"])) $v0a9dad1fe0 .= "\n<!-- Add TASKS JS and CSS files -->\n" . $this->printTasksCSSAndJS(); return $v0a9dad1fe0; } public function getJS($v23b252dead = false, $v10d8a653cc = false, $pd05429f9 = null) { $v10d8a653cc = empty($v10d8a653cc) ? $v23b252dead : $v10d8a653cc; $v0a9dad1fe0 = '
<script>
...
'; if ($v23b252dead) $v0a9dad1fe0 .= 'taskFlowChartObj.TaskFile.get_tasks_file_url = "' . $this->pcd2aca48 . 'workflow/get_workflow_file?path=' . $v23b252dead . '";'; if ($v10d8a653cc) $v0a9dad1fe0 .= 'taskFlowChartObj.TaskFile.set_tasks_file_url = "' . $this->pcd2aca48 . 'workflow/set_workflow_file?path=' . $v10d8a653cc . '";'; if ($pd05429f9) foreach ($pd05429f9 as $pe5c5e2fe => $v956913c90f) $v0a9dad1fe0 .= '
		...
		taskFlowChartObj.Container.tasks_containers = ' . $this->f94ef746929() . ';
...
'; return $v6e611b5051; } public function printTasksList() { $pf8ed4912 = '<ul class="tasks_groups">'; $v20fbb86a18 = array(); foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { $v1b1c6a10a2 = isset($v003bc751fd["tag"]) ? $v003bc751fd["tag"] : null; if ($v1b1c6a10a2) $v20fbb86a18[$v1b1c6a10a2] = array($pc8421459, $v003bc751fd); } $pc3b3502c = array(); if (is_array($this->v521be90a09)) { foreach ($this->v521be90a09 as $pfc00b2ed => $v8a9674a7c9) { if ($v8a9674a7c9) { $v26c1ea2796 = ""; $pc37695cb = count($this->v4c6473be39); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v1b1c6a10a2 = $this->v4c6473be39[$v43dd7d0051]; if (in_array($v1b1c6a10a2, $v8a9674a7c9)) { $v7f5911d32d = isset($v20fbb86a18[$v1b1c6a10a2]) ? $v20fbb86a18[$v1b1c6a10a2] : null; $pc8421459 = isset($v7f5911d32d[0]) ? $v7f5911d32d[0] : null; $v003bc751fd = isset($v7f5911d32d[1]) ? $v7f5911d32d[1] : null; if ($pc8421459 && $v003bc751fd) { $pc3b3502c[] = $pc8421459; $v26c1ea2796 .= $this->mff0e0fe7a0dd($pc8421459, $v003bc751fd); } } } $pc37695cb = count($v8a9674a7c9); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v1b1c6a10a2 = $v8a9674a7c9[$v43dd7d0051]; $v7f5911d32d = isset($v20fbb86a18[$v1b1c6a10a2]) ? $v20fbb86a18[$v1b1c6a10a2] : null; $pc8421459 = isset($v7f5911d32d[0]) ? $v7f5911d32d[0] : null; $v003bc751fd = isset($v7f5911d32d[1]) ? $v7f5911d32d[1] : null; if ($pc8421459 && $v003bc751fd && !in_array($pc8421459, $pc3b3502c)) { $pc3b3502c[] = $pc8421459; $v26c1ea2796 .= $this->mff0e0fe7a0dd($pc8421459, $v003bc751fd); } } if ($v26c1ea2796) { $v3bfa9d9b8f = "tasks_group_" . str_replace(array(" ", "-"), "_", strtolower($pfc00b2ed)); $pf8ed4912 .= '<li class="tasks_group ' . $v3bfa9d9b8f . '">'; $pf8ed4912 .= '<div class="tasks_group_label">' . $pfc00b2ed . '</div>'; $pf8ed4912 .= '<div class="tasks_group_tasks">'; $pf8ed4912 .= $v26c1ea2796; $pf8ed4912 .= '</div>
							<div style="clear:left; float:none;"></div>
						</li>'; } } } } $v3a29af29e1 = count($pc3b3502c) > 0; $pd04a32f6 = ""; foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { if ($pcbf3c2f0) { $pc37695cb = count($this->v4c6473be39); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v1b1c6a10a2 = $this->v4c6473be39[$v43dd7d0051]; $v7f5911d32d = isset($v20fbb86a18[$v1b1c6a10a2]) ? $v20fbb86a18[$v1b1c6a10a2] : null; $pc8421459 = isset($v7f5911d32d[0]) ? $v7f5911d32d[0] : null; if (!empty($pcbf3c2f0[$pc8421459]) && !in_array($pc8421459, $pc3b3502c)) { $pc3b3502c[] = $pc8421459; $pd04a32f6 .= $this->mff0e0fe7a0dd($pc8421459, isset($pcbf3c2f0[$pc8421459]) ? $pcbf3c2f0[$pc8421459] : null); } } foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) if (!in_array($pc8421459, $pc3b3502c)) $pd04a32f6 .= $this->mff0e0fe7a0dd($pc8421459, $v003bc751fd); } } if ($pd04a32f6) { $pf8ed4912 .= '<li class="tasks_group tasks_group_others">'; $pf8ed4912 .= $v3a29af29e1 ? '<div class="tasks_group_label">Others</div>' : ''; $pf8ed4912 .= '<div class="tasks_group_tasks">' . $pd04a32f6 . '</div>
				<div style="clear:left; float:none;"></div>
			</li>'; } $pf8ed4912 .= '</ul>'; return $pf8ed4912; } private function mff0e0fe7a0dd($pc8421459, $v003bc751fd) { $pfbb6ee46 = isset($v003bc751fd["tag"]) ? str_replace(" ", "_", $v003bc751fd["tag"]) : ""; $v89cfc6ba9c = isset($v003bc751fd["label"]) ? $v003bc751fd["label"] : null; return '<div class="task task_menu task_' . $pc8421459 . ' task_' . $pfbb6ee46 . '" type="' . $pc8421459 . '" tag="' . $pfbb6ee46 . '" title="' . str_replace('"', "&quot;", $v89cfc6ba9c) . '"><span>' . $v89cfc6ba9c . '</span></div>'; } public function printTasksProperties() { $pf8ed4912 = ""; if (!empty($this->v4c6473be39)) { $v524bbc0f84 = $this->v524bbc0f84; $pc37695cb = count($this->v4c6473be39); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) { $v1b1c6a10a2 = $this->v4c6473be39[$v43dd7d0051]; foreach ($v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { $pfbb6ee46 = isset($v003bc751fd["tag"]) ? $v003bc751fd["tag"] : null; if ($pfbb6ee46 == $v1b1c6a10a2) { if (!empty($v003bc751fd["task_properties_html"])) { $pf8ed4912 .= '<div class="task_properties task_properties_' . $pc8421459 . '">' . (is_array($v003bc751fd) ? $v003bc751fd["task_properties_html"] : $v003bc751fd) . '</div>'; } unset($v524bbc0f84[$v93feab0020][$pc8421459]); break; } } } } foreach ($v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { if (!empty($v003bc751fd["task_properties_html"])) { $pf8ed4912 .= '<div class="task_properties task_properties_' . $pc8421459 . '">' . (is_array($v003bc751fd) ? $v003bc751fd["task_properties_html"] : $v003bc751fd) . '</div>'; } } } } else { foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { if (!empty($v003bc751fd["task_properties_html"])) { $pf8ed4912 .= '<div class="task_properties task_properties_' . $pc8421459 . '">' . (is_array($v003bc751fd) ? $v003bc751fd["task_properties_html"] : $v003bc751fd) . '</div>'; } } } } return $pf8ed4912; } public function printConnectionsProperties() { $pf8ed4912 = ""; foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { if (!empty($v003bc751fd["connection_properties_html"])) { $pf8ed4912 .= '<div class="connection_properties connection_properties_' . $pc8421459 . '">' . (is_array($v003bc751fd) ? $v003bc751fd["connection_properties_html"] : $v003bc751fd) . '</div>'; } } } return $pf8ed4912; } public function printTasksCSSAndJS() { $pa0ca8d24 = $v7c2b1a70d1 = array(); foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) if (is_array($v003bc751fd)) { if (!empty($v003bc751fd["files"]["css"])) $pa0ca8d24 = array_merge($pa0ca8d24, $v003bc751fd["files"]["css"]); if (!empty($v003bc751fd["files"]["js"])) $v7c2b1a70d1 = array_merge($v7c2b1a70d1, $v003bc751fd["files"]["js"]); } $v136b6e03de = $this->v4bf8d90f04 ? $this->v4bf8d90f04 . "/" . WorkFlowTaskHandler::TASKS_WEBROOT_FOLDER_PREFIX . "files/" : null; $pd7e7a3e7 = $this->pfce4d1b3 ? $this->pfce4d1b3 . "/" . WorkFlowTaskHandler::TASKS_WEBROOT_FOLDER_PREFIX . "files/" : null; $v85acbf71cb = new CssAndJSFilesOptimizer($v136b6e03de, $pd7e7a3e7); $pf8ed4912 = $v85acbf71cb->getCssAndJSFilesHtml($pa0ca8d24, $v7c2b1a70d1); $pd51fd21c = $pc3e896c2 = ""; foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { if (is_array($v003bc751fd)) { if (isset($v003bc751fd["css"]) && trim($v003bc751fd["css"])) $pd51fd21c .= $v003bc751fd["css"] . "\n"; if (isset($v003bc751fd["js_code"]) && trim($v003bc751fd["settings"]["js_code"])) $pc3e896c2 .= $v003bc751fd["settings"]["js_code"] . "\n"; } } } if (trim($pd51fd21c)) $pf8ed4912 .= '<style type="text/css">' . $pd51fd21c . '</style>' . "\n"; if (trim($pc3e896c2)) $pf8ed4912 .= '<script language="javascript" type="text/javascript">' . $pc3e896c2 . '</script>' . "\n"; return $pf8ed4912; } private function f925abac613() { $pf8ed4912 = ""; if (is_array($this->v85ea3272a0)) foreach ($this->v85ea3272a0 as $v0a9aceebca => $v3692be40aa) $pf8ed4912 .= '<div class="task_container" id="' . $v0a9aceebca . '"></div>'; return $pf8ed4912; } private function f94ef746929() { $v57316767de = array(); foreach ($this->v85ea3272a0 as $v0a9aceebca => $v189716ac66) if ($v189716ac66) { $pc37695cb = count($v189716ac66); for ($v43dd7d0051 = 0; $v43dd7d0051 < $pc37695cb; $v43dd7d0051++) $v57316767de[ $v189716ac66[$v43dd7d0051] ][] = $v0a9aceebca; } return json_encode($v57316767de); } public function getTasksSettingsObj() { $pf8ed4912 = "{"; foreach ($this->v524bbc0f84 as $v93feab0020 => $pcbf3c2f0) { foreach ($pcbf3c2f0 as $pc8421459 => $v003bc751fd) { if (is_array($v003bc751fd)) { if (isset($v003bc751fd["settings"]) && is_array($v003bc751fd["settings"])) { $pf8ed4912 .= ($pf8ed4912 != "{" ? ", " : "") . '"' . $pc8421459 . '" : {'; $pd69fb7d0 = 0; foreach ($v003bc751fd["settings"] as $pbfa01ed1 => $v67db1bd535) { if (is_array($v67db1bd535)) { $pa456327a = "{"; foreach ($v67db1bd535 as $v2300608a66 => $v08d1f6acf0) { if (strlen(trim($v08d1f6acf0)) > 0) { $pa456327a .= ($pa456327a != "{" ? ", " : "") . '"' . strtolower($v2300608a66) . '" : ' . $v08d1f6acf0; } } $pa456327a .= "}"; $v67db1bd535 = $pa456327a; } if (strlen(trim($v67db1bd535)) > 0) { $pf8ed4912 .= ($pd69fb7d0 > 0 ? ", " : "") . '"' . strtolower($pbfa01ed1) . '" : ' . $v67db1bd535; $pd69fb7d0++; } } $pf8ed4912 .= '}'; } } } } $pf8ed4912 .= "}"; return $pf8ed4912; } } ?>
