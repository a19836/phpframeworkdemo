...
<div id="content">
	...
	<table>
		...
		</tr>'; $t = count($user_user_types); for ($i = 0; $i < $t; $i++) { $user_user_type = $user_user_types[$i]; $uut_user_id = isset($user_user_type["user_id"]) ? $user_user_type["user_id"] : null; $uut_user_type_id = isset($user_user_type["user_type_id"]) ? $user_user_type["user_type_id"] : null; $main_content .= '
	<tr>
