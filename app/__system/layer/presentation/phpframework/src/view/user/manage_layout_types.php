...
<div id="content">
	...
	<table>
		...
		</tr>'; $t = count($layout_types); for ($i = 0; $i < $t; $i++) { $layout_type = $layout_types[$i]; $layout_type_id = isset($layout_type["layout_type_id"]) ? $layout_type["layout_type_id"] : null; $av_type_id = isset($layout_type["type_id"]) ? $layout_type["type_id"] : null; $type = isset($available_types[$av_type_id]) ? $available_types[$av_type_id] : null; $main_content .= '<tr>
