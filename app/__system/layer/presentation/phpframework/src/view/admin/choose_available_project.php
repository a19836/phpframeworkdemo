...
</div>'; $main_content .= VideoTutorialHandler::getFeaturedTutorialsSectionHtml($filtered_tutorials, $online_tutorials_url_prefix); $main_content .= TourGuideUIHandler::getHtml($entity, $project_url_prefix, $project_common_url_prefix, $online_tutorials_url_prefix); ?>
