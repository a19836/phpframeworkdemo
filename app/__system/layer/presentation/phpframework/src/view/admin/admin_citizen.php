 ...
 */
 include $EVC->getViewPath("admin/admin_simple"); $db_driver_layer_folder_name = isset($db_driver_layer_folder_name) ? $db_driver_layer_folder_name : null; $db_driver_bean_name = isset($db_driver_bean_name) ? $db_driver_bean_name : null; $db_driver_bean_file_name = isset($db_driver_bean_file_name) ? $db_driver_bean_file_name : null; $db_driver_layer_bean_file_name = isset($db_driver_layer_bean_file_name) ? $db_driver_layer_bean_file_name : null; $db_driver_layer_bean_name = isset($db_driver_layer_bean_name) ? $db_driver_layer_bean_name : null; $db_driver_broker_name = isset($db_driver_broker_name) ? $db_driver_broker_name : null; $head .= '
			...
			<ul>
				...
				<li class="scroll">
					<ul>
						...
						</li>'; if ($filter_by_layout && !empty($presentation_projects_by_layer_label[$layer_label][$filter_by_layout])) $selected_project_name = $presentation_projects_by_layer_label[$layer_label][$filter_by_layout]; } foreach ($non_projects_layout_types as $lname => $lid) $main_content .= '<li class="project' . ($filter_by_layout == $lname ? ' selected' : '') . '">
...
</div>'; $main_content .= TourGuideUIHandler::getHtml($entity, $project_url_prefix, $project_common_url_prefix, $online_tutorials_url_prefix, array("restart_allow" => false)); ?>
