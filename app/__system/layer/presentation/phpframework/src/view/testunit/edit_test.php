...
<script>
' . WorkFlowBrokersSelectedDBVarsHandler::printSelectedDBVarsJavascriptCode($project_url_prefix, "#bean_name#", "#bean_file_name#", array( "dal_broker" => "all", "db_brokers_drivers" => array( "all" => $db_drivers_options ) )) . '
