...
<div class="modules_list">
	<table>
		...
		</tr>'; if (!empty($loaded_modules)) foreach ($loaded_modules as $group_module_id => $loaded_modules_by_group) { $main_content .= '<tr>
