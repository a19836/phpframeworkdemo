...
<script>
function onSuccessTableGeneration() {'; if ($on_success_js_func) $head .= "
	if (typeof window.parent.$on_success_js_func == 'function')
		window.parent.$on_success_js_func();"; else $head .= "
	if (typeof window.parent.refreshLastNodeParentChilds == 'function' && window.parent.last_selected_node_id && window.parent.$('#' + window.parent.last_selected_node_id + ' > a > i.table').length > 0)
		...
		window.parent.refreshAndShowLastNodeChilds();"; $head .= "
}
</script>"; $main_content = '<div class="generate_table_with_ai">
	<div class="top_bar">
		<header>
			<div class="title">
