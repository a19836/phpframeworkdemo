...
;(function() {
	...
	*/
	...
	//console.log("I SHOULD NOT BE USING THIS FUNCTION BECAUSE HAS A BUG. PLEASE USE THE _getOffset FROM THE task_flow_chart.js file, instead of ../jqueryjsplumb/build/1.3.16/demo/js/jquery.jsplumb-1.3.16-all.js");console.log(el);console.log(o);
			if (_instance != null) {
	...
	*/
	...
	var AbstractSvgArrowOverlay = function(superclass, originalArgs) {
    	...
    	var makePath = function(d) {
    		if (!d.hxy.x || !d.hxy.y) //Added by JP: 2018-02-03. I added this line bc sometimes Chrome gives the error 'Error: <path> attribute d: Expected number, "MNaN,NaN LNaN,NaN…".' in  jquery.jsPlumb-1.3.16-all-min.js:1 or jquery.jsPlumb-1.3.16-all.js:9149.
    			return "";
