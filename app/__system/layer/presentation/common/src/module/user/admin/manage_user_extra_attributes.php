...
if (!empty($PEVC)) {
	...
	$CommonModuleAdminTableExtraAttributesUtil = new CommonModuleAdminTableExtraAttributesUtil($EVC, $PEVC, $UserAuthenticationHandler, $module_path, isset($GLOBALS["default_db_driver"]) ? $GLOBALS["default_db_driver"] : null, "mu_user", "user");
