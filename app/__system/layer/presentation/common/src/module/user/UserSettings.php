...
class UserSettings extends CommonSettings {
	...
	const USER_SESSION_COOKIES_EXTRA_FLAGS = array("SameSite" => "Strict", "httponly" => true);//SameSite=Strict or SameSite=Lax or SameSite=None. SameSite=None is not advisable, because of CSRF attacks. Please read https://web.dev/samesite-cookies-explained/
	...
	const USER_SESSION_AUTHENTICATION_RESTRICTED_TO_SAME_REFERER_HOST = true; //important to be true bc of CSRF attacks
