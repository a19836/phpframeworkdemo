...
if ($PEVC) {
	...
	$CommonModuleAdminTableExtraAttributesUtil = new CommonModuleAdminTableExtraAttributesUtil($EVC, $PEVC, $UserAuthenticationHandler, $module_path, $GLOBALS["default_db_driver"], "me_event", "event");
