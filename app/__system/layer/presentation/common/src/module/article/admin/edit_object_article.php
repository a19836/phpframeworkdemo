...
if (!empty($PEVC)) {
	...
	$object_type_id = isset($_GET["object_type_id"]) ? $_GET["article_id"] : null;
	$object_id = isset($_GET["object_id"]) ? $_GET["article_id"] : null;
	...
	//Preparing HTML
	$form_settings = array(
		"title" => $data || (!empty($_POST["delete"]) && empty($error_message)) ? "Edit Object Article" : "Add Object Article",
		"fields" => array(
