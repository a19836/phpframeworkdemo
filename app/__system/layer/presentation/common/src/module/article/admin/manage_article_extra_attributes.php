...
if ($PEVC) {
	...
	$CommonModuleAdminTableExtraAttributesUtil = new CommonModuleAdminTableExtraAttributesUtil($EVC, $PEVC, $module_path, $user_global_variables_file_path, $user_beans_folder_path, $GLOBALS["default_db_driver"], "ma_article", "article");
