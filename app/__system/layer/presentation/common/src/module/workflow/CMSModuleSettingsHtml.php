...
if ($PEVC) {
	...
	//must have the layout after this, bc the getHeader method loads the lib/jquerytaskflowchart/css/style.css which will overwrite the previous loaded layout.css styles. So we must re-add it here again.
	$head .= '
<!-- Layout CSS file -->
