...
if (!empty($PEVC)) {
	...
	if (!empty($_POST)) {
		...
		$properties = array(
			"RUNNING_PROCESSES_MAXIMUM_NUMBER" => isset($_POST["RUNNING_PROCESSES_MAXIMUM_NUMBER"]) && is_numeric($_POST["RUNNING_PROCESSES_MAXIMUM_NUMBER"]) ? $_POST["RUNNING_PROCESSES_MAXIMUM_NUMBER"] : 0,
			"PROCESS_MAXIMUM_EXECUTION_TIME" => isset($_POST["PROCESS_MAXIMUM_EXECUTION_TIME"]) && is_numeric($_POST["PROCESS_MAXIMUM_EXECUTION_TIME"]) ? $_POST["PROCESS_MAXIMUM_EXECUTION_TIME"] : 0,
			"PROCESS_MAXIMUM_EXPIRATION_EXECUTION_TIME" => isset($_POST["PROCESS_MAXIMUM_EXPIRATION_EXECUTION_TIME"]) && is_numeric($_POST["PROCESS_MAXIMUM_EXPIRATION_EXECUTION_TIME"]) ? $_POST["PROCESS_MAXIMUM_EXPIRATION_EXECUTION_TIME"] : 0,
			"WORKERS_MAXIMUM_NUMBER_PER_PROCESS" => isset($_POST["WORKERS_MAXIMUM_NUMBER_PER_PROCESS"]) && is_numeric($_POST["WORKERS_MAXIMUM_NUMBER_PER_PROCESS"]) ? $_POST["WORKERS_MAXIMUM_NUMBER_PER_PROCESS"] : 0,
			"WORKER_FAILED_ATTEMPTS_MAXIMUM_NUMBER" => isset($_POST["WORKER_FAILED_ATTEMPTS_MAXIMUM_NUMBER"]) && is_numeric($_POST["WORKER_FAILED_ATTEMPTS_MAXIMUM_NUMBER"]) ? $_POST["WORKER_FAILED_ATTEMPTS_MAXIMUM_NUMBER"] : 0,
			"WORKER_MAXIMUM_EXPIRATION_EXECUTION_TIME" => isset($_POST["WORKER_MAXIMUM_EXPIRATION_EXECUTION_TIME"]) && is_numeric($_POST["WORKER_MAXIMUM_EXPIRATION_EXECUTION_TIME"]) ? $_POST["WORKER_MAXIMUM_EXPIRATION_EXECUTION_TIME"] : 0,
		);
