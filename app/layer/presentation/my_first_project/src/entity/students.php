...
$EVC->getCMSLayer()->getCMSSequentialLogicalActivityLayer()->addSequentialLogicalActivities(array(
	array(
		"result_var_name" => "students_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"students\"",
		"action_description" => "Get records from table: student.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "students",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
					"action_value" => array(
						"method_obj" => "StudentResourceUtil",
						"method_name" => "getAll",
						"method_static" => 1,
						"method_args" => array(
							$EVC,
						...
						"include_file_path" => $EVC->getUtilPath("resource/StudentResourceUtil"),
						"include_once" => 1
					)
				)
			)
	...
	array(
		"result_var_name" => "delete_all_students_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"delete_all_students\" && \$_POST",
		"action_description" => "Delete multiple records at once from table: student.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "delete_all_students",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "delete_all_students_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "delete_all_students",
					"action_description" => "",
					"action_value" => 1
				)
			)
	...
	array(
		"result_var_name" => "count_students_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"count_students\"",
		"action_description" => "Count records from table: student.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "count_students",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
	...
	array(
		"result_var_name" => "delete_student_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"delete_student\" && \$_POST",
		"action_description" => "Delete record from table: student.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "delete_student",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "delete_student_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "delete_student",
					"action_description" => "",
					"action_value" => 1
				)
			)
	...
	array(
		"result_var_name" => "insert_student_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"insert_student\" && \$_POST",
		"action_description" => "Insert data into table: student.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "insert_student",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "insert_student_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "insert_student",
					"action_description" => "",
					"action_value" => 1
				)
			)
	...
	array(
		"result_var_name" => "student_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"student\"",
		"action_description" => "Get a record from table: student.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "student",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
	...
	array(
		"result_var_name" => "update_student_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"update_student\" && \$_POST",
		"action_description" => "Update data into table: student.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "update_student",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "update_student_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "update_student",
					"action_description" => "",
					"action_value" => 1
				)
			)
...
$EVC->getCMSLayer()->getCMSTemplateLayer()->addRegionHtml("Content", "<div class=\"text-right text-end\" data-widget-group-list data-widget-props=\"{&quot;db_broker&quot;:&quot;&quot;,&quot;db_driver&quot;:&quot;mysql&quot;,&quot;db_type&quot;:&quot;diagram&quot;,&quot;db_table&quot;:&quot;student&quot;,&quot;db_table_alias&quot;:&quot;&quot;}\">
	...
	<div class=\"card mb-3 text-left text-start\" id=\"widget_list_1\" data-widget-list data-widget-props=\"{&quot;items_limit_per_page&quot;:50,&quot;pks_attrs_names&quot;:&quot;student_id&quot;,&quot;load&quot;:&quot;MyWidgetResourceLib.ListHandler.loadListTableAndTreeResource&quot;,&quot;dependent_widgets_id&quot;:&quot;widget_list_caption_1&quot;,&quot;complete&quot;:{&quot;remove&quot;:&quot;MyWidgetResourceLib.ListHandler.onRemoveResourceItem&quot;}}\" data-widget-resources=\"{&quot;load&quot;:[{&quot;name&quot;:&quot;students&quot;}],&quot;remove&quot;:[{&quot;error_message&quot;:&quot;Error trying to remove. Please try again...&quot;,&quot;success_message&quot;:&quot;Removed successfully!&quot;,&quot;confirmation_message&quot;:&quot;Are you sure you want to continue?&quot;,&quot;name&quot;:&quot;delete_student&quot;}]}\" data-widget-resources-load=\"\">
		<div class=\"card-body\">
					...
					<tbody>
						<tr data-widget-item>
							...
							<td class=\"border-0 align-middle\" data-widget-item-column data-widget-item-attribute-name=\"student_id\">
								<span class=\"form-control-plaintext\" data-widget-item-attribute-field-view data-widget-resource-value=\"{&quot;attribute&quot;:&quot;student_id&quot;}\"></span>
							</td>
							...
							<td class=\"border-0 text-right text-end align-middle\" data-widget-item-actions-column>
								<div class=\"btn-group justify-content-center align-items-center\">
									...
									<button class=\"btn btn-sm btn-danger text-nowrap\" data-widget-item-button-remove onclick=\"MyWidgetResourceLib.ItemHandler.removeResourceItem(this); return false;\" title=\"Remove\">
										<i class=\"bi bi-trash icon icon-remove mr-1 me-1 overflow-visible\"></i>Remove</button>
									<a class=\"btn btn-sm btn-outline-secondary text-nowrap\" data-widget-item-button-edit href=\"{$project_url_prefix}schools?search_attrs[school_id]=#idx[school_id]#\" onclick>
										<i class=\"template_widget_html-tag_m9bxw_332 bi bi-card-list icon icon-edit mr-1 me-1 overflow-visible\"></i>Schools</a>
								</div>
							</td>
						</tr>
						...
						<tr data-widget-list-empty>
							<td class=\"border-0 text-center text-muted small p-3\" colspan=\"5\">There are no records available.<div data-widget-list-empty-add=\"\">Please click in the button below to add new records:<br/>
									<br/>
									<button class=\"btn btn-sm btn-success text-nowrap m-1\" onclick=\"MyWidgetResourceLib.PopupHandler.openButtonAddPopup(this); return false;\" data-widget-button-add data-widget-popup-id=\"widget_popup_add_1\" title=\"Add\">
										<i class=\"bi bi-plus-lg icon icon-add mr-1 me-1 overflow-visible\"></i>Add new Record</button>
								</div>
			...
			<div class=\"text-muted small mt-3\" id=\"widget_list_caption_1\" data-widget-list-caption data-widget-props=\"{&quot;load&quot;:&quot;MyWidgetResourceLib.ListHandler.loadListCaptionResource&quot;}\" data-widget-resources=\"{&quot;load&quot;:&quot;count_students&quot;}\"></div>
		</div></div>
	<div class=\"btn-toolbar justify-content-between text-left text-start mb-3\" id=\"widget_bottom_pagination_1_1\" data-widget-pagination data-widget-props=\"{&quot;number_of_pages_to_show_at_once&quot;:10,&quot;load&quot;:&quot;MyWidgetResourceLib.PaginationHandler.loadPaginationResource&quot;,&quot;dependent_widgets_id&quot;:[&quot;widget_list_1&quot;]}\" data-widget-resources=\"count_students\" data-widget-resources-load=\"\">
	...
	<div class=\"modal fade text-left text-start\" id=\"widget_popup_edit_1\" data-widget-popup data-widget-popup-edit tabindex=\"-1\" role=\"dialog\" data-widget-props=\"{&quot;dependent_widgets_id&quot;:&quot;widget_popup_edit_form_1&quot;,&quot;load&quot;:&quot;MyWidgetResourceLib.PopupHandler.loadPopupResource&quot;}\" style=\"background-color:rgba(0, 0, 0, .5);\">
		<div class=\"modal-dialog\">
			<div class=\"modal-content\">
				<div class=\"modal-header\">
					<h5 class=\"modal-title text-muted\">Edit Student</h5>
					<button class=\"btn-close\" data-dismiss=\"modal\" data-bs-dismiss=\"modal\" aria-label=\"Close\" title=\"Close Popup\"></button>
				</div>
				<div class=\"modal-body\">
					<form id=\"widget_popup_edit_form_1\" method=\"post\" onsubmit=\"return false;\" data-widget-form data-widget-resources=\"{&quot;load&quot;:[{&quot;error_message&quot;:&quot;No record available...&quot;,&quot;name&quot;:&quot;student&quot;}],&quot;update&quot;:[{&quot;error_message&quot;:&quot;Error trying to update. Please try again...&quot;,&quot;success_message&quot;:&quot;Updated successfully!&quot;,&quot;name&quot;:&quot;update_student&quot;}],&quot;remove&quot;:[{&quot;error_message&quot;:&quot;Error trying to remove. Please try again...&quot;,&quot;success_message&quot;:&quot;Removed successfully!&quot;,&quot;confirmation_message&quot;:&quot;Are you sure you want to continue?&quot;,&quot;name&quot;:&quot;delete_student&quot;}]}\" data-widget-props=\"{&quot;pks_attrs_names&quot;:&quot;student_id&quot;,&quot;dependent_widgets_id&quot;:[&quot;widget_list_1&quot;],&quot;load&quot;:&quot;MyWidgetResourceLib.FormHandler.loadFormResource&quot;,&quot;complete&quot;:{&quot;update&quot;:&quot;MyWidgetResourceLib.FormHandler.onUpdatePopupResourceItem&quot;,&quot;remove&quot;:&quot;MyWidgetResourceLib.FormHandler.onRemovePopupResourceItem&quot;}}\">
						<div class=\"row mb-3\" data-widget-item-column data-widget-item-attribute-name=\"student_id\">
							<label class=\"col-sm-4 col-form-label\" data-widget-item-head>Student Id<span class=\"label-colon\">:</span>
							</label>
							<div class=\"col-sm-8\">
								<span class=\"form-control-plaintext\" data-widget-item-attribute-field-view data-widget-resource-value=\"{&quot;attribute&quot;:&quot;student_id&quot;}\"></span>
							</div></div>
