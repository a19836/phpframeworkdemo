...
$EVC->getCMSLayer()->getCMSSequentialLogicalActivityLayer()->addSequentialLogicalActivities(array(
	...
	array(
		"result_var_name" => "delete_all_schools_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"delete_all_schools\" && \$_POST",
		"action_description" => "Delete multiple records at once from table: school.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "delete_all_schools",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "delete_all_schools_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "delete_all_schools",
					"action_description" => "",
					"action_value" => 1
				)
			)
	...
	array(
		"result_var_name" => "delete_school_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"delete_school\" && \$_POST",
		"action_description" => "Delete record from table: school.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "delete_school",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "delete_school_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "delete_school",
					"action_description" => "",
					"action_value" => 1
				)
			)
	...
	array(
		"result_var_name" => "insert_school_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"insert_school\" && \$_POST",
		"action_description" => "Insert data into table: school.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "insert_school",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "insert_school_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "insert_school",
					"action_description" => "",
					"action_value" => 1
				)
			)
	...
	array(
		"result_var_name" => "update_school_group",
		"action_type" => "group",
		"condition_type" => "execute_if_condition",
		"condition_value" => "\$_GET[\"resource\"] == \"update_school\" && \$_POST",
		"action_description" => "Update data into table: school.",
		"action_value" => array(
			"group_name" => "",
			"actions" => array(
				array(
					"result_var_name" => "update_school",
					"action_type" => "callobjectmethod",
					"condition_type" => "execute_always",
					"condition_value" => "",
					"action_description" => "",
				...
				array(
					"result_var_name" => "update_school_unsuccessfully",
					"action_type" => "string",
					"condition_type" => "execute_if_not_var",
					"condition_value" => "update_school",
					"action_description" => "",
					"action_value" => 1
				)
			)
...
$EVC->getCMSLayer()->getCMSTemplateLayer()->addRegionHtml("Content", "<div class=\"text-right text-end\" data-widget-group-list data-widget-props=\"{&quot;db_broker&quot;:&quot;&quot;,&quot;db_driver&quot;:&quot;mysql&quot;,&quot;db_type&quot;:&quot;diagram&quot;,&quot;db_table&quot;:&quot;school&quot;,&quot;db_table_alias&quot;:&quot;&quot;}\">
	...
	<div class=\"card mb-3 text-left text-start\" id=\"widget_list_1\" data-widget-list data-widget-props=\"{&quot;items_limit_per_page&quot;:50,&quot;pks_attrs_names&quot;:&quot;school_id&quot;,&quot;load&quot;:&quot;MyWidgetResourceLib.ListHandler.loadListTableAndTreeResource&quot;,&quot;dependent_widgets_id&quot;:&quot;widget_list_caption_1&quot;,&quot;complete&quot;:{&quot;remove&quot;:&quot;MyWidgetResourceLib.ListHandler.onRemoveResourceItem&quot;}}\" data-widget-resources=\"{&quot;load&quot;:[{&quot;name&quot;:&quot;schools&quot;}],&quot;remove&quot;:[{&quot;error_message&quot;:&quot;Error trying to remove. Please try again...&quot;,&quot;success_message&quot;:&quot;Removed successfully!&quot;,&quot;confirmation_message&quot;:&quot;Are you sure you want to continue?&quot;,&quot;name&quot;:&quot;delete_school&quot;}]}\" data-widget-resources-load=\"\">
		<div class=\"card-body\">
							...
							<td class=\"border-0 text-right text-end align-middle\" data-widget-item-actions-column>
								<div class=\"btn-group justify-content-center align-items-center\">
									...
									<button class=\"btn btn-sm btn-danger text-nowrap\" data-widget-item-button-remove onclick=\"MyWidgetResourceLib.ItemHandler.removeResourceItem(this); return false;\" title=\"Remove\">
										<i class=\"bi bi-trash icon icon-remove mr-1 me-1 overflow-visible\"></i>Remove</button>
									<a class=\"btn btn-sm btn-outline-secondary text-nowrap\" data-widget-item-button-edit href=\"{$project_url_prefix}teachers?search_attrs[school_id]=#idx[school_id]#\">
										<i class=\"template_widget_html-tag_4n9lg_191 bi bi-card-list icon icon-edit mr-1 me-1 overflow-visible\"></i>Teachers</a>
									<a class=\"btn btn-sm btn-outline-secondary text-nowrap\" data-widget-item-button-edit href=\"{$project_url_prefix}students?search_attrs[school_id]=#idx[school_id]#\">
										<i class=\"template_widget_html-tag_4n9lg_191 bi bi-card-list icon icon-edit mr-1 me-1 overflow-visible\"></i>Students</a>
								</div>
							</td>
						</tr>
						<tr data-widget-list-loading>
							<td class=\"border-0 text-center text-muted small p-3\" colspan=\"4\">Loading new data... Please wait a while...</td>
						</tr>
						<tr data-widget-list-empty>
							<td class=\"border-0 text-center text-muted small p-3\" colspan=\"4\">There are no records available.<div data-widget-list-empty-add=\"\">Please click in the button below to add new records:<br/>
									<br/>
									<button class=\"btn btn-sm btn-success text-nowrap m-1\" onclick=\"MyWidgetResourceLib.PopupHandler.openButtonAddPopup(this); return false;\" data-widget-button-add data-widget-popup-id=\"widget_popup_add_1\" title=\"Add\">
										<i class=\"bi bi-plus-lg icon icon-add mr-1 me-1 overflow-visible\"></i>Add new Record</button>
								</div>
		...
		<div class=\"modal-dialog\">
			<div class=\"modal-content\">
				<div class=\"modal-header\">
					<h5 class=\"modal-title text-muted\">Add School</h5>
	...
	<div class=\"modal fade text-left text-start\" id=\"widget_popup_edit_1\" data-widget-popup data-widget-popup-edit tabindex=\"-1\" role=\"dialog\" data-widget-props=\"{&quot;dependent_widgets_id&quot;:&quot;widget_popup_edit_form_1&quot;,&quot;load&quot;:&quot;MyWidgetResourceLib.PopupHandler.loadPopupResource&quot;}\" style=\"background-color:rgba(0, 0, 0, .5);\">
		<div class=\"modal-dialog\">
			<div class=\"modal-content\">
				<div class=\"modal-header\">
					<h5 class=\"modal-title text-muted\">Edit School</h5>
					<button class=\"btn-close\" data-dismiss=\"modal\" data-bs-dismiss=\"modal\" aria-label=\"Close\" title=\"Close Popup\"></button>
				</div>
				<div class=\"modal-body\">
