...
<html lang="en">
	...
	<body  class="sb-nav-fixed">
			...
			<div id="layoutSidenav_content">
				<main>
					...
					<div class="container-fluid pt-4 pb-4 admin-page-content">
						<h1 class="h4 font-weight-bold admin-page-content-title">
							<?= translateProjectLabel($EVC, $EVC->getCMSLayer()->getCMSTemplateLayer()->getParam("Page Title"));
							?>
						</h1>
						<small>
		...
		<script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-stock-manager/js/authenticated-1.js">
		</script>
