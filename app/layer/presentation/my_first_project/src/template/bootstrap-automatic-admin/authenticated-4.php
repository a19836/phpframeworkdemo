...
<head>
	...
	<link href="<?php echo $original_project_url_prefix; ?>template/bootstrap-automatic-admin/css/authenticated-4.css" rel="stylesheet">
...
<body class="sb-nav-fixed">
           ...
           <main>
		  	<div class="sb-topnav-menu">
               ...
               <div class="container-fluid pt-4 pb-4 admin-page-content">
			    ...
			    <h1 class="h3 mt-4 mb-4"><?= translateProjectLabel($EVC, $EVC->getCMSLayer()->getCMSTemplateLayer()->getParam("Page Title")); ?></h1>
  ...
  <script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-automatic-admin/js/authenticated-4.js"></script>
