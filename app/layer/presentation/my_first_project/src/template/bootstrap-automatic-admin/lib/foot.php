   	...
   	<!-- Local script with native javascript to execute first -->
	<script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-automatic-admin/js/pre.js"></script>
   
	<!-- Bootstrap core JavaScript-->
	<script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-automatic-admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Core plugin JavaScript-->
	<script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-automatic-admin/vendor/jquery-easing/jquery.easing.min.js"></script>
	
	<!--[if lt IE 7 ]>
	  <script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-automatic-admin/vendor/drewdiller/dd_belatedpng.js"></script>
	...
	<script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-automatic-admin/vendor/fonts/fontawesome-free/js/all.min.js"></script>
