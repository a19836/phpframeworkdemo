...
function showBreadcrumbs($curr_url, $project_url_prefix, $admin_url) {
	...
	echo '<li class="breadcrumb-item active"><a href="' . $url_prefix . '">Dashboard</a></li>';
	...
	for ($i = 0; $i < $l; $i++) {
		...
		if (trim($part) && $part != "index") {
			...
			echo '<li class="breadcrumb-item active"><a href="' . $url_prefix . '">' . ucwords(strtolower(str_replace(array("_", "-"), " ", $part))) . '</a></li>';
		}
	}
}
