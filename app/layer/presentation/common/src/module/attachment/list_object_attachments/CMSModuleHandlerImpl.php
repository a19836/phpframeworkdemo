...
class CMSModuleHandlerImpl extends \CMSModuleHandler {
	...
	public function execute(&$settings = false) {
		...
		$settings["edit_page_url"] .= (isset($settings["edit_page_url"]) && strpos($settings["edit_page_url"], "?") !== false ? "&" : "?") . "attachment_id=#[idx][attachment_id]#&object_type_id=#[idx][object_type_id]#&object_id=#[idx][object_id]#";
