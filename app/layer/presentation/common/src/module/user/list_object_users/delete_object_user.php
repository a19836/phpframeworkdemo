...
if (isset($_GET["user_id"]) && isset($_GET["object_type_id"]) && isset($_GET["object_id"]) && UserUtil::deleteObjectUser($brokers, $_GET["user_id"], $_GET["object_type_id"], $_GET["object_id"])) {
	echo "1";
}
?>
