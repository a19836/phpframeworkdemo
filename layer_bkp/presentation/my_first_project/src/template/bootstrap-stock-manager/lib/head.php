	...
	<script src="<?php echo $original_project_url_prefix; ?>template/bootstrap-stock-manager/vendor/jquery/jquery.min.js"></script>

	<!-- Add Jquery UI JS and CSS files -->
	<link rel="stylesheet" href="<?php echo $original_project_url_prefix; ?>template/bootstrap-stock-manager/vendor/jquery-ui/jquery-ui.min.css" type="text/css" />
	<script language="javascript" type="text/javascript" src="<?php echo $original_project_url_prefix; ?>template/bootstrap-stock-manager/vendor/jquery-ui/jquery-ui.min.js"></script>
	
	<!-- Bootstrap core CSS -->
	<link href="<?php echo $original_project_url_prefix; ?>template/bootstrap-stock-manager/vendor/bootstrap5/css/bootstrap.min.css" rel="stylesheet">
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.2/font/bootstrap-icons.css">
    
	<!-- Custom fonts for this template-->
	<link href="<?php echo $original_project_url_prefix; ?>template/bootstrap-stock-manager/vendor/fonts/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $original_project_url_prefix; ?>template/bootstrap-stock-manager/vendor/fonts/google/google-fonts.css" rel="stylesheet">
	...
	<script><?php echo initMyJSLibTranslations($EVC); ?></script>
	
	<!-- StatusMessage --> 
	<!--link href="<?php echo $project_common_url_prefix; ?>vendor/jquerymystatusmessage/css/style.css" rel="stylesheet" type="text/css">
